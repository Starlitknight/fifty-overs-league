...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      ".fo-fd{position:relative;min-height:70vh;color:var(--foink);font-family:Oswald,-apple-system,sans-serif}",
      ...
      ".fo-fd .fd-pmc span{font:600 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--fomut)}",
      ".fo-fd .fd-pmc b{font:700 26px/1 Oswald,sans-serif;letter-spacing:-.02em;color:var(--foink);font-variant-numeric:tabular-nums}",
      ".fo-fd .fd-pmnote{margin:13px 0 0;font:400 13px/1.6 Oswald,sans-serif;color:#5d6472;max-width:66ch}",
      ...
      ".fo-fd .fd-pmk span{display:block;font:600 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--fomut)}",
      ".fo-fd .fd-pmk b{display:block;margin-top:7px;font:600 16px/1.15 Oswald,sans-serif;letter-spacing:-.01em;color:var(--foink)}",
      ".fo-fd .fd-pmk u{display:block;margin-top:5px;font:400 13px/1.5 Oswald,sans-serif;color:#6c7382;text-decoration:none}",
      ...
      ".fo-fd .fd-pmst{font:600 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--fomut)}",
      "html body #page .fo-fd .fd-pmsn{display:block;margin-top:7px;font:600 17px/1.15 Oswald,sans-serif;letter-spacing:-.015em;color:var(--foink) !important;text-decoration:none !important}",
      ...
      ".fo-fd .fd-pmmen span{display:flex;align-items:baseline;justify-content:space-between;gap:10px;font:500 12.5px/1.3 Oswald,sans-serif;color:#3c4453;border-bottom:1px solid rgba(20,36,58,.06);padding-bottom:5px}",
      ".fo-fd .fd-pmmen span:last-child{border-bottom:0}",
      ".fo-fd .fd-pmmen u{text-decoration:none;font:700 12.5px/1 Oswald,sans-serif;color:var(--foink);font-variant-numeric:tabular-nums}",
      ".fo-fd .fd-pmtags{display:flex;flex-wrap:wrap;gap:5px;margin-top:9px}",
      ".fo-fd .fd-pmtags em{font:600 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:var(--fomut);background:rgba(20,36,58,.05);border-radius:999px;padding:6px 10px 5px}",
      ...
      ".fo-fd .fd-pmform i{width:20px;height:20px;border-radius:5px;display:flex;align-items:center;justify-content:center;font:700 11px/1 Oswald,sans-serif;color:#FFFEFC}",
      ".fo-fd .fd-pmform i.w{background:#2F6B45}.fo-fd .fd-pmform i.l{background:#8C2B2B}.fo-fd .fd-pmform i.t{background:#8a8272}",
      ".fo-fd .fd-pmnone{color:var(--fomut);font:400 13px/1.4 Oswald,sans-serif}",
      ...
      "html body #page .fo-fd .fd-back{display:inline-flex;align-items:center;min-height:44px;font:600 13px/1 Oswald,sans-serif;color:#14243A !important;text-decoration:none !important;white-space:nowrap}",
      ".fo-fd .fd-flag{width:24px;height:16px;object-fit:cover;border-radius:2.5px;box-shadow:0 1px 3px rgba(14,35,63,.25)}",
      ".fo-fd .fd-lg{font:700 12px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:var(--foink);white-space:nowrap}",
      ".fo-fd .fd-meta .vd{width:1px;height:16px;background:rgba(20,36,58,.18)}",
      ".fo-fd .fd-meta .gr{font:400 13.5px/1.3 Oswald,sans-serif;color:var(--fomut)}",
      ".fo-fd .fd-live{margin-left:auto;display:inline-flex;align-items:center;gap:6px;font:800 11px/1 Oswald,sans-serif;letter-spacing:.16em;color:#B23230}",
      ...
      ".fo-fd .fd-fin{margin-left:auto;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;color:rgba(20,32,47,.55)}",
      ...
      ".fo-fd .fd-cond{font:500 13.5px/1.6 Oswald,sans-serif;color:#F1EEE6;text-shadow:0 1px 10px rgba(7,22,46,.65);margin-top:4px}",
      ...
      ".fo-fd .fd-bugchips .ch{display:inline-flex;align-items:center;gap:6px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:rgba(244,239,228,.75);background:rgba(255,253,247,.08);border:1px solid rgba(255,253,247,.14);border-radius:999px;padding:6px 10px;white-space:nowrap}",
      ...
      ".fo-fd .fd-bug b{font:700 clamp(24px,6.4vw,32px)/1 Oswald,sans-serif;text-transform:uppercase;letter-spacing:.02em;color:#FFFEFC;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      ...
      ".fo-fd .fd-bugsub{margin-top:6px;font:600 11px/1.5 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(244,239,228,.55)}",
      ...
      ".fo-fd .fd-mets u{display:block;text-decoration:none;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;color:rgba(255,254,252,.5);margin-bottom:5px}",
      ...
      ".fo-fd .fd-strip .s0,.fo-fd .fd-strip .s1{font:700 11px Oswald,sans-serif;color:rgba(255,254,252,.45)}",
      ...
      ".fo-fd .fd-strip .bar em{position:absolute;top:50%;transform:translate(-50%,-50%);width:24px;height:24px;border-radius:50%;background:var(--fogold);color:var(--fon9);font:700 11px/24px Oswald,sans-serif;font-style:normal;text-align:center;box-shadow:0 2px 8px rgba(0,0,0,.35)}",
      ".fo-fd .fd-sub{font:400 14px/1.6 Fraunces,Georgia,serif;color:rgba(255,254,252,.78);margin-top:10px}",
      "html body #page .fo-fd .fd-enter{display:inline-block;margin-top:14px;font:600 14px/1 Oswald,sans-serif;letter-spacing:.01em;color:#FFFEFC !important;background:var(--foor) !important;border:none;border-radius:999px;padding:12px 22px;cursor:pointer;text-align:center;text-decoration:none !important;align-self:flex-start}",
      "html body #page .fo-fd .fd-ftime{display:flex;align-items:baseline;gap:11px;flex-wrap:wrap;margin:12px 0 0}",
      "html body #page .fo-fd .fd-ftime u{text-decoration:none;flex:none;font:700 11px/1 Oswald,sans-serif;letter-spacing:.22em;color:#E8B96A}",
      ...
      ".fo-fd .fd-bh .lo{font:400 13px Oswald,sans-serif;color:var(--fomut)}",
      ...
      "html body #page .fo-fd .fd-fsel{font:600 13px Oswald,sans-serif;color:#6A6354;background:#F6F3EB;border:1px solid var(--fobrd);border-radius:8px;padding:6px 9px;cursor:pointer}",
      ...
      ".fo-fd .fd-ev .no{font:700 13px Oswald,sans-serif;color:var(--fomut);font-variant-numeric:tabular-nums;margin-right:8px}",
      ".fo-fd .fd-ev b{font:600 13.5px Oswald,sans-serif;color:var(--foink)}",
      ".fo-fd .fd-ev p{margin:3px 0 0;font:400 13px/1.55 Oswald,sans-serif;color:#4a4436}",
      ...
      ".fo-fd .fd-ev.wkt .hl{font:700 13px Oswald,sans-serif;letter-spacing:.08em;color:var(--fowkt)}",
      ".fo-fd .fd-ev.wkt .fowchip{display:inline-block;margin-top:8px;font:600 13px Oswald,sans-serif;color:#6d4a42;background:rgba(255,254,252,.72);border:1px solid #e8c9b8;border-radius:8px;padding:5px 9px}",
      ...
      ".fo-fd .fd-ev.top .w{position:relative;z-index:1;font:700 13px Oswald,sans-serif;color:var(--foink);background:#F6F3EB;border-radius:8px;padding:8px 11px}",
      ".fo-fd .fd-ev.top .w .os{display:block;margin-top:4px;font:400 13px/1.5 Oswald,sans-serif;color:#6d6455}",
      ".fo-fd .fd-ev.top .w .os strong{font-weight:600;color:var(--foink)}",
      // ---- at the crease
      ".fo-fd .fd-crease .cb{display:flex;align-items:baseline;gap:8px;padding:6px 0;font:400 13.5px Oswald,sans-serif}",
      ...
      ".fo-fd .fd-crease .cb .bv{font:400 12.5px Oswald,sans-serif;color:var(--fomut);font-variant-numeric:tabular-nums}",
      ".fo-fd .fd-crease .cb .wv{font:700 16px Oswald,sans-serif;color:var(--foor)}",
      ".fo-fd .fd-crease .lbl{display:flex;justify-content:flex-end;gap:14px;font:700 11px Oswald,sans-serif;letter-spacing:.14em;color:#b3ab99}",
      ".fo-fd .fd-crease .lbl.cap{justify-content:flex-start;letter-spacing:.08em;text-transform:none;font:400 12px/1.4 Oswald,sans-serif;color:var(--fomut);margin-top:3px}",
      ".fo-fd .fd-crease .lbl span:first-child{flex:1}",
      ".fo-fd .fd-crease .dv{height:1px;background:#efe9d9;margin:10px 0}",
      ".fo-fd .fd-crease .sh{font:700 11px Oswald,sans-serif;letter-spacing:.18em;color:var(--fomut);margin:2px 0 6px}",
      ".fo-fd .fd-crease .pv{font:700 13px Oswald,sans-serif;letter-spacing:.06em;color:var(--foink);margin-bottom:10px}",
      "html body #page .fo-fd .fd-allbtn{display:block;width:100%;margin-top:10px;font:700 11px Oswald,sans-serif !important;letter-spacing:.16em;text-transform:uppercase;color:#C9571F !important;background:transparent !important;border:1px dashed #e0b9a4 !important;border-radius:10px;padding:11px;cursor:pointer}",
      ...
      ".fo-fd .fd-ch{font:700 11px Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--fomut);margin:2px 0 8px}",
      ...
      ".fo-fd .fd-tb{width:100%;min-width:330px;border-collapse:collapse;margin:0;font:400 12.5px/1.5 Oswald,sans-serif}",
      ...
      ".fo-fd .fd-tb th{font:700 11px Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--fomut);text-align:left;padding:4px 6px;border-bottom:1px solid var(--fobrd)}",
      ...
      // partnerships
      ".fo-fd .fd-ph{font:700 11px Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--fomut);margin:10px 0 6px}",
      ".fo-fd .fd-pr{display:grid;grid-template-columns:74px 1fr 34px;gap:4px 10px;align-items:center;padding:3px 0;font:400 13px Oswald,sans-serif}",
      ".fo-fd .fd-pr .l{font:700 11px Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#6A6354}",
      ...
      ".fo-fd .fd-svg .ax{font:600 10px Oswald,sans-serif;fill:#8a8272}",
      ...
      ".fo-fd .fd-svg .chip{font:700 11px Oswald,sans-serif;letter-spacing:.06em;fill:#FFFEFC;text-anchor:middle}",
      ...
      ".fo-fd .fd-svg .ttxt{font:700 11px Oswald,sans-serif;letter-spacing:.12em;fill:#8a6a1f;text-anchor:middle}",
      ...
      ".fo-fd .fd-leg .lg{display:inline-flex;align-items:center;gap:6px;font:600 13px Oswald,sans-serif;color:#6A6354;background:#F6F3EB;border:1px solid #e8e1cf;border-radius:999px;padding:4px 11px}",
      ".fo-fd .fd-leg .lg i{width:14px;height:4px;border-radius:2px;display:inline-block}",
      ".fo-fd .fd-leg .lg b{font:700 11px Oswald,sans-serif;letter-spacing:.04em;color:#14243A;margin-left:2px}",
      ...
      ".fo-fd .fd-xic .c u{display:block;text-decoration:none;font:700 11px Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:var(--foor);margin-bottom:6px}",
      ".fo-fd .fd-xic .c u.t2{margin-top:8px;color:var(--fomut)}",
      ".fo-fd .fd-xic .c span{display:flex;align-items:baseline;gap:6px;font:400 13px/1.6 Oswald,sans-serif;color:var(--foink)}",
      ".fo-fd .fd-xic .c span i{font-style:normal;font:700 11px/1 Oswald,sans-serif;color:#b3ab99;width:13px;text-align:right}",
      ".fo-fd .fd-xic .c span em{font-style:normal;font:700 11px Oswald,sans-serif;color:var(--foor)}",
      ...
      ".fo-fd .fdtag{display:inline-block;margin-left:8px;vertical-align:1px;font:700 11px Oswald,sans-serif;letter-spacing:.14em;border-radius:5px;padding:2.5px 6px}",
      ...
      ".fo-fd .fd-rest span{font:400 13.5px/1.6 Oswald,system-ui,sans-serif;color:var(--fomut)}",
      ...
      "html body #page .fo-fd .fd-foot a{font:700 11px Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#C9571F !important;text-decoration:none !important}",
