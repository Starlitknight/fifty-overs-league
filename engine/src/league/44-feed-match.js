...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      // the tab rail, in the daylight almanack voice
      ".fo-fd .fd-tabs{display:flex;gap:7px;margin:14px 0 0;flex-wrap:wrap}",
      "html body #page .fo-fd .fd-tabs button{font:700 10.5px Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#3a4353;background:#fff;border:1px solid rgba(14,35,63,.22);border-radius:999px;padding:8px 15px;cursor:pointer}",
      "html body #page .fo-fd .fd-tabs button.on{color:#FFFEFC;background:#14243A;border-color:#14243A}",
      ...
      ".fo-fd .fd-chips{display:flex;gap:6px;flex-wrap:wrap;margin:0 0 10px}",
      "html body #page .fo-fd .fd-chips button{font:600 10.5px Inter,sans-serif;color:#5b5344;background:#F6F3EB;border:1px solid #e3dccb;border-radius:999px;padding:5px 11px;cursor:pointer}",
      "html body #page .fo-fd .fd-chips button.on{color:#fff;background:#C9571F;border-color:#C9571F}",
