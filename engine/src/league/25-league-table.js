...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-lgx-row .rk{font:700 12px/1 Inter,sans-serif;color:rgba(20,28,40,.45);font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-lgx-vs i{font:400 11px/1 Fraunces,Georgia,serif;color:rgba(20,28,40,.38)}",
    ...
    "html body #page .fo-lgx-verdict{grid-column:1/-1;margin-top:2px;padding-top:7px;border-top:1px dashed rgba(20,28,40,.1);font:420 11.5px/1.45 Fraunces,Georgia,serif;color:rgba(20,28,40,.6)}",
    ...
    "html body #page .fo-lgx-leadsub{display:block;margin-top:4px;font:420 10.5px/1.4 Fraunces,Georgia,serif;color:rgba(255,254,252,.6)}",
    ...
    "html body #page table.fo-lgx-stat th{position:sticky;top:0;background:#14243A;color:#FFFDF7;font:700 8.5px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;text-align:right;padding:9px 7px;white-space:nowrap}",
    ...
    "html body #page .fo-lgx-nx i{font:400 10px/1 Fraunces,Georgia,serif;color:rgba(20,28,40,.35)}",
    ...
    "html body #page .fo-lgx-chase b{text-align:right;font:700 12px/1 Inter,sans-serif;color:#FFFEFC;font-variant-numeric:tabular-nums}",
