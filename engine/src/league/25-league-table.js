...
(function () {
  ...
  var CSS = [
    ...
    "html body #page a.fo-sa-map span,#fo-sideart .fo-sa-map span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    ...
    "html body #page .fo-lgx-k{font:700 10px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:var(--gold)}",
    ...
    "html body #page .fo-lgx-rk{font:700 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,254,252,.72)}",
    ...
    "html body #page .fo-lgx-hop span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(255,254,252,.48)}",
    ...
    "html body #page .fo-lgx-sub{font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    "html body #page .fo-lgx-sub2{margin:16px 0 4px;padding-top:12px;border-top:1px solid rgba(20,28,40,.08);font:700 10px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.5)}",
    "html body #page .fo-lgx-rdnav{display:flex;align-items:center;gap:6px}",
    "html body #page .fo-lgx-rdnav b{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.6)}",
    ...
    "html body #page .fo-lgx-cols{padding:4px 8px 7px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,28,40,.4)}",
    ...
    "html body #page .fo-lgx-row .nm em{display:inline-block;margin:3px 6px 0 0;vertical-align:top;font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;font-style:normal;color:rgba(20,28,40,.4);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
    ...
    "html body #page .fo-lgx-yours{position:absolute;left:11px;top:0;transform:translateY(-50%);z-index:2;background:#FFF6F1;border:1px solid rgba(201,85,50,.42);border-radius:999px;padding:3px 8px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--nac)}",
    ...
    "html body #page .fo-lgx-lv{display:inline-flex;align-items:center;gap:4px;text-decoration:none;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;color:#fff;background:#C0392E;border-radius:5px;padding:4px 7px}",
    ...
    "html body #page .fo-lgx-lead i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-style:normal}",
    ...
    "html body #page table.fo-lgx-stat th{position:sticky;top:0;background:#14243A;color:#FFFDF7;font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;text-align:right;padding:9px 7px;white-space:nowrap}",
    ...
    "html body #page .fo-lgx-cols5{padding:4px 8px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.4)}",
    ...
    "html body #page .fo-lgx-card h3{display:flex;align-items:baseline;justify-content:space-between;gap:8px;margin:0 0 10px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.5)}",
    ...
    "html body #page .fo-lgx-run i{width:22px;font:700 10px/1 Oswald,sans-serif;color:var(--gold);font-style:normal}",
    ...
    "html body #page .fo-lgx-glance i{display:block;margin-top:5px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    ...
    "html body #page .fo-lgx-nx u{grid-column:1/-1;text-decoration:none;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--nac)}",
