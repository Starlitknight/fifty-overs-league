...
(function () {
  ...
  s.textContent = [
    ...
    "html body.ftpskin.fo-scb-on .fo-sct th,html body.fo-scb-on .fo-sct th{background:transparent !important;color:#8a7b52 !important;font-family:Inter,sans-serif;font-size:10px;letter-spacing:.2em;text-transform:uppercase;border-bottom:1px solid rgba(36,29,14,.55) !important}",
    ...
    "body.fo-scb-on .fo-sci-box b{color:#8a7b52;font-family:Inter,sans-serif;font-size:10px;letter-spacing:.2em;text-transform:uppercase}",
    ...
    "html body.fo-scb-on #page .fo-sctab,html body.ftpskin.fo-scb-on #page .fo-sctab{background:transparent !important;border:0 !important;border-radius:0 !important;padding:7px 2px !important;margin-right:16px;font-family:Inter,sans-serif !important;font-size:10px !important;letter-spacing:.18em;text-transform:uppercase;color:#8a7b52 !important;border-bottom:2px solid transparent !important;cursor:pointer}",
    ...
    ".fo-scb-stamp{position:absolute;top:52px;right:16px;z-index:2;transform:rotate(-7deg);font-family:Inter,sans-serif;font-weight:700;font-size:15px;letter-spacing:.26em;color:#c23b25;border:3px solid #c23b25;border-radius:5px;padding:5px 12px 4px;opacity:.72;pointer-events:none;mix-blend-mode:multiply}",
