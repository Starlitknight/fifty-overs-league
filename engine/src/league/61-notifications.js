...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "#topbar #fo-nbell i{position:absolute;top:2px;right:1px;min-width:16px;height:16px;padding:0 4px;border-radius:999px;background:#C9571F;color:#fff;font:800 11px/16px Oswald,sans-serif;text-align:center;font-style:normal;box-shadow:0 0 0 2px rgba(9,25,50,.9)}",
      // the page
      ...
      ".fo-nt-hero i{font:700 11px Oswald,sans-serif;letter-spacing:.22em;color:#E8B96A;font-style:normal}",
      ...
      ".fo-nt-ck{display:flex;align-items:center;gap:8px;font:600 11px Oswald,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86;padding:11px 0 9px;border-bottom:1px solid #efe9dc}",
      ".fo-nt-ck i{font:700 11px Oswald,sans-serif;font-style:normal;color:#C9571F}",
      ...
      ".fo-nt-row b{display:block;font:650 13.5px/1.3 Oswald,sans-serif;color:#14243A}",
      ".fo-nt-row i{display:block;margin-top:2px;font:400 13px/1.45 Oswald,sans-serif;color:#6d6455;font-style:normal}",
      ".fo-nt-row .wh{font:600 11px Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#b3aa96;white-space:nowrap;align-self:start;padding-top:3px}",
