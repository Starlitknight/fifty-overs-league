...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "#topbar #fo-nbell i{position:absolute;top:2px;right:1px;min-width:16px;height:16px;padding:0 4px;border-radius:999px;background:#C9571F;color:#fff;font:800 11px/16px Inter,sans-serif;text-align:center;font-style:normal;box-shadow:0 0 0 2px rgba(9,25,50,.9)}",
      // the page
      ...
      ".fo-nt-hero i{font:700 11px Inter,sans-serif;letter-spacing:.22em;color:#E8B96A;font-style:normal}",
      ".fo-nt-hero h1{font-family:Fraunces,Georgia,serif;font-weight:600;font-size:34px;color:#FFFEFC;margin:4px 0 0}",
      ".fo-nt-hero u{display:inline-block;margin-top:8px;text-decoration:none;font:600 11px Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#F1B27A}",
      ...
      ".fo-nt-ck{display:flex;align-items:center;gap:8px;font:600 11px Inter,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86;padding:11px 0 9px;border-bottom:1px solid #efe9dc}",
      ".fo-nt-ck i{font:700 11px Inter,sans-serif;font-style:normal;color:#C9571F}",
