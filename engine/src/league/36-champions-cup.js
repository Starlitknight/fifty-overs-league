...
(function () {
  ...
  function foClCss() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-cl-k{font-family:Inter,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-cl-chip{display:inline-block;font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;border-radius:999px;padding:7px 13px;background:rgba(232,185,106,.16);color:#E8B96A}",
      ...
      "html body #page .fo-cl-crown em{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#B44A22;margin-top:10px}",
      ...
      "html body #page .fo-cl-stage h3,html body #page .fo-cl-sec h3,html body #page .fo-cl-sched h3{margin:0 0 10px;font-family:Inter,sans-serif;font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#8A6A1F;display:flex;justify-content:space-between;align-items:baseline}",
      ...
      "html body #page .fo-cl-foot a{font:600 13px/1 Inter,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
