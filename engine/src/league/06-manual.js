  ...
  function foManualPage() {
    ...
    var secs = [
      ...
      ["books", "The books: the crowd, the gate and the ground", [
        ...
        "<li><b>An overdraft costs.</b> Go below nothing and the bank takes three per cent of what you owe every round, and <b>nothing gets built until you are level</b>. Nothing stops you playing - but it compounds.</li>",
        "<li><b>There is a floor.</b> A club cannot sink further than the money it was founded with. Reach it and the club is in <b>administration</b>: the losses below the line are written off, because there is no deeper hole to dig - but while you are under, <b>the sponsor pays half</b>. It is a floor with a price, not a rescue. Win, fill the ground, and climb back over the line.</li></ul>",
      ...
      ["academy", "The academy and the colts", [
        ...
        "<p><b>A year passes at the turn of every season</b>, and it falls on everybody. Your professionals get a year older too, and one who reaches <b>thirty-eight</b> hangs them up - that is how places come free. A senior staff is <b>twenty men</b>: if a colt comes of age and there is no room, he takes a place only if he is better than the weakest professional on the books, who makes way for him. If he is not, the club lets him go rather than carrying twenty-one.</p>",
