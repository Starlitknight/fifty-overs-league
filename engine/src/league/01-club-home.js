  ...
  try {
    ...
    foCh3Css.textContent =
      ...
      ".fo-cxh-next .bosslbl{font-style:normal;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.6px;color:#E8B96A}" +
  ...
  try {
    ...
    foPhCss.textContent =
      ...
      ".phc-role{font-family:Oswald,sans-serif;font-size:11px;letter-spacing:2.4px;text-transform:uppercase;color:#8F6A1C;font-weight:600}" +
      ...
      ".phc-ovr b{font-family:Oswald,sans-serif;font-size:30px;font-weight:600;color:#E8B96A;display:block}" +
      ...
      ".pht-k{flex:0 0 auto;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.6px;color:#0B1322;background:#8F6A1C;border-radius:6px;padding:2.5px 7px;font-weight:600;margin-top:1px}" +
      ...
      ".phc-ft{display:flex;justify-content:space-between;align-items:center;margin-top:9px;padding-top:8px;border-top:1px solid rgba(255,255,255,.12);font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.6px;color:#9FB0C6}" +
      ...
      "html body #page #fo-pstage .panel h4{background:transparent !important;color:#8F6A1C !important;font-family:Oswald,sans-serif !important;font-weight:600 !important;letter-spacing:2.2px;text-transform:uppercase;font-size:12px !important;border-bottom:1px solid rgba(255,255,255,.09) !important;border-radius:0 !important;padding:11px 14px 9px !important;margin:0 !important}" +
      ...
      "html body #page #fo-pstage th{background:transparent !important;color:#9FB0C6 !important;font-family:Oswald,sans-serif;font-weight:600;letter-spacing:1.2px;text-transform:uppercase;font-size:10px}" +
      "html body #page #fo-pstage td{background:transparent !important}" +
      "html body #page #fo-pstage table.kv td:first-child{color:#9FB0C6;font-family:Oswald,sans-serif;font-size:11px;letter-spacing:1.4px;text-transform:uppercase;padding-right:12px;white-space:nowrap}" +
      ...
      "#fo-pstage .fo-cp-ev i{color:#8F6A1C;font-style:normal;font-family:Oswald,sans-serif;letter-spacing:1px;font-size:10.5px;text-transform:uppercase}" +
