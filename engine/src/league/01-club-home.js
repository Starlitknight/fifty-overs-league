  ...
  function foPremiumClub() {
    try {
      ...
      var standRow = function (x, i) {
        ...
        return "<tr class='" + (meRow ? "fo-userrow" : "") + foldM + "'><td class='fo-rk'>" + (i === 0 ? "<span style='color:#C08A2E;display:inline-flex;vertical-align:-2px'>" + FO_I("trophy", 14) + "</span>" : (i + 1)) + "</td><td class='fo-scoutname'>" + E(x.nm) + botTag + "</td><td class='r'>" + x.p + "</td><td class='r'>" + x.w + "</td><td class='r'>" + x.l + "</td><td class='r'>" + (x.nrr >= 0 ? "+" : "") + x.nrr.toFixed(2) + "</td><td class='r'><b>" + x.pts + "</b></td></tr>";
      };
      ...
      var wRow = function (p2) {
        var en = enOf(p2);
        var col = en.tired ? "#B23230" : en.word === "rested" ? "#c08a2b" : "#16A34A";
      ...
      try {
        if (typeof FO_CX_REGIONS !== "undefined") {
          ...
          if (curJ >= FO_CX_REGIONS.length) {
            cxHero = "<div class='fo-cxhero' data-go='circuit' style='--cxc:#C9571F'>" +
    ...
    try {
      ...
      if (lv.length) {
        ...
        liveStrip = "<div class='panel fo-keep'><h4>" + (anyOn ? "<span class='live-dot'></span> On air" : "&#128250; On air soon") + "</h4><div class='pad'>" +
          ...
          "<div class='small' style='margin-top:8px;color:#6A6354'>Every broadcast in the league is public - tune in to any manager's match, ball by ball.</div></div></div>";
      }
    } catch (eLv) {}
    ...
    sel("league_clubs", "league_id=eq." + LG.id + "&select=club,manager_id").then(function (rows) {
      ...
      var chalPrev = function () {
        try {
          ...
          el9.innerHTML = "Kicks off " + E(loc) + (loc.indexOf(" ET") < 0 ? " <span style='color:#9FB0C6;font-weight:400'>(" + E(et) + " &middot; league clock)</span>" : "");
        } catch (e9) {}
      };
  ...
  function foNetsCss() {
    ...
    st.textContent =
      ...
      ".fo-net-bat{border-top:3px solid #22635F}.fo-net-bowl{border-top:3px solid #C9571F}" +
      ".fo-net-role{font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;margin-bottom:9px;color:#6A6354}" +
      ".fo-net-bat .fo-net-role{color:#22635F}.fo-net-bowl .fo-net-role{color:#a4552e}" +
      ...
      ".fo-net-nm:hover{color:#22635F;text-decoration:underline}" +
      ...
      ".fo-net-v{align-self:center;justify-self:center;width:30px;height:30px;border-radius:50%;background:#efece2;color:#6A6354;font-weight:800;font-size:13px;display:flex;align-items:center;justify-content:center}" +
      ...
      ".fo-nc label{font-size:10px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:#8A8272}" +
  ...
  // ==== the FULL PLAYER PAGE hero: a holographic trading card ==============
  // Opening a player is the game's pack-rip moment: a big tilting card with
  ...
  try {
    ...
    foCh3Css.textContent =
      ...
      ".fo-cs-mgr{font-size:12px;color:#6A6354}" +
      ".fo-cs-meta{font-size:12px;color:#6A6354}.fo-cs-meta u{text-decoration:none;color:#c3bda9}" +
      ".fo-cs-right{margin-left:auto;display:flex;gap:8px;align-items:center;flex-wrap:wrap}" +
      ".fo-cs-chip{display:inline-flex;align-items:center;gap:6px;font-size:11px;color:#6A6354;background:rgba(20,36,58,.05);border-radius:999px;padding:3px 11px}" +
      ".fo-cs-chip b{color:#14243A;font-size:11px}.fo-cs-chip u{text-decoration:none;color:#9FB0C6}" +
      ...
      ".fo-cxh-in{position:relative;padding:22px 26px 20px;color:#F4EFE3;max-width:660px}" +
      ".fo-cxh-eyebrow{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:3.6px;text-transform:uppercase;color:#E4C463;font-weight:600}" +
      ".fo-cxh-title{font-family:Manrope,sans-serif;font-weight:600;font-size:clamp(27px,4.5vw,42px);letter-spacing:1.5px;text-transform:uppercase;line-height:1.04;color:#FFFEFC;margin:3px 0 9px}" +
      ".fo-cxh-prog{height:7px;background:rgba(255,255,255,.16);border-radius:99px;max-width:330px;overflow:hidden}" +
      ".fo-cxh-prog u{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#8F6A1C,#E8B96A)}" +
      ".fo-cxh-progk{font-family:Manrope,sans-serif;font-size:10px;letter-spacing:2.2px;text-transform:uppercase;color:#cdd5e3;margin:5px 0 13px}" +
      ".fo-cxh-next{display:flex;align-items:center;gap:11px;font-size:15px;line-height:1.35}" +
      ".fo-cxh-next .fo-cxh-face{width:46px;height:46px;border-radius:50%;object-fit:cover;object-position:50% 10%;border:2px solid #8F6A1C;background:#FFFEFC;flex:0 0 46px}" +
      ...
      ".fo-cxh-next .bosslbl{font-style:normal;font-family:Manrope,sans-serif;font-size:10px;letter-spacing:1.6px;color:#E8B96A}" +
      ...
      "html body #page .fo-cxh-cta,html body.ftpskin #page .fo-cxh-cta{font-family:Manrope,sans-serif !important;font-weight:600 !important;letter-spacing:1.8px;text-transform:uppercase;font-size:12.5px;background:linear-gradient(180deg,#E8B96A,#8F6A1C) !important;color:#0C1B2E !important;border:none !important;border-radius:10px;padding:10px 22px;cursor:pointer;box-shadow:0 4px 0 rgba(16,27,45,.35) !important}" +
      "html body #page .fo-cxh-cta:hover{filter:brightness(1.06)}" +
      "html body #page .fo-cxh-pass,html body.ftpskin #page .fo-cxh-pass{font-family:Manrope,sans-serif !important;font-weight:600 !important;letter-spacing:1.8px;text-transform:uppercase;font-size:11px;background:transparent !important;color:#E4C463 !important;border:1.5px solid rgba(228,196,99,.6) !important;border-radius:10px;padding:10px 16px;cursor:pointer;box-shadow:none !important}" +
      ...
      ".fo-mp-badge{font-family:Manrope,sans-serif;font-size:10px;letter-spacing:1.8px;background:#14243A;color:#FFFEFC;border-radius:6px;padding:2.5px 8px;vertical-align:2px;margin-left:7px;font-weight:600}" +
      ".fo-mp-prog{font-size:12px;color:#6A6354;margin:2px 0 10px}.fo-mp-prog .fo-progress-bar{height:6px;background:rgba(20,36,58,.09);border-radius:99px;overflow:hidden;margin-top:5px}.fo-mp-prog .fo-progress-bar u{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#C9571F,#C08A2E)}" +
  ...
  try {
    ...
    foPhCss.textContent =
      ...
      ".phc-in{background:radial-gradient(140% 100% at 50% 0%,#1b2a4a 0%,#0C1B2E 58%,#0B1322 100%);border-radius:15px;padding:13px 15px 11px;color:#F4EFE3;position:relative;overflow:hidden}" +
      ".phc-hd{display:flex;justify-content:space-between;align-items:flex-start;gap:10px;margin-bottom:9px}" +
      ".phc-role{font-family:Manrope,sans-serif;font-size:11px;letter-spacing:2.4px;text-transform:uppercase;color:#8F6A1C;font-weight:600}" +
      ".phc-nm{font-family:Manrope,sans-serif;font-weight:800;font-size:25px;line-height:1.06;color:#FFFEFC;margin-top:2px}" +
      ...
      ".phc-ovr b{font-family:Manrope,sans-serif;font-size:30px;font-weight:600;color:#E8B96A;display:block}" +
      ".phc-ovr i{font-style:normal;font-family:Manrope,sans-serif;font-size:10px;letter-spacing:2px;color:#b9c2d4}" +
      ...
      // plus a soft glare that follows it on every tier
      ".phc-holo{position:absolute;inset:-12%;pointer-events:none;mix-blend-mode:color-dodge;opacity:0;background:linear-gradient(112deg,transparent 26%,rgba(255,80,220,.22) 38%,rgba(90,230,255,.22) 48%,rgba(255,240,120,.2) 58%,transparent 72%);transform:translateX(calc((var(--mx,.5) - .5)*70%))}" +
      ".ph-star .phc-holo{opacity:.75}.ph-legend .phc-holo{opacity:1}" +
      ...
      ".phr i{font-style:normal;font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:1.8px;color:#b9c2d4;font-weight:600;flex:0 0 72px}" +
      ".phr .st{text-decoration:none;font-size:15px;letter-spacing:1.6px;line-height:1}" +
      ".phr .st em{font-style:normal;color:#2c3a55}" +
      ".phr-b .st em.f{color:#E8B96A}.phr-b .st em.h{background:linear-gradient(90deg,#E8B96A 50%,#2c3a55 50%);-webkit-background-clip:text;background-clip:text;color:transparent}" +
      ...
      ".phr > em{font-style:normal;font-family:Manrope,sans-serif;font-weight:600;font-size:16px;color:#FFFEFC;margin-left:auto}" +
      ...
      ".pht-k{flex:0 0 auto;font-family:Manrope,sans-serif;font-size:10px;letter-spacing:1.6px;color:#0B1322;background:#8F6A1C;border-radius:6px;padding:2.5px 7px;font-weight:600;margin-top:1px}" +
      ...
      ".phc-meta s{text-decoration:none;color:#8F6A1C}" +
      ".phc-ft{display:flex;justify-content:space-between;align-items:center;margin-top:9px;padding-top:8px;border-top:1px solid rgba(255,255,255,.12);font-family:Manrope,sans-serif;font-size:10px;letter-spacing:1.6px;color:#9FB0C6}" +
      ".phc-ft .rr{color:#E8B96A;font-size:12px;letter-spacing:0}" +
      ...
      "html body .fo-pd-holo .fo-pd-hx{position:sticky;top:0;left:100%;z-index:6;display:block;margin:0 0 -30px;background:rgba(16,27,45,.85);color:#F4EFE3;border:1px solid rgba(255,255,255,.35)}" +
      ...
      ".fo-pd-hmoney b{color:#FFFEFC;font-size:14.5px;font-family:Manrope,sans-serif;font-weight:600}" +
      ...
      // panels: dark slabs with gold Manrope headers
      ...
      "html body #page #fo-pstage .panel h4{background:transparent !important;color:#8F6A1C !important;font-family:Manrope,sans-serif !important;font-weight:600 !important;letter-spacing:2.2px;text-transform:uppercase;font-size:12px !important;border-bottom:1px solid rgba(255,255,255,.09) !important;border-radius:0 !important;padding:11px 14px 9px !important;margin:0 !important}" +
      ...
      "html body #page #fo-pstage .ftp-pinfo-top b{color:#E8B96A}" +
      ...
      "html body #page #fo-pstage th{background:transparent !important;color:#9FB0C6 !important;font-family:Manrope,sans-serif;font-weight:600;letter-spacing:1.2px;text-transform:uppercase;font-size:10px}" +
      "html body #page #fo-pstage td{background:transparent !important}" +
      "html body #page #fo-pstage table.kv td:first-child{color:#9FB0C6;font-family:Manrope,sans-serif;font-size:11px;letter-spacing:1.4px;text-transform:uppercase;padding-right:12px;white-space:nowrap}" +
      "html body #page #fo-pstage table.kv b{color:#E8B96A}" +
      "html body #page #fo-pstage a{color:#E4C463}" +
      "html body #page #fo-pstage .small{color:#9FB0C6 !important}" +
      ...
      "html body #page #fo-pstage .fo-bigskill-bar i{background:linear-gradient(90deg,var(--tc),#E8B96A) !important;border-radius:99px}" +
      ...
      "html body #page #fo-pstage .fo-cp-tab{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.18);color:#dfe5f0 !important;border-radius:99px;padding:4px 15px;cursor:pointer;font-family:Manrope,sans-serif;letter-spacing:1.4px;text-transform:uppercase;font-size:10.5px;text-decoration:none}" +
      "html body #page #fo-pstage .fo-cp-tab.on{background:#8F6A1C;border-color:#8F6A1C;color:#0C1B2E !important;font-weight:600}" +
      "#fo-pstage .fo-cp-ev i{color:#8F6A1C;font-style:normal;font-family:Manrope,sans-serif;letter-spacing:1px;font-size:10.5px;text-transform:uppercase}" +
      "#fo-pstage .fo-cp-ev span{color:#dfe5f0}" +
      "html body #page #fo-pstage .fo-cp-tot td{color:#E8B96A !important;font-weight:700}" +
      "#fo-pstage .fo-cp-fld{color:#b9c2d4}" +
      "#fo-pstage details.adv summary{color:#9FB0C6;cursor:pointer}";
    ...
    try {
      ...
      if (on) {
        ...
        try {
          ...
          // the manager's own match OPENS at the broadcast's unhurried pace -
          // time to read the field and the commentary.
          try {
            if (__mine && M && !M.__foSpdInit) {
              M.__foSpdInit = 1;
              UI.apHl = false; UI.apMs = 3200;
  ...
  function foWorm2(worm, innings, target) {
    try {
      ...
      for (var o = 0; o <= mo; o += 10) grid += "<line x1='" + X(o).toFixed(1) + "' y1='188' x2='" + X(o).toFixed(1) + "' y2='24' stroke='#ece7da'/>" +
        "<text x='" + X(o).toFixed(1) + "' y='201' font-size='9.5' fill='#6A6354' text-anchor='middle'>" + o + "</text>";
      ...
      for (var rv2 = 0; rv2 <= mx - 8; rv2 += step) grid += "<text x='37' y='" + (Y(rv2) + 3).toFixed(1) + "' font-size='9.5' fill='#6A6354' text-anchor='end'>" + rv2 + "</text>";
      var line = function (w, col) {
        return "<polyline fill='none' stroke='" + col + "' stroke-width='2' points='" + w.map(function (pt) { return X(pt[0]).toFixed(1) + "," + Y(pt[1]).toFixed(1); }).join(" ") + "'/>" +
          w.filter(function (pt, i) { return i > 0 && (pt[2] || 0) > (w[i - 1][2] || 0); }).map(function (pt) { return "<circle cx='" + X(pt[0]).toFixed(1) + "' cy='" + Y(pt[1]).toFixed(1) + "' r='3' fill='#B23230'/>"; }).join("");
      };
      ...
      return "<svg viewBox='0 0 500 218' style='max-width:100%;width:520px'>" + grid +
        "<line x1='42' y1='188' x2='472' y2='188' stroke='#8A8272'/><line x1='42' y1='24' x2='42' y2='188' stroke='#8A8272'/>" + tgt +
        (worm[0] ? line(worm[0], "#22635F") : "") + (worm[1] ? line(worm[1], "#C08A2E") : "") +
        ...
        "<div class='small' style='margin-top:4px'><span style='color:#22635F'>■</span> " + E(innings[0] ? innings[0].batTeam : "") + " &nbsp; <span style='color:#C08A2E'>■</span> " + E(innings[1] ? innings[1].batTeam : "") + " &nbsp; <span style='color:#B23230'>●</span> wicket" + ((target && target > 1) ? " &nbsp; <span style='color:#C9571F'>––– target</span>" : "") + "</div>";
    } catch (e) { return null; }
  }
