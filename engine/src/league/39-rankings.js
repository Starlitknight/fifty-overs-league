...
(function () {
  ...
  function foRkCss() {
    ...
    s.textContent = [
      ...
      ".fo-rk-k{font:700 11px/1 Inter,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8894A}",
      ...
      ".fo-rk-mine u{text-decoration:none;font-family:Inter,sans-serif;font-weight:700;color:#B44A22}",
      ...
      ".fo-rk-card h3 span{display:block;font:600 11px/1.6 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45)}",
      ...
      ".fo-rk-row b em{font-style:normal;font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;color:#C9571F;border:1px solid rgba(200,84,47,.45);border-radius:999px;padding:2px 6px;vertical-align:1px}",
      ...
      ".fo-rk-gap{text-align:center;color:rgba(20,28,40,.35);font:700 12px/1 Inter,sans-serif;padding:4px 0}",
      ".fo-rk-foot{display:flex;justify-content:space-between;padding:4px 6px}",
      "html body #page .fo-rk-foot a{display:inline-flex;align-items:center;min-height:44px;padding:0 13px;margin:0 -13px;border-radius:12px;font:600 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#B44A22 !important;text-decoration:none !important}"
    ].join("\n");
