  ...
  try {
    ...
    foOfCss.textContent =
      ...
      ".fo-of2{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#14243A}" +
    ...
    ".fo-of2-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:0 0 14px}" +
      ...
      "html body .fo-of2-hbtn,html body.ftpskin #page .fo-of2-hbtn{margin-left:auto;background:transparent !important;border:1px solid rgba(255,255,255,.35) !important;color:#fff !important;border-radius:8px;padding:4px 10px !important;font:700 13px Inter,ui-sans-serif,sans-serif !important;cursor:pointer;text-transform:none;letter-spacing:0}" +
      ...
      ".fo-mn2{display:grid;grid-template-columns:260px minmax(0,1fr);gap:22px;align-items:start;max-width:1180px;margin:0 auto;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#14243A}" +
      ...
      "html body .fo-mn2-cbtn,html body.ftpskin #page .fo-mn2-cbtn{display:flex;width:100%;align-items:center;justify-content:space-between;background:none !important;border:0 !important;padding:9px 4px !important;font:700 13px/1 Inter,ui-sans-serif,sans-serif !important;letter-spacing:.07em;text-transform:uppercase;color:#687386 !important;cursor:pointer;box-shadow:none !important}" +
      ...
      "html body .fo-mn2-mbar button,html body.ftpskin #page .fo-mn2-mbar button{flex:0 0 auto;min-height:38px;min-width:44px;background:#fff !important;border:1px solid rgba(15,35,60,.16) !important;border-radius:9px;padding:0 14px !important;font:700 12.5px Inter,ui-sans-serif,sans-serif !important;color:#14243A !important;cursor:pointer;box-shadow:0 2px 6px rgba(15,35,60,.06)}" +
