  ...
  try {
    ...
    foOfCss.textContent =
      ...
      ".fo-of-head h2{margin:0;font-size:22px;color:#14243A}" +
      ".fo-of-head .small{color:#9FB0C6}" +
      ...
      ".fo-of-pill{border:1px solid rgba(28,36,51,.18);background:#FFFEFC;color:#14243A;border-radius:999px;padding:5px 12px;font-size:12px;font-weight:700;cursor:pointer}" +
      ".fo-of-pill.on{background:#14243A;color:#fff;border-color:#14243A}" +
      "html body.ftpskin button.fo-of-pill{background:#FFFEFC !important;color:#14243A !important;border-color:rgba(28,36,51,.18) !important}" +
      "html body.ftpskin button.fo-of-pill.on{background:#14243A !important;color:#fff !important;border-color:#14243A !important}" +
      ...
      ".fo-of-lvl{display:inline-block;background:#14243A;color:#FFFEFC;border-radius:7px;padding:2px 9px;font-size:11px;font-weight:800;margin-right:7px}" +
      ".fo-of-ledger td,.fo-of-ledger th{font-size:12px}" +
      ".fo-of-foot{font-size:11.5px;color:#9FB0C6;margin:6px 2px}" +
      ".fo-pot{display:inline-block;border-radius:999px;padding:2px 10px;font-size:11px;font-weight:700}" +
      ".fo-pot-star{background:#EEE8FA;color:#5b4a91}.fo-pot-high{background:#D8EADF;color:#1c5537}.fo-pot-useful{background:#E8EAEE;color:#6A6354}.fo-pot-limited{background:#F3EBE0;color:#8a6b3a}" +
      ...
      ".fo-of2{font-family:Manrope,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#14243A}" +
      ...
      ".fo-of2-head h1{margin:0;font-size:26px;letter-spacing:-.3px;color:#14243A}" +
    ...
    ".fo-of2-mchip i{font-style:normal;color:#6b7280;text-transform:uppercase;font-size:10px;letter-spacing:.06em;font-weight:800}" +
    ...
    ".fo-of2-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:0 0 14px}" +
      ...
      ".fo-of2-kpi b{display:block;font-size:23px;color:#14243A;margin:3px 0 1px;font-variant-numeric:tabular-nums;white-space:nowrap}" +
      ...
      ".fo-of2-hrow{display:flex;gap:8px;align-items:baseline;font-size:12.5px;color:#14243A}" +
      ".fo-of2-hrow span:last-child{color:#14243A}.fo-of2-hrow span:first-child{font-weight:800}" +
      ...
      "html body .fo-of2-hbtn,html body.ftpskin #page .fo-of2-hbtn{margin-left:auto;background:transparent !important;border:1px solid rgba(255,255,255,.35) !important;color:#fff !important;border-radius:8px;padding:4px 10px !important;font:700 13px Manrope,ui-sans-serif,sans-serif !important;cursor:pointer;text-transform:none;letter-spacing:0}" +
      ...
      ".fo-of2-frow{display:flex;justify-content:space-between;gap:12px;padding:5px 0;font-size:13px;color:#14243A;border-bottom:1px dashed rgba(15,35,60,.08)}" +
      ...
      ".fo-of2-d b{font-size:13.5px;color:#14243A}" +
      ...
      ".fo-of2-gstat b{font-size:16px;color:#14243A;font-variant-numeric:tabular-nums}" +
      ...
      ".fo-mn2{display:grid;grid-template-columns:260px minmax(0,1fr);gap:22px;align-items:start;max-width:1180px;margin:0 auto;font-family:Manrope,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#14243A}" +
      ...
      ".fo-mn2-sh a{font-weight:800;font-size:15px;color:#14243A !important;text-decoration:none}" +
      ...
      "html body .fo-mn2-cbtn,html body.ftpskin #page .fo-mn2-cbtn{display:flex;width:100%;align-items:center;justify-content:space-between;background:none !important;border:0 !important;padding:9px 4px !important;font:700 13px/1 Manrope,ui-sans-serif,sans-serif !important;letter-spacing:.07em;text-transform:uppercase;color:#687386 !important;cursor:pointer;box-shadow:none !important}" +
      ".fo-mn2-cbtn i{font-style:normal;font-size:13px}" +
      ".fo-mn2-arts a{display:flex;align-items:center;min-height:34px;padding:2px 10px;border-radius:8px;color:#14243A !important;font-size:13px;font-weight:600;text-decoration:none;line-height:1.3}" +
      ...
      ".fo-mn2-cc{display:block;background:#fff;border:1px solid rgba(15,35,60,.11);border-radius:12px;box-shadow:0 5px 14px rgba(15,35,60,.055);padding:16px 18px;text-decoration:none !important;color:#14243A !important;transition:transform .12s ease,box-shadow .12s ease}" +
      ...
      ".fo-mn2-crumb{font-size:12px;color:#687386;margin:0 0 6px}.fo-mn2-crumb a{color:#687386 !important;text-decoration:none}.fo-mn2-crumb b{color:#14243A}" +
      ...
      ".fo-mn2-pn a{flex:1;max-width:48%;display:block;background:#faf8f3;border:1px solid rgba(15,35,60,.11);border-radius:10px;padding:10px 14px;text-decoration:none !important;color:#14243A !important;min-height:44px;box-sizing:border-box}" +
      ...
      ".fo-mn2-hits a{display:block;padding:9px 12px;border-radius:9px;text-decoration:none !important;color:#14243A !important}" +
      ...
      ".fo-mn2-hits a i{display:block;font-style:normal;font-size:12px;color:#6A6354;margin-top:2px;line-height:1.5}" +
      ...
      ".fo-mn2-dcat{font-size:10.5px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:#9FB0C6;margin:12px 4px 4px}" +
      ...
      ".fo-mn2-mbar b{flex:0 0 auto;font-size:16px;color:#14243A}" +
      "html body .fo-mn2-mbar button,html body.ftpskin #page .fo-mn2-mbar button{flex:0 0 auto;min-height:38px;min-width:44px;background:#fff !important;border:1px solid rgba(15,35,60,.16) !important;border-radius:9px;padding:0 14px !important;font:700 12.5px Manrope,ui-sans-serif,sans-serif !important;color:#14243A !important;cursor:pointer;box-shadow:0 2px 6px rgba(15,35,60,.06)}" +
  ...
  function foSponsorCardHtml(t) {
    ...
    if (fr && fr.round != null) {
      ...
      frHtml = "<div class='small' style='color:#6A6354;text-transform:uppercase;letter-spacing:.08em;font-size:10px;margin:8px 0 4px'>Matchday " + fr.round + " settlement</div>" +
        "<table class='kv'>" +
