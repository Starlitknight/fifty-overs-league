...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-mk-row .tlts em{font-style:normal;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#7A5210;background:linear-gradient(120deg,#F6E7C0,#EED9A0);border:1px solid rgba(184,147,58,.35);border-radius:6px;padding:5px 8px}",
      ...
      "html body #page .fo-mk-row .facts i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#6A6354;font-style:normal;margin-bottom:4px}",
      "html body #page .fo-mk-row .facts b{font:650 13px/1 Manrope,sans-serif;color:#14243A;font-variant-numeric:tabular-nums}",
      // the deed's word, ON the card: a green strip, never a popup
      "html body #page .fo-mk-row .rail .bidok{margin-top:10px;font:600 13px/1.5 Manrope,sans-serif;color:#8FD6B5;background:rgba(23,122,87,.22);border:1px solid rgba(143,214,181,.35);border-radius:8px;padding:9px 11px;animation:fo-mk-drop2 .2s ease}",
      "html body #page .fo-mk-row .rail .bidmsg{display:none;font:500 12px/1.5 Manrope,sans-serif;color:#FFB4A0;margin-top:7px}",
      ...
      "html body #page .fo-mk-hd .eb{font:600 11px/1 Manrope,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#C08A2E;margin-bottom:9px}",
      "html body #page .fo-mk-hd .row{display:flex;align-items:flex-end;gap:30px;flex-wrap:wrap}",
      "html body #page .fo-mk-hd h1{font:700 31px/1 Manrope,sans-serif;text-transform:uppercase;color:#14243A;margin:0;letter-spacing:.015em}",
      ...
      "html body #page .fo-mk-hd .f i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#6A6354;font-style:normal;margin-top:5px}",
      ...
      "html body #page .fo-mk-tabs button{font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.13em;text-transform:uppercase;color:#9FB0C6 !important;background:transparent !important;border:0 !important;border-radius:0 !important;padding:6px 0 !important;cursor:pointer;white-space:nowrap;box-shadow:none !important;transition:color .15s}",
      ...
      "html body #page .fo-mk-rlinks button{font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.11em;text-transform:uppercase;color:#9FB0C6 !important;background:transparent !important;border:0 !important;border-radius:0 !important;padding:6px 0 !important;cursor:pointer;box-shadow:none !important;transition:color .15s}",
      ...
      "html body #page .fo-mk-deck .sel select{appearance:none !important;-webkit-appearance:none !important;border:0 !important;background:transparent !important;font:600 13px/1.4 Manrope,sans-serif !important;color:#14243A !important;padding:6px 16px 6px 0 !important;cursor:pointer;min-height:0 !important;box-shadow:none !important}",
      ...
      "html body #page .fo-mk-row .ovr{flex:none;width:44px;height:44px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1px;background:#14243A;color:#F6EFDF;border-radius:11px;font:600 16px/1 Manrope,sans-serif;font-variant-numeric:tabular-nums}.fo-mk-row .ovr b{font-weight:700}.fo-mk-row .ovr i{font-style:normal;font:700 11px/1 Manrope,sans-serif;letter-spacing:.06em;color:#9FB0C6}",
      ...
      "html body #page .fo-mk-row .nm .mt{display:block;font:400 13px/1.6 Manrope,sans-serif;color:#7d8798;margin-top:2px}",
      "html body #page .fo-mk-row .mt .natc{display:inline-flex;align-items:center;gap:5px;font:600 12px/1 Manrope,sans-serif;color:#4a5568;vertical-align:middle}",
      ...
      "html body #page .fo-mk-row .gg .lb{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.17em;text-transform:uppercase;color:#6A6354}",
      "html body #page .fo-mk-row .gg .vl{display:block;font:600 13px/1.25 Manrope,sans-serif;color:#14243A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ...
      "html body #page .fo-mk-row .fold{display:inline-flex;align-items:center;gap:6px;margin-top:12px;padding:2px 0 !important;font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.16em;text-transform:uppercase;color:#C9571F !important;background:transparent !important;border:0 !important;border-radius:0 !important;cursor:pointer;box-shadow:none !important}",
      ...
      "html body #page .fo-mk-full .fb{display:grid;grid-template-columns:72px 1fr 88px;gap:10px;align-items:center}",
      "html body #page .fo-mk-full .fb i{font-style:normal;font:600 11px/1 Manrope,sans-serif;letter-spacing:.15em;text-transform:uppercase;color:#6A6354}",
      ...
      "html body #page .fo-mk-full .fb b{font:600 11px/1 Manrope,sans-serif;text-align:right;color:#2a3444;white-space:nowrap}",
      ...
      "html body #page .fo-mk-row .prov .tag{flex:none;font:600 11px/1 Manrope,sans-serif;letter-spacing:.11em;text-transform:uppercase;color:#7A5480;background:rgba(122,84,128,.07);border:1px solid rgba(122,84,128,.22);border-radius:6px;padding:5px 8px}",
      ...
      "html body #page .fo-mk-row .rail .lb2{font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(246,239,223,.42)}",
      "html body #page .fo-mk-row .rail .lb2.hm{margin-top:7px}",
      "html body #page .fo-mk-row .rail .club{font:600 13px/1.4 Manrope,sans-serif;color:#FFFEFC;text-decoration:none;border-bottom:1px solid rgba(255,253,247,.3);align-self:flex-start}",
      ...
      "html body #page .fo-mk-row .rail .amt{font:600 32px/1 Manrope,sans-serif;color:#FFFEFC;font-variant-numeric:tabular-nums;margin-top:5px}",
      "html body #page .fo-mk-row .rail .amt i{font:600 11px/1 Manrope,sans-serif;font-style:normal;color:rgba(246,239,223,.5);letter-spacing:.08em;margin-left:6px}",
      "html body #page .fo-mk-row .rail .rsv{font:400 12px/1.4 Manrope,sans-serif;color:rgba(246,239,223,.55)}",
      "html body #page .fo-mk-row .rail .hmwrap{display:block}",
      "html body #page .fo-mk-row .rail .clk{display:block;font:600 18px/1.15 Manrope,sans-serif;letter-spacing:.06em;font-variant-numeric:tabular-nums;color:#E8B96A}",
      ...
      "html body #page .fo-mk-row .rail .go{margin-top:10px;font:600 13px/1 Manrope,sans-serif !important;letter-spacing:.14em;text-transform:uppercase;color:#FFFEFC !important;background:#C9571F !important;border:0 !important;border-radius:9px !important;padding:13px 0 !important;width:100%;cursor:pointer;transition:background .15s}",
      ...
      "html body #page .fo-mk-row .rail .cust input.fo-mk-in{flex:1;min-width:0;background:transparent !important;border:0 !important;border-bottom:1px solid rgba(246,239,223,.28) !important;border-radius:0 !important;color:#FFFEFC !important;font:600 13px/1 Manrope,sans-serif !important;padding:8px 2px !important;font-variant-numeric:tabular-nums;box-shadow:none !important;min-height:0 !important}",
      ...
      "html body #page .fo-mk-row .rail .act.ghost{margin-top:10px;font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.14em;text-transform:uppercase;color:rgba(246,239,223,.85) !important;background:transparent !important;border:1px solid rgba(246,239,223,.35) !important;border-radius:999px !important;padding:12px 0 !important;width:100%;cursor:pointer}",
      ...
      "html body #page .fo-mk .yth{display:inline-flex;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;color:#7A5210;background:linear-gradient(120deg,#F3DFA9,#E8B96A);border-radius:5px;padding:3.5px 6px;vertical-align:3px;margin-left:8px;text-transform:uppercase;white-space:nowrap}",
      // the door to the rest of a big board
      "html body #page .fo-mk-more{display:block;width:100%;margin:2px 0 0;padding:13px !important;font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.13em;text-transform:uppercase;color:#67748a !important;background:#FFFEFC !important;border:1px dashed rgba(27,36,50,.25) !important;border-radius:12px !important;cursor:pointer}",
      ...
      "html body #page .fo-mk-k{font-family:Manrope,sans-serif;font-size:10px;letter-spacing:.22em;text-transform:uppercase;color:#B44A22;margin:22px 2px 9px}",
      ...
      "html body #page .fo-mk-swho .amt2{font:650 12.5px/1 Manrope,sans-serif;color:#14243A;font-variant-numeric:tabular-nums}",
      "html body #page .fo-mk-swho .st{display:block;font:600 12px/1.5 Manrope,sans-serif;font-style:normal;margin-top:3px}",
      ...
      "html body #page .fo-mk-shammer i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#6A6354;font-style:normal;margin-bottom:4px}",
      "html body #page .fo-mk-shammer .clk{font:600 14px/1.15 Manrope,sans-serif;letter-spacing:.05em;color:#C08A2E;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-mk-swho span{display:block;font:400 13px/1.4 Manrope,sans-serif;color:rgba(20,28,40,.5);margin-top:2px}",
      "html body #page .fo-mk-sbtns{display:flex;gap:7px;flex:0 0 auto;flex-wrap:wrap;justify-content:flex-end}",
      "html body #page .fo-mk-b{font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.11em;text-transform:uppercase;color:#FFFEFC !important;background:#C9571F !important;border:1px solid #C9571F !important;border-radius:999px !important;padding:9px 14px !important;cursor:pointer;min-height:32px;transition:background .15s,color .15s}",
      ...
      "html body #page .fo-mk-on{font:600 13px/1.3 Manrope,sans-serif;color:#177A57}",
      "html body #page .fo-mk-deal{background:#FFFEFC;border:1px solid rgba(20,28,40,.09);border-radius:12px;padding:11px 15px;margin-bottom:8px;font:400 12.5px/1.5 Manrope,sans-serif;color:rgba(20,28,40,.75)}",
      ...
      "html body #page .fo-mk-foot a{font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
      ...
      "html body #page .fo-mk-vt button{display:inline-flex;align-items:center;gap:6px;font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.12em;text-transform:uppercase;color:#67748a !important;background:transparent !important;border:0 !important;border-radius:7px !important;padding:7px 11px !important;cursor:pointer;box-shadow:none !important}",
      ...
      "html body #page .fo-mk-tbl thead th{background:linear-gradient(180deg,#1A2C47,#0E1E33) !important;color:#D9CBA8 !important;font:600 11px/1.3 Manrope,sans-serif !important;letter-spacing:.15em;text-transform:uppercase;padding:14px 10px !important;text-align:right;white-space:nowrap;cursor:pointer;position:sticky;top:0;z-index:2;border:0 !important;box-shadow:inset 0 -3px 0 rgba(201,87,31,.55)}",
      ...
      "html body #page .fo-mk-tbl td{padding:11px 10px;border-top:1px solid rgba(27,36,50,.06);font:500 13px/1.35 Manrope,sans-serif;color:#2a3444;text-align:right;font-variant-numeric:tabular-nums;white-space:nowrap}",
      ...
      "html body #page .fo-mk-tbl td .ovch{display:inline-block;min-width:30px;background:#14243A;color:#F6EFDF;font:700 12.5px/1 Manrope,sans-serif;border-radius:8px;padding:6px 5px;text-align:center;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-mk-tbl td .sub{display:block;font:400 12px/1.6 Manrope,sans-serif;color:#9FB0C6;margin-top:1px}",
      ...
      "html body #page .fo-mk-tbl td .qok{font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#177A57}",
      ...
      "html body #page .fo-mk-tbl td .hbc{display:block;font:600 12px/1.5 Manrope,sans-serif}",
      ...
      "html body #page .fo-mk-tbl .hmwrap.tbl .clk{display:inline;font:600 12.5px/1.2 Manrope,sans-serif;letter-spacing:.04em;color:#14243A;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-mk-tbl .qb{font:600 11px/1 Manrope,sans-serif !important;letter-spacing:.1em;text-transform:uppercase;color:#FFFEFC !important;background:#C9571F !important;border:0 !important;border-radius:999px !important;padding:8px 12px !important;cursor:pointer;box-shadow:none !important}",
      ...
      "html body #topbar #fo-wire-btn #fo-wire-bdg{position:absolute;top:-4px;right:-4px;min-width:16px;height:16px;border-radius:8px;background:#8E1F13;color:#fff;font:700 10px/16px Manrope,sans-serif;text-align:center;padding:0 4px;box-shadow:0 0 0 2px #14243A}",
      ...
      "#fo-wire-pop .ph span{margin-left:auto;font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#C9571F;cursor:pointer}",
      ...
      "#fo-wire-pop .tx{min-width:0;font:400 13px/1.5 Manrope,sans-serif;color:#2a3444;white-space:normal}",
      "#fo-wire-pop .tx i{display:block;font-style:normal;font:400 12px/1.5 Manrope,sans-serif;color:#6A6354;margin-top:2px}",
      ...
      "#fo-wire-pop .tx b{display:block;font:600 12.5px/1.4 Manrope,sans-serif;color:#1B2432}",
      "html body #fo-wire-pop a.pf{display:block;padding:12px 16px;text-align:center;font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#C9571F !important;text-decoration:none;border-top:1px solid rgba(27,36,50,.08)}",
