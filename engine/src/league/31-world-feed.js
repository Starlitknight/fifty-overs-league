...
(function () {
  ...
  var CSS = [
    ...
    "html body #page #fo-wsvc>i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#177A57;font-style:normal}",
    ...
    "html body #page #fo-wsvc .r{display:flex;gap:8px;align-items:baseline;font:500 13px/1.5 Inter,sans-serif;color:#1B2432}",
    ...
    "html body #page #fo-wsvc .r u{text-decoration:none;font:700 10px/1 Oswald,sans-serif;color:#B44A22;letter-spacing:.1em}",
