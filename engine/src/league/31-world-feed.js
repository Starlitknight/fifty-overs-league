...
(function () {
  ...
  var CSS = [
    ...
    "html body #page #fo-wsvc>i{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#177A57;font-style:normal}",
    ...
    "html body #page #fo-wsvc .r u{text-decoration:none;font:700 11px/1 Inter,sans-serif;color:#B44A22;letter-spacing:.1em}",
