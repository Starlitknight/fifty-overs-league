  ...
  function foOrdPlanVisual() {
    try {
      ...
      var mix = "<div class='fo-ord-xinote'><b>" + nBat + " bat" + (nBat === 1 ? "" : "s") + "</b> · <b>" + nWk + " keeper" + (nWk === 1 ? "" : "s") + "</b> · <b>" + nSeam + " seam</b> · <b>" + nSpin + " spin</b> · <b>" + nAr + " all-rounder" + (nAr === 1 ? "" : "s") + "</b> · tap a player for his card</div>";
