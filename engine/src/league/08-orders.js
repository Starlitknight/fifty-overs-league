  ...
  function foOrdPlanVisual() {
    try {
      ...
      var chip = function (nm, i, dim) {
        ...
        var bars = foOrdB3([
          ["T", "Technique (vs pace & spin)", ((sk.vsPace || 0) + (sk.vsSpin || 0)) / 2],
          ["P", "Power hitting", sk.power || 0],
          ["S", "Stamina", sk.stamina || 0]
        ]);
      ...
      var mix = "<div class='fo-ord-xinote'>The mix: <b>" + nSeam + " seam</b> · <b>" + nSpin + " spin</b> · <b>" + nAr + " all-rounder" + (nAr === 1 ? "" : "s") + "</b> - " + nBowl + " bowling options for this pitch. Stars show each man's standing in YOUR squad · bars: <b>T</b>echnique, <b>P</b>ower, <b>S</b>tamina · gold pills are talents · tap any player for his full card.</div>";
      ...
      // each bowler as a small card: colour key, type, overs, the bowling
      // lens (wickets/economy/stamina) and his talents
      var legend = "<div class='fo-ord-bws'>" + Object.keys(tot).map(function (nm3) {
        var p3 = by[nm3] || {}, sk3 = p3.skills || {};
        var bars3 = foOrdB3([
          ["W", "Wicket threat", sk3.wicket || 0],
          ["E", "Economy (hard to score off)", sk3.economy || 0],
          ["S", "Stamina", sk3.stamina || 0]
        ]);
        return "<button type='button' class='bw' data-fo-pc='" + E(nm3) + "'>" +
          "<span class='bw-h'><i style='background:" + (cols[nm3] || "#8a93a3") + "'></i><b>" + E(dispNm(nm3)) + "</b><span class='bt'>" + E(foOrdBType(p3)) + "</span><u>" + tot[nm3] + " ov</u></span>" +
      ...
      return cards + "<div class='fo-ord-vzh'>The XI, in batting order</div>" + xiChips + bench +
        ...
        "<div class='fo-ord-vzh'>The fifty overs of bowling <span>&middot; bars: <b>W</b>ickets · <b>E</b>conomy · <b>S</b>tamina</span></div><div class='fo-ord-bstrip'>" + cells + "</div>" + legend +
