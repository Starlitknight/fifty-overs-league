  ...
  function foOrdFrontline(p) { return !!p.bowlType && p.bowlType !== "none" && !/part/i.test(p.bowlTypeFull || ""); }
  // each man is rated at HIS job: bowlers on the ball, batters on the bat,
  // all-rounders on their better half
  function foOrdPrimeComp(p) {
    var b = foOrdBatComp(p);
