...
(function () {
  ...
  function foFinCss() {
    ...
    s.textContent = [
      ...
      ".fo-st-head{display:grid;grid-template-columns:46px minmax(0,1fr) 96px 96px;gap:10px;padding:0 12px 7px;font:600 11px/1 Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      ".fo-st-day{padding:9px 13px;background:rgba(14,34,70,.055);font:700 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#14243A;border-top:1px solid rgba(20,28,40,.09)}",
      ...
      "html body #page .fo-st-more{display:block;width:100%;margin-top:12px;font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14243A !important;background:var(--paper) !important;border:1px solid rgba(20,28,40,.18) !important;border-radius:12px !important;padding:0 !important;min-height:46px;cursor:pointer}",
      ...
      ".fo-tre-lbl{font:700 11px/1.2 Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase}",
      ".fo-tre-top{display:flex;justify-content:space-between;align-items:baseline;gap:14px;margin-bottom:22px}",
      ".fo-tre-top .ey{color:var(--brand);font:700 11px/1.2 Inter,sans-serif;letter-spacing:.22em;text-transform:uppercase}",
      ".fo-tre-top .rt{color:var(--mut);font:700 11px/1.2 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;text-align:right}",
      ".fo-tre-head{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,420px);gap:24px 60px;align-items:end}",
      ".fo-tre-bank{font:800 clamp(46px,7.8vw,108px)/0.95 Inter,sans-serif;letter-spacing:-.015em;color:var(--ink);white-space:nowrap}",
      ...
      ".fo-tre-cap span{font:700 11px/1.3 Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a09a8d}",
      ...
      ".fo-me-ey{color:var(--orange);font:700 11px/1.1 Inter,sans-serif;letter-spacing:.17em;text-transform:uppercase;margin-bottom:9px}",
      ...
      ".fo-me-cardtitle{display:flex;align-items:center;gap:12px;margin:0;padding:16px 18px 14px;background:var(--navy);color:#F8F3E8;font:700 12px/1 Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase}",
      ...
      ".fo-me-occ{text-align:center}.fo-me-occ>span{display:block;margin-top:6px;color:var(--mut);font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase}",
      ...
      ".fo-me-kpi span{display:block;color:#667286;font:700 11px/1.3 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase}.fo-me-kpi b{display:block;margin-top:6px;color:var(--ink);font:750 19px/1.05 Inter,sans-serif;font-variant-numeric:tabular-nums;letter-spacing:-.025em;white-space:nowrap}",
      ".fo-me-data{display:grid;grid-template-columns:minmax(0,1.48fr) minmax(270px,.92fr);gap:15px;min-height:303px}",
      ".fo-me-panelhead{min-height:46px;display:flex;align-items:center;gap:10px;padding:1px 16px 0;border-bottom:1px solid #E2DDD4;color:var(--ink);font:700 11px/1 Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-panelhead em{margin-left:auto;color:#7D8795;font:500 10px/1 Inter,sans-serif;letter-spacing:.03em;text-transform:none;font-style:normal}",
      ...
      ".fo-me-matchrow{display:grid;grid-template-columns:58px minmax(0,1fr) 56px;gap:11px;align-items:center}.fo-me-matchrow .date{color:#657286;font:700 11px/1 Inter,sans-serif;letter-spacing:.08em;text-transform:uppercase}.fo-me-matchrow .track{height:10px;border-radius:99px;background:#EEEAE1;overflow:hidden}.fo-me-matchrow .track i{display:block;width:var(--w);height:100%;border-radius:99px;background:linear-gradient(90deg,#F16A31,#D94414);box-shadow:inset 0 -1px 0 rgba(121,31,4,.12)}.fo-me-matchrow b{text-align:right;color:var(--orange);font:750 13px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
      ...
      ".fo-me-donut{width:124px;height:124px;border-radius:50%;position:relative;display:grid;place-items:center;background:var(--mix);box-shadow:inset 0 0 0 1px rgba(19,38,64,.08)}.fo-me-donut:after{content:'';position:absolute;inset:31px;border-radius:50%;background:var(--paper);box-shadow:0 0 0 1px rgba(19,38,64,.04)}.fo-me-donutin{position:relative;z-index:2;text-align:center}.fo-me-donutin span{display:block;color:#778192;font:700 11px/1 Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-donutin b{display:block;margin-top:4px;color:var(--ink);font:750 13px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
      ...
      ".fo-me-health{background:linear-gradient(145deg,var(--navy),#173C63);color:#fff;padding:16px}.fo-me-health h3{margin:0 0 12px;color:#E0B54C;font:700 11px/1.2 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase}.fo-me-health .grade{display:flex;align-items:center;gap:14px;padding:5px 0 13px;border-bottom:1px solid rgba(255,255,255,.14)}.fo-me-health .grade b{font:600 48px/1 Fraunces,serif;color:#E0B54C}.fo-me-health .grade span{font:700 14px/1 Inter,sans-serif;letter-spacing:.11em;color:#6FD3A7}.fo-me-health .stats{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:13px;text-align:center}.fo-me-health .stats span{display:block;color:#9BAEC6;font:700 11px/1.2 Inter,sans-serif;letter-spacing:.1em;text-transform:uppercase}.fo-me-health .stats b{display:block;margin-top:5px;color:#fff;font:700 13px/1.25 Inter,sans-serif}.fo-me-health p{margin:14px 0 0;color:#C2CDDB;font:450 12px/1.5 Inter,sans-serif}",
