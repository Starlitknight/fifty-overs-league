...
(function () {
  ...
  function foFinCss() {
    ...
    s.textContent = [
      ...
      ".fo-fin-bank .lb{font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:#8FA8CC}",
      ...
      ".fo-fin-walk span{font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#8FA8CC}",
      ...
      ".fo-st-head{display:grid;grid-template-columns:46px minmax(0,1fr) 96px 96px;gap:10px;padding:0 12px 7px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      ".fo-st-day{padding:9px 13px;background:rgba(14,34,70,.055);font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#14243A;border-top:1px solid rgba(20,28,40,.09)}",
      ...
      ".fo-st-row .t{font:600 13px/1 Inter,sans-serif;color:rgba(20,28,40,.45);font-variant-numeric:tabular-nums}",
      ".fo-st-row .w{min-width:0}",
      ".fo-st-row .w b{display:block;font:600 13px/1.3 Inter,sans-serif;color:#1B2432}",
      ".fo-st-row .w i{display:block;font-style:normal;font:400 13px/1.4 Inter,sans-serif;color:rgba(20,28,40,.55)}",
      ...
      ".fo-tre-lbl{font:700 10px/1.2 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase}",
      ".fo-tre-top{display:flex;justify-content:space-between;align-items:baseline;gap:14px;margin-bottom:22px}",
      ".fo-tre-top .ey{color:var(--brand);font:700 10px/1.2 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase}",
      ".fo-tre-top .rt{color:var(--mut);font:700 10px/1.2 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;text-align:right}",
      ".fo-tre-head{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,420px);gap:24px 60px;align-items:end}",
      ".fo-tre-bank{font:800 clamp(46px,7.8vw,108px)/0.95 Oswald,Inter,sans-serif;letter-spacing:-.015em;color:var(--ink);white-space:nowrap}",
      ...
      ".fo-tre-delta{font:700 15px/1.2 Inter,sans-serif;color:var(--grn)}.fo-tre-delta.dn{color:var(--red)}",
      ...
      ".fo-tre-cap span{font:700 10px/1.3 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a09a8d}",
      ...
      ".fo-tre-strip b{display:block;font:700 21px/1.15 Inter,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ...
      ".fo-tre-cols{display:grid;grid-template-columns:1fr 1fr;gap:8px 60px;align-items:start}",
      ...
      "html body #page .fo-tre-sec b{font:700 15px/1.2 Inter,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ".fo-tre-row{display:flex;align-items:baseline;gap:12px;padding:11px 0;border-bottom:1px solid var(--edge)}",
      ".fo-tre-row u{text-decoration:none;flex:1;min-width:0;font:600 14px/1.35 Inter,sans-serif;color:#4A4438}",
      "html body #page .fo-tre-row b{font:700 15px/1.2 Inter,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ".fo-tre-row s{text-decoration:none;font:600 11px/1 Inter,sans-serif;color:#a09a8d;min-width:38px;text-align:right;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-tre-net b{font:800 27px/1 Oswald,Inter,sans-serif;color:var(--grn);font-variant-numeric:tabular-nums}",
      ...
      ".fo-tre-line u{text-decoration:none;flex:1;min-width:0;font:600 13px/1.45 Inter,sans-serif;color:#4A4438}",
      ".fo-tre-line u b{color:var(--ink)}",
      "html body #page .fo-tre-line .pj{font:800 20px/1 Oswald,Inter,sans-serif;color:var(--grn);font-variant-numeric:tabular-nums;white-space:nowrap}",
      ...
      "html body #page button.fo-tre-act{font:700 11px/1 Oswald,sans-serif !important;letter-spacing:.13em;text-transform:uppercase;color:var(--brand) !important;background:transparent !important;border:0 !important;border-radius:0 !important;box-shadow:none !important;padding:0 0 0 14px !important;min-height:44px;cursor:pointer}",
      ...
      ".fo-me-occ{text-align:center}.fo-me-occ>span{display:block;margin-top:6px;color:var(--mut);font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase}",
      ...
      ".fo-me-kpi span{display:block;color:#667286;font:700 10px/1.3 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase}.fo-me-kpi b{display:block;margin-top:6px;color:var(--ink);font:750 19px/1.05 Inter,sans-serif;font-variant-numeric:tabular-nums;letter-spacing:-.025em;white-space:nowrap}",
      ".fo-me-data{display:grid;grid-template-columns:minmax(0,1.48fr) minmax(270px,.92fr);gap:15px;min-height:303px}",
      ".fo-me-panelhead{min-height:46px;display:flex;align-items:center;gap:10px;padding:1px 16px 0;border-bottom:1px solid #E2DDD4;color:var(--ink);font:700 10.5px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-panelhead em{margin-left:auto;color:#7D8795;font:500 10px/1 Inter,sans-serif;letter-spacing:.03em;text-transform:none;font-style:normal}",
      ...
      ".fo-me-matchrow{display:grid;grid-template-columns:58px minmax(0,1fr) 56px;gap:11px;align-items:center}.fo-me-matchrow .date{color:#657286;font:700 10px/1 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase}.fo-me-matchrow .track{height:10px;border-radius:99px;background:#EEEAE1;overflow:hidden}.fo-me-matchrow .track i{display:block;width:var(--w);height:100%;border-radius:99px;background:linear-gradient(90deg,#F16A31,#D94414);box-shadow:inset 0 -1px 0 rgba(121,31,4,.12)}.fo-me-matchrow b{text-align:right;color:var(--orange);font:750 13px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-chartfoot{display:flex;align-items:baseline;justify-content:space-between;gap:12px;margin-top:auto;padding:12px 16px 13px;border-top:1px solid #E8E3DA;background:#FAF8F3}.fo-me-chartfoot span{color:#697587;font:650 10px/1.2 Inter,sans-serif}.fo-me-chartfoot b{color:var(--ink);font:750 15px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-empty{display:flex;align-items:center;justify-content:center;min-height:150px;padding:20px;color:var(--mut);font:500 13px/1.55 Inter,sans-serif;text-align:center}",
      ...
      ".fo-me-donut{width:124px;height:124px;border-radius:50%;position:relative;display:grid;place-items:center;background:var(--mix);box-shadow:inset 0 0 0 1px rgba(19,38,64,.08)}.fo-me-donut:after{content:'';position:absolute;inset:31px;border-radius:50%;background:var(--paper);box-shadow:0 0 0 1px rgba(19,38,64,.04)}.fo-me-donutin{position:relative;z-index:2;text-align:center}.fo-me-donutin span{display:block;color:#778192;font:700 10px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-donutin b{display:block;margin-top:4px;color:var(--ink);font:750 13px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
      ...
      ".fo-me-lever .top{display:flex;align-items:center;gap:9px}.fo-me-lever .ic{width:32px;height:32px;border:1px solid #D7C49B;border-radius:10px;display:grid;place-items:center;color:var(--orange);background:#FFF8F0;font:700 13px/1 Inter,sans-serif}.fo-me-lever span{color:#536074;font:700 10px/1.25 Oswald,sans-serif;letter-spacing:.11em;text-transform:uppercase}",
      ...
      "html body #page .fo-me-lever button{margin-top:auto;width:100%;border:0 !important;border-top:1px solid #E2D9C7 !important;border-radius:0 !important;background:transparent !important;color:var(--orange) !important;text-align:left;font:700 10px/1 Oswald,sans-serif !important;letter-spacing:.1em;text-transform:uppercase;padding:10px 0 0 !important;box-shadow:none !important}.fo-me-lever button[disabled]{color:#9E978A !important}",
      ".fo-me-forecast{padding-bottom:13px}.fo-me-forecastbody{display:grid;grid-template-columns:138px minmax(0,1fr);gap:14px;padding:13px 16px 0;align-items:stretch}.fo-me-opp{display:flex;flex-direction:column;align-items:center;justify-content:center;border-right:1px solid #E5DFD4;text-align:center}.fo-me-shield{width:55px;height:61px;clip-path:polygon(8% 0,92% 0,88% 70%,50% 100%,12% 70%);display:grid;place-items:center;background:linear-gradient(150deg,#E0B53E,#C8951F);color:#102641;font:700 16px/1 Fraunces,serif}.fo-me-opp b{margin-top:8px;font:650 16px/1.1 Fraunces,Georgia,serif}.fo-me-opp span{margin-top:6px;color:var(--mut);font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase}",
      ".fo-me-fgrid{display:grid;grid-template-columns:1fr 1fr}.fo-me-fstat{padding:11px;border-bottom:1px solid #E9E4DB}.fo-me-fstat:nth-child(odd){border-right:1px solid #E9E4DB}.fo-me-fstat span{display:block;color:#778294;font:700 10px/1.25 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase}.fo-me-fstat b{display:block;margin-top:6px;color:var(--ink);font:750 14px/1.1 Inter,sans-serif;font-variant-numeric:tabular-nums}.fo-me-fstat.green b{color:var(--green)}",
  ...
  function render(page, st, room) {
    ...
    html2 += "<div class='fo-tre-strip num'>" +
      "<div><b class='" + (perRound >= 0 ? "up" : "dn") + "'>" + (perRound > 0 ? "+" : "") + Mk(Math.round(perRound)) + "</b><span class='fo-tre-lbl'>Per round &middot; operating</span></div>" +
      "<div><b>" + M(billNow) + "</b><span class='fo-tre-lbl'>Wage bill / round</span></div>" +
      "<div><b>" + wageShare + "%</b><span class='fo-tre-lbl'>Wage share of income</span></div>" +
      "<div><b>" + (avgAtt || lastAtt || 0).toLocaleString() + "</b><span class='fo-tre-lbl'>Avg crowd &middot; " + full + "% full</span></div></div>";

    html2 += "<div class='fo-tre-cols'><div>" +
      "<div class='fo-tre-sec'><span class='fo-tre-lbl'>In</span><b>" + M(totIn) + "</b></div>" +
      ...
      "</div><div>" +
      "<div class='fo-tre-sec'><span class='fo-tre-lbl'>Out</span><b>" + M(totOut) + "</b></div>" +
    ...
    html2 += "<div class='fo-tre-desk'><div>" + gateLine +
      ...
      "<div class='fo-fin-msg' id='fo-fin-msg'></div>" + treasurerWord(f, wageShare, perRound, rounds) +
      "</div><div>" +
  ...
  // the treasurer's one-line read, derived from the same figures the page
  // shows - never a stored opinion, so it can disagree with nothing
  function treasurerWord(f, wageShare, perRound, rounds) {
    if (!rounds) return "";
    var grade, read;
    if (f.administration) { grade = "Under"; read = "the club is in administration, and <b>the gate is the route out</b>"; }
    else if (perRound <= 0) { grade = "Tight"; read = "the rounds are running at a loss &mdash; <b>the wage bill is the lever</b>"; }
    else if (wageShare <= 65) { grade = "Sound"; read = "wages well covered; <b>the gate is carrying the club</b>"; }
    else { grade = "Steady"; read = "the club earns more than it spends, but <b>the wage bill is heavy</b>"; }
    return "<p class='fo-tre-word'>&ldquo;" + grade + ". " + read + ".&rdquo; &mdash; the treasurer</p>";
  }
