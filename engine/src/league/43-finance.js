...
(function () {
  ...
  function foSoloCss() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-so-row b{font:700 12.5px/1 Inter,sans-serif;font-variant-numeric:tabular-nums;color:#2A2418}",
      ...
      "html body #page .fo-me-lever .fo-so-bar i{font:600 9px/1 Inter,sans-serif;font-style:normal;color:#9A8E77;font-variant-numeric:tabular-nums}",
