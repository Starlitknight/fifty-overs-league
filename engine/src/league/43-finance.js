...
(function () {
  ...
  function foFinCss() {
    ...
    s.textContent = [
      ...
      "  max-width:1500px;margin:0 auto;padding:24px 28px 44px;color:var(--ink);font-family:Oswald,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif}",
      ...
      ".fo-fin-bank .lb{font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:#9FB0C6}",
      ...
      ".fo-fin-walk span{font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#9FB0C6}",
      ...
      ".fo-fin-admin p{margin:0;font:400 13px/1.6 Oswald,sans-serif;color:rgba(20,28,40,.8)}",
      // the two ledgers
      ...
      ".fo-fin-msg{margin-top:10px;font:600 12.5px/1.5 Oswald,sans-serif;color:#1E7A55}",
      ...
      "html body #page .fo-fin-stlink{display:block;margin-top:18px;padding:14px 16px;background:var(--paper) !important;border:1px solid rgba(20,28,40,.14);border-left:3px solid var(--brand);border-radius:12px;font:600 13px/1.4 Oswald,sans-serif;color:#14243A !important;text-decoration:none !important}",
      // the statement's filter is a line of words, not a toolbar - see .fo-seg
      ".fo-st-head{display:grid;grid-template-columns:46px minmax(0,1fr) 96px 96px;gap:10px;padding:0 12px 7px;font:600 11px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      ".fo-st-day{padding:9px 13px;background:rgba(14,34,70,.055);font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#14243A;border-top:1px solid rgba(20,28,40,.09)}",
      ...
      ".fo-st-row .t{font:600 13px/1 Oswald,sans-serif;color:rgba(20,28,40,.45);font-variant-numeric:tabular-nums}",
      ".fo-st-row .w{min-width:0}",
      ".fo-st-row .w b{display:block;font:600 13px/1.3 Oswald,sans-serif;color:#1B2432}",
      ".fo-st-row .w i{display:block;font-style:normal;font:400 13px/1.4 Oswald,sans-serif;color:rgba(20,28,40,.55)}",
      ...
      ".fo-st-none{padding:22px 14px;text-align:center;font:400 13px/1.6 Oswald,sans-serif;color:rgba(20,28,40,.55)}",
      ...
      ".fo-fin-foot a{display:inline-flex;align-items:center;min-height:44px;font:600 13px Oswald,sans-serif;color:rgba(20,28,40,.65);background:var(--paper);border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:0 17px;text-decoration:none}",
      ...
      ".fo-tre-lbl{font:700 11px/1.2 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase}",
      ".fo-tre-top{display:flex;justify-content:space-between;align-items:baseline;gap:14px;margin-bottom:22px}",
      ".fo-tre-top .ey{color:var(--brand);font:700 11px/1.2 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase}",
      ".fo-tre-top .rt{color:var(--mut);font:700 11px/1.2 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;text-align:right}",
      ".fo-tre-head{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,420px);gap:24px 60px;align-items:end}",
      ".fo-tre-bank{font:800 clamp(46px,7.8vw,108px)/0.95 Oswald,sans-serif;letter-spacing:-.015em;color:var(--ink);white-space:nowrap}",
      ...
      ".fo-tre-delta{font:700 15px/1.2 Oswald,sans-serif;color:var(--grn)}.fo-tre-delta.dn{color:var(--red)}",
      ...
      ".fo-tre-cap span{font:700 11px/1.3 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a09a8d}",
      ...
      ".fo-tre-strip b{display:block;font:700 21px/1.15 Oswald,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-tre-sec b{font:700 15px/1.2 Oswald,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ".fo-tre-row{display:flex;align-items:baseline;gap:12px;padding:11px 0;border-bottom:1px solid var(--edge)}",
      ".fo-tre-row u{text-decoration:none;flex:1;min-width:0;font:600 14px/1.35 Oswald,sans-serif;color:#4A4438}",
      "html body #page .fo-tre-row b{font:700 15px/1.2 Oswald,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ".fo-tre-row s{text-decoration:none;font:600 11px/1 Oswald,sans-serif;color:#a09a8d;min-width:38px;text-align:right;font-variant-numeric:tabular-nums}",
      ...
      ".fo-tre-tot u{text-decoration:none;font:700 13px/1.2 Oswald,sans-serif;color:var(--ink)}",
      "html body #page .fo-tre-tot b{font:700 16px/1.2 Oswald,sans-serif;color:var(--ink);font-variant-numeric:tabular-nums}",
      ".fo-tre-drift{margin-top:10px;font:600 12px/1.5 Oswald,sans-serif;color:var(--red)}",
      ...
      ".fo-tre-line u{text-decoration:none;flex:1;min-width:0;font:600 13px/1.45 Oswald,sans-serif;color:#4A4438}",
      ".fo-tre-line u b{color:var(--ink)}",
      "html body #page .fo-tre-line .pj{font:800 20px/1 Oswald,Oswald,sans-serif;color:var(--grn);font-variant-numeric:tabular-nums;white-space:nowrap}",
      ...
      "a.fo-tre-door .fo-tre-lbl{color:var(--ink);text-transform:none;font:700 13px/1.2 Oswald,sans-serif;letter-spacing:.01em}",
      "a.fo-tre-door i{font-style:normal;font:400 12.5px/1.3 Oswald,sans-serif;color:var(--mut);text-align:right}",
      "a.fo-tre-door .ch{font:400 19px/1 Georgia,serif;color:var(--brand)}",
      "html body #page button.fo-tre-act{font:700 11px/1 Oswald,sans-serif !important;letter-spacing:.13em;color:var(--brand) !important;background:transparent !important;border:0 !important;border-radius:0 !important;box-shadow:none !important;padding:0 0 0 14px !important;min-height:44px;cursor:pointer}",
      ...
      ".fo-me-occ{text-align:center}.fo-me-occ>span{display:block;margin-top:6px;color:var(--mut);font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase}",
      ...
      ".fo-me-ring b{position:relative;z-index:2;color:var(--ink);font:750 16px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums;letter-spacing:-.04em}",
      ".fo-me-cap b{display:block;color:var(--ink);font:750 25px/1.08 Oswald,sans-serif;font-variant-numeric:tabular-nums;letter-spacing:-.035em;white-space:nowrap}.fo-me-cap span{display:block;margin-top:9px;padding-top:9px;border-top:1px solid #D6CDBB;color:var(--mut);font:700 11px/1.3 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-cap em{color:var(--orange);font-style:normal}",
      ...
      ".fo-me-kpi span{display:block;color:#667286;font:700 11px/1.3 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase}.fo-me-kpi b{display:block;margin-top:6px;color:var(--ink);font:750 19px/1.05 Oswald,sans-serif;font-variant-numeric:tabular-nums;letter-spacing:-.025em;white-space:nowrap}",
      ".fo-me-data{display:grid;grid-template-columns:minmax(0,1.48fr) minmax(270px,.92fr);gap:15px;min-height:303px}",
      ".fo-me-panelhead{min-height:46px;display:flex;align-items:center;gap:10px;padding:1px 16px 0;border-bottom:1px solid #E2DDD4;color:var(--ink);font:700 11px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-panelhead em{margin-left:auto;color:#7D8795;font:500 10px/1 Oswald,sans-serif;letter-spacing:.03em;text-transform:none;font-style:normal}",
      ...
      ".fo-me-matchrow{display:grid;grid-template-columns:58px minmax(0,1fr) 56px;gap:11px;align-items:center}.fo-me-matchrow .date{color:#657286;font:700 11px/1 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase}.fo-me-matchrow .track{height:10px;border-radius:99px;background:#EEEAE1;overflow:hidden}.fo-me-matchrow .track i{display:block;width:var(--w);height:100%;border-radius:99px;background:linear-gradient(90deg,#F16A31,#D94414);box-shadow:inset 0 -1px 0 rgba(121,31,4,.12)}.fo-me-matchrow b{text-align:right;color:var(--orange);font:750 13px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-chartfoot{display:flex;align-items:baseline;justify-content:space-between;gap:12px;margin-top:auto;padding:12px 16px 13px;border-top:1px solid #E8E3DA;background:#FAF8F3}.fo-me-chartfoot span{color:#697587;font:650 10px/1.2 Oswald,sans-serif}.fo-me-chartfoot b{color:var(--ink);font:750 15px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-empty{display:flex;align-items:center;justify-content:center;min-height:150px;padding:20px;color:var(--mut);font:500 13px/1.55 Oswald,sans-serif;text-align:center}",
      ...
      ".fo-me-donut{width:124px;height:124px;border-radius:50%;position:relative;display:grid;place-items:center;background:var(--mix);box-shadow:inset 0 0 0 1px rgba(19,38,64,.08)}.fo-me-donut:after{content:'';position:absolute;inset:31px;border-radius:50%;background:var(--paper);box-shadow:0 0 0 1px rgba(19,38,64,.04)}.fo-me-donutin{position:relative;z-index:2;text-align:center}.fo-me-donutin span{display:block;color:#778192;font:700 11px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase}.fo-me-donutin b{display:block;margin-top:4px;color:var(--ink);font:750 13px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-mixrow{display:grid;grid-template-columns:9px minmax(0,1fr) auto;gap:9px;align-items:center;padding:8px 0;border-bottom:1px solid #ECE7DE;color:#526073;font:500 12px/1 Oswald,sans-serif}.fo-me-mixrow:last-child{border-bottom:0}.fo-me-mixrow i{width:8px;height:8px;border-radius:3px}.fo-me-mixrow b{color:var(--ink);font-size:11px;font-variant-numeric:tabular-nums}",
      ...
      ".fo-me-lever .top{display:flex;align-items:center;gap:9px}.fo-me-lever .ic{width:32px;height:32px;border:1px solid #D7C49B;border-radius:10px;display:grid;place-items:center;color:var(--orange);background:#FFF8F0;font:700 13px/1 Oswald,sans-serif}.fo-me-lever span{color:#536074;font:700 11px/1.25 Oswald,sans-serif;letter-spacing:.11em;text-transform:uppercase}",
      ".fo-me-lever b{display:block;margin-top:8px;color:var(--ink);font:750 15px/1.12 Oswald,sans-serif;letter-spacing:-.015em}.fo-me-lever em{display:block;margin:8px 0;color:var(--mut);font:450 12px/1.42 Oswald,sans-serif;font-style:normal}",
      "html body #page .fo-me-lever button{margin-top:auto;width:100%;border:0 !important;border-top:1px solid #E2D9C7 !important;border-radius:0 !important;background:transparent !important;color:var(--orange) !important;text-align:left;font:700 11px/1 Oswald,sans-serif !important;letter-spacing:.1em;text-transform:uppercase;padding:10px 0 0 !important;box-shadow:none !important}.fo-me-lever button[disabled]{color:#9E978A !important}",
      // the ticket dial
      ".fo-me-lever.fo-tk b{display:flex;align-items:baseline;gap:8px}",
      ".fo-me-lever.fo-tk b s{text-decoration:none;font:750 22px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums}",
      ".fo-me-lever.fo-tk b s:before{content:'$';font-size:14px;font-weight:600;color:#778192;margin-right:1px}",
      ".fo-me-lever.fo-tk b i{font:500 11px/1 Oswald,sans-serif;font-style:normal;color:#9E978A}",
      ".fo-tk-dial{display:flex;gap:7px;margin-top:9px}",
      "html body #page .fo-tk-dial button{margin:0;width:38px;min-height:34px;flex:0 0 auto;border:1px solid #CFC6B6 !important;border-radius:9px !important;background:#FFFEFA !important;color:#1B2432 !important;font:700 16px/1 Oswald,sans-serif !important;text-align:center;padding:0 !important;letter-spacing:0;text-transform:none}",
      "html body #page .fo-tk-dial button:active{background:#F4EFE3 !important}",
      // the gate board
      ".fo-gb{margin-top:15px;padding:0 15px 6px}",
      ".fo-gb .fo-me-panelhead em{font:450 11.5px/1.3 Oswald,sans-serif;color:var(--mut);font-style:normal;letter-spacing:0;text-transform:none}",
      ...
      ".fo-gb-row .rd{font:700 12px/1.2 Oswald,sans-serif;color:#14243A}",
      ".fo-gb-row .rd u{display:block;margin-top:3px;text-decoration:none;font:500 10.5px/1.2 Oswald,sans-serif;color:#8a8272;white-space:nowrap}",
      ".fo-gb-row .op{min-width:0}",
      ".fo-gb-row .op b{display:block;font:650 13px/1.2 Oswald,sans-serif;color:#1B2432;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      ...
      ".fo-gb-row .op s{text-decoration:none;font:500 11px/1.2 Oswald,sans-serif;color:#6A6354;font-variant-numeric:tabular-nums}",
      ".fo-gb-row .op s b.hot{font:700 10px/1.2 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#B4441C}",
      ".fo-gb-row .op .pr{display:flex;align-items:center;gap:7px;margin-top:7px}",
      ".fo-gb-row .op .pr b{font:700 13px/1 Oswald,sans-serif;color:#14243A;min-width:36px;text-align:center;font-variant-numeric:tabular-nums}",
      ".fo-gb-row .op .pr.lk{font:600 11px/1 Oswald,sans-serif;color:#8a8272}",
      "html body #page .fo-gb-row .pr button{width:28px;min-height:28px;padding:0 !important;margin:0;flex:0 0 auto;border:1px solid #CFC6B6 !important;border-radius:8px !important;background:#FFFEFA !important;color:#1B2432 !important;font:700 14px/1 Oswald,sans-serif !important;text-align:center;letter-spacing:0;text-transform:none;box-shadow:none !important}",
      ...
      ".fo-gb-row .tk b{display:block;font:700 13px/1.2 Oswald,sans-serif;color:#14243A;font-variant-numeric:tabular-nums}",
      ".fo-gb-row .tk u{display:block;margin-top:2px;text-decoration:none;font:600 9.5px/1.2 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#9E978A}",
      ".fo-gb-row .tk em{display:block;margin-top:3px;font:600 10.5px/1.2 Oswald,sans-serif;font-style:normal;color:#C08A2E}",
      ".fo-gb-row .tk em.lk{color:#177A57}",
      ".fo-me-forecast{padding-bottom:13px}.fo-me-forecastbody{display:grid;grid-template-columns:138px minmax(0,1fr);gap:14px;padding:13px 16px 0;align-items:stretch}.fo-me-opp{display:flex;flex-direction:column;align-items:center;justify-content:center;border-right:1px solid #E5DFD4;text-align:center}.fo-me-shield{width:55px;height:61px;clip-path:polygon(8% 0,92% 0,88% 70%,50% 100%,12% 70%);display:grid;place-items:center;background:linear-gradient(150deg,#E0B53E,#C8951F);color:#102641;font:700 16px/1 Fraunces,serif}.fo-me-shield.arms,.fo-me-shield.crest{clip-path:none;background:none;width:auto;min-width:52px;height:61px;display:flex;align-items:center;justify-content:center}.fo-me-shield.crest{object-fit:contain;max-width:64px}.fo-me-shield.arms svg{display:block}.fo-me-opp b{margin-top:8px;font:650 16px/1.1 Fraunces,Georgia,serif}.fo-me-opp span{margin-top:6px;color:var(--mut);font:700 11px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase}",
      ".fo-me-fgrid{display:grid;grid-template-columns:1fr 1fr}.fo-me-fstat{padding:11px;border-bottom:1px solid #E9E4DB}.fo-me-fstat:nth-child(odd){border-right:1px solid #E9E4DB}.fo-me-fstat span{display:block;color:#778294;font:700 11px/1.25 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase}.fo-me-fstat b{display:block;margin-top:6px;color:var(--ink);font:750 14px/1.1 Oswald,sans-serif;font-variant-numeric:tabular-nums}.fo-me-fstat.green b{color:var(--green)}",
      ".fo-me-recon{display:flex;flex-wrap:wrap;align-items:baseline;gap:6px 16px;padding:13px 16px;border:1px solid var(--edge);border-radius:13px;background:#FAF8F3;color:#667387;font:500 13px/1.5 Oswald,sans-serif}",
