...
(function () {
  ...
  function foFinCss() {
    ...
    s.textContent = [
      ...
      ".fo-me-oval:after{content:'FO  •  HOME';position:absolute;z-index:3;left:50%;top:-13px;transform:translateX(-50%);padding:5px 10px;border:2px solid #E6D7B5;border-radius:3px;background:#102641;color:#F4C75A;font:700 7px/1 Oswald,sans-serif;letter-spacing:.16em;white-space:nowrap;box-shadow:0 3px 7px rgba(16,38,65,.24)}",
      ...
      "@media(max-width:820px){html body.fo-fin-on{background:#EEEAE1 !important}.fo-fin{padding:16px 12px 92px}.fo-me{gap:12px}.fo-me-head{display:block;padding:2px 2px 4px}.fo-me-ey{font-size:10px;letter-spacing:.16em;margin-bottom:7px}.fo-me-head h1{font-size:clamp(34px,9.6vw,42px);line-height:.98;letter-spacing:-.04em}.fo-me-head p{margin-top:8px;font-size:13px;line-height:1.45}.fo-me-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:14px 0 0;padding:0}.fo-me-actions .fo-me-btn{min-width:0;width:100%;height:48px;padding:0 10px !important;font-size:10px !important;letter-spacing:.1em}.fo-me-top,.fo-me-data,.fo-me-bottom,.fo-me-account{display:flex;flex-direction:column;gap:12px}.fo-me-card{border-radius:12px;box-shadow:0 3px 12px rgba(20,35,55,.055)}.fo-me-stadium{min-height:0;padding:14px 14px 16px;border-color:#102641;background:linear-gradient(180deg,#102641 0,#19385D 238px,#FFFEFB 238px)}.fo-me-cardtitle{margin-bottom:10px;color:#F9F5EA;font-size:11px;letter-spacing:.1em}.fo-me-cardtitle:before,.fo-me-cardtitle:after{background:#D4A53A}.fo-me-oval{width:min(96%,340px);margin:3px auto 16px;aspect-ratio:1.6;border-width:14px;background:repeating-conic-gradient(from 1deg,#E2C77F 0 9deg,#F5EEDF 9deg 16deg,#C9572D 16deg 24deg,#F5EEDF 24deg 31deg,#173454 31deg 39deg,#F5EEDF 39deg 46deg);box-shadow:inset 0 0 0 3px #C7A14C,0 10px 24px rgba(4,15,30,.34)}.fo-me-oval:before{inset:12px;border-width:6px;background:repeating-linear-gradient(90deg,rgba(255,255,255,.055) 0 25px,rgba(6,54,31,.055) 25px 50px),#3E7B4C}.fo-me-oval:after{top:-11px;font-size:7px}.fo-me-pitch{width:29px;height:91px}.fo-me-pitch:before,.fo-me-pitch:after{left:-6px;width:39px}.fo-me-stadfoot{grid-template-columns:78px 1fr;gap:14px;margin-top:2px}.fo-me-ring{width:70px;height:70px}.fo-me-ring:after{inset:7px}.fo-me-ring b{font-size:20px}.fo-me-ring span{top:11px;font-size:6.5px}.fo-me-cap b{font-size:20px}.fo-me-cap span{margin-top:7px;padding-top:7px;font-size:9px;letter-spacing:.11em}.fo-me-right{gap:12px}.fo-me-kpis{grid-template-columns:1fr 1fr;gap:8px}.fo-me-kpi{min-height:88px;padding:12px 10px;grid-template-columns:34px minmax(0,1fr);gap:9px}.fo-me-kpi .ico{width:34px;height:34px;font-size:14px}.fo-me-kpi span{font-size:9px;line-height:1.25;letter-spacing:.1em}.fo-me-kpi b{margin-top:5px;font-size:17px}.fo-me-panelhead{height:45px;padding:0 14px;font-size:10.5px;letter-spacing:.12em}.fo-me-bars{height:178px;margin-top:10px;padding:12px 8px 28px;gap:8px;background:repeating-linear-gradient(to bottom,#fff 0 33px,#E9ECEF 34px)}.fo-me-bar{max-width:34px}.fo-me-bar b{bottom:calc(100% + 5px);font-size:9px}.fo-me-bar span{top:calc(100% + 8px);font-size:8px;letter-spacing:.06em}.fo-me-chartleg{gap:12px;margin-top:11px;font-size:9px;line-height:1.25}.fo-me-mixbody{grid-template-columns:108px 1fr;gap:13px;padding:17px 14px 7px}.fo-me-donut{width:104px;height:104px}.fo-me-donut:after{inset:25px;font-size:7px}.fo-me-mixrow{padding:7px 0;font-size:11px}.fo-me-mixrow b{font-size:11px}.fo-me-bottom .fo-me-forecast{order:-1}.fo-me-forecastbody{grid-template-columns:96px 1fr;gap:10px;padding:12px 12px 0}.fo-me-shield{width:48px;height:54px;font-size:15px}.fo-me-opp b{margin-top:7px;font-size:14px}.fo-me-opp span{font-size:8px;letter-spacing:.1em}.fo-me-fstat{padding:10px 8px}.fo-me-fstat span{font-size:8.5px;letter-spacing:.08em}.fo-me-fstat b{margin-top:5px;font-size:14px}.fo-me-levers{padding:0 10px 10px}.fo-me-levergrid{grid-template-columns:1fr 1fr;gap:8px}.fo-me-lever{min-height:154px;padding:11px}.fo-me-lever .top{gap:7px}.fo-me-lever .ic{width:30px;height:30px;font-size:12px}.fo-me-lever span{font-size:9px;letter-spacing:.09em}.fo-me-lever b{margin-top:7px;font-size:15px}.fo-me-lever em{margin:7px 0;font-size:11px;line-height:1.35}.fo-me-lever button{font-size:8.5px !important;letter-spacing:.08em;padding-top:9px !important}.fo-me-account{grid-template-columns:1fr}.fo-me-account .fo-f2-card{padding:15px 14px}.fo-me-account .fo-f2-sh{margin:-15px -14px 11px;padding:12px 14px 11px;font-size:11px}.fo-me-account .fo-f2-r{padding:9px 0;font-size:12.5px}.fo-me-health{padding:15px}.fo-me-health h3{font-size:10.5px;line-height:1.25}.fo-me-health .grade b{font-size:44px}.fo-me-health .grade span{font-size:13px}.fo-me-health .stats span{font-size:8px;line-height:1.25}.fo-me-health .stats b{font-size:12px;line-height:1.3}.fo-me-health p{font-size:11px;line-height:1.55}.fo-fin-stlink{margin-top:2px !important;padding:15px !important;font-size:12px !important;line-height:1.45 !important}.fo-fin-foot{margin-top:0}.fo-fin-foot a{min-height:46px;font-size:12px;padding:0 14px}}",
      "@media(max-width:360px){.fo-fin{padding-left:9px;padding-right:9px}.fo-me-head h1{font-size:32px}.fo-me-actions{grid-template-columns:1fr}.fo-me-kpis{grid-template-columns:1fr}.fo-me-kpi{min-height:76px}.fo-me-levergrid{grid-template-columns:1fr}.fo-me-forecastbody{grid-template-columns:82px 1fr}.fo-me-mixbody{grid-template-columns:92px 1fr;padding-left:10px;padding-right:10px}.fo-me-donut{width:88px;height:88px}.fo-me-donut:after{inset:21px}.fo-me-stadfoot{grid-template-columns:68px 1fr;gap:10px}.fo-me-ring{width:64px;height:64px}.fo-me-cap b{font-size:18px}}"
    ].join("\n");
