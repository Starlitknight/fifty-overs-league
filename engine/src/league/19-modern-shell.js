...
(function () {
  ...
  var CSS = [
    // == glass topbar ==========================================================
    "#topbar#topbar{position:sticky;top:0;z-index:320;background:rgba(253,252,249,.86) !important;-webkit-backdrop-filter:blur(20px) saturate(1.4);backdrop-filter:blur(20px) saturate(1.4);border-bottom:1px solid rgba(20,28,40,.1) !important;box-shadow:0 10px 30px rgba(30,38,52,.1);padding:5px 12px;gap:4px;align-items:center}",
    "@supports not (backdrop-filter:blur(1px)){#topbar#topbar{background:rgba(253,252,249,.98) !important}}",
    "#topbar#topbar .brand{font:700 13.5px/1 Inter,sans-serif;letter-spacing:.2px;color:#141C28 !important;padding:7px 10px 7px 2px}",
    ...
    "#topbar#topbar a{border-radius:999px;padding:7px 13px;font:600 12px/1 Inter,sans-serif;color:rgba(20,28,40,.62) !important;transition:background .15s ease,color .15s ease}",
    "#topbar#topbar a:hover{background:rgba(20,28,40,.06) !important;color:#0B1220 !important;text-decoration:none}",
    "#topbar#topbar a.on{background:rgba(20,28,40,.08) !important;color:#0B1220 !important;box-shadow:inset 0 0 0 1px rgba(20,28,40,.08) !important;font-weight:700}",
    "#topbar#topbar a.fo-logout{color:rgba(20,28,40,.38) !important}",
    "#topbar#topbar #fo-clock{border-left:none;color:rgba(20,28,40,.45);font:500 11px/1 Inter,sans-serif;font-variant-numeric:tabular-nums}",
    "#topbar#topbar #fo-top-status{color:rgba(20,28,40,.55)}",
    "#topbar#topbar #fo-top-status span{border-left:1px solid rgba(20,28,40,.12);padding-left:10px}",
    // live pill: quiet glass by default, red only when something is on air
    "#topbar#topbar #fo-mlive{display:inline-flex;align-items:center;gap:6px;background:rgba(20,28,40,.05) !important;border:1px solid rgba(20,28,40,.12);color:rgba(20,28,40,.5) !important;font:700 11px/1 Inter,sans-serif;letter-spacing:.4px;padding:6px 12px;border-radius:999px}",
    "#topbar#topbar #fo-mlive .live-dot{width:7px;height:7px;border-radius:50%;background:rgba(20,28,40,.3);display:inline-block}",
    "#topbar#topbar #fo-mlive.on{background:rgba(229,57,53,.1) !important;border-color:rgba(229,57,53,.5);color:#C22823 !important}",
    ...
    "#topbar#topbar #fo-mnav-btn{background:transparent;border:none;color:#141C28;border-radius:12px;padding:6px;cursor:pointer}",
    "#topbar#topbar #fo-mnav-btn:hover{background:rgba(20,28,40,.06)}",
    // == the drawer, glassed ===================================================
    "#fo-mdrawer#fo-mdrawer .fo-mdp{background:rgba(253,252,249,.95) !important;-webkit-backdrop-filter:blur(26px) saturate(1.4);backdrop-filter:blur(26px) saturate(1.4);border-right:1px solid rgba(20,28,40,.1);color:#141C28 !important}",
    "#fo-mdrawer#fo-mdrawer .fo-mdl{border-radius:12px;margin:2px 8px;font:600 13.5px/1 Inter,sans-serif;color:rgba(20,28,40,.75) !important;border:none !important}",
    "#fo-mdrawer#fo-mdrawer .fo-mdl:hover{background:rgba(20,28,40,.05) !important}",
    "#fo-mdrawer#fo-mdrawer .fo-mdl.on{background:rgba(232,102,60,.12) !important;color:#B44A22 !important}",
    // == the phone tab dock ====================================================
    "#fo-dock{display:none}",
    "@media(max-width:820px){",
    "#fo-dock{position:fixed;left:12px;right:12px;bottom:calc(10px + env(safe-area-inset-bottom,0px));z-index:340;display:flex;align-items:stretch;background:rgba(253,252,249,.9);-webkit-backdrop-filter:blur(24px) saturate(1.4);backdrop-filter:blur(24px) saturate(1.4);border:1px solid rgba(20,28,40,.1);border-radius:24px;box-shadow:0 18px 40px rgba(30,38,52,.22),inset 0 1px 0 rgba(255,255,255,.7);padding:7px 6px calc(7px + env(safe-area-inset-bottom,0px)*0)}",
    "#fo-dock.off{display:none}",
    "#fo-dock a,body.ftpskin #fo-dock a{flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;padding:4px 0 3px;border-radius:16px;color:rgba(20,28,40,.52) !important;text-decoration:none;transition:color .15s ease,transform .12s ease}",
    ...
    "#fo-dock a.on,body.ftpskin #fo-dock a.on{color:#D9552A !important}",
    "#fo-dock a.on svg{filter:drop-shadow(0 0 8px rgba(217,85,42,.35))}",
