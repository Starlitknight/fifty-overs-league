...
(function () {
  ...
  var CSS = [
    ...
    "#topbar#topbar .brand{font:700 13.5px/1 Manrope,sans-serif;letter-spacing:.2px;color:#FFFFFF !important;padding:7px 10px 7px 2px}",
    ...
    "#topbar#topbar a{border-radius:999px;padding:7px 13px;font:600 13px/1 Manrope,sans-serif;color:rgba(233,238,246,.68) !important;transition:background .15s ease,color .15s ease}",
    ...
    "#topbar#topbar #fo-clock{border-left:none;color:rgba(233,238,246,.5);font:500 13px/1 Manrope,sans-serif;font-variant-numeric:tabular-nums}",
    ...
    "#topbar#topbar #fo-mlive{display:none;align-items:center;gap:6px;height:24px;padding:0 9px;border-radius:4px;background:transparent !important;border:1px solid rgba(233,238,246,.22) !important;color:rgba(233,238,246,.62) !important;font:700 12px/1 Manrope,sans-serif !important;letter-spacing:.13em;text-transform:uppercase;text-decoration:none !important;white-space:nowrap;box-shadow:none !important;transition:transform .12s ease,box-shadow .12s ease,background .12s ease}",
    ...
    "#fo-mdrawer#fo-mdrawer .fo-mdl{border-radius:12px;margin:2px 8px;font:600 13.5px/1 Manrope,sans-serif;color:rgba(233,238,246,.78) !important;border:none !important}",
    ...
    "html body #page .fo-mc-kick{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#B44A22}",
    "html body #page .fo-mc-hero h1{font-family:Manrope,sans-serif;font-weight:600;font-size:34px;letter-spacing:.04em;text-transform:uppercase;margin:6px 0 8px;color:#1B2432}",
    ...
    "html body #page .fo-mc-row i{font:500 12px/1 Manrope,sans-serif;color:rgba(20,28,40,.45);font-style:normal;font-variant-numeric:tabular-nums;white-space:nowrap}",
    "html body #page .fo-mc-row b{font:600 13.5px/1.35 Manrope,sans-serif;color:#1B2432;min-width:0}",
    ...
    "html body #page .fo-mc-foot{display:flex;justify-content:space-between;flex-wrap:wrap;gap:6px 14px;margin-top:16px}",
    "html body #page .fo-mc-foot a{font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
