...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-pp-scv em{float:right;font:700 12px/1 Inter,sans-serif;font-style:normal;color:#141C28;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-pp-bar em{text-align:right;font:600 11.5px/1 Inter,sans-serif;font-style:normal;color:#141C28;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-pp-mini b{display:block;font:600 21px/1 Inter,sans-serif;color:#141C28;font-variant-numeric:tabular-nums}",
