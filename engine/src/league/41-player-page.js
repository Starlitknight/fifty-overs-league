...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-pp-log th{font:700 10px Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#8a8272;text-align:left;padding:6px 8px;border-bottom:1px solid #eee7d9;white-space:nowrap}",
    ...
    "html body #page a.fo-pp-back{display:inline-flex;align-items:center;min-height:44px;padding:0 12px;margin:0 -12px 6px;border-radius:12px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--nac);text-decoration:none}",
    // ---- the hero -----------------------------------------------------------
    ...
    "html body #page .fo-pp-no{position:absolute;z-index:2;left:9px;bottom:7px;text-shadow:0 1px 4px rgba(6,12,24,.9);font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;color:rgba(232,214,168,.85)}",
    "html body #page .fo-pp-id{min-width:0}",
    "html body #page .fo-pp-k{font:700 10px/1 Oswald,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:var(--nac)}",
    ...
    "html body #page .fo-pp-strip i{display:block;margin-top:4px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42);font-style:normal}",
    ...
    "html body #page .fo-pp-scv i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    ...
    "html body #page .fo-pp-ovr i{font-style:normal;font:600 10px/1 Oswald,sans-serif;letter-spacing:.2em;color:rgba(232,214,168,.7)}",
    ...
    "html body #page .fo-pp-talk{flex:0 0 auto;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#0C1B2E;background:var(--gold);border-radius:5px;padding:3px 6px;margin-top:1px}",
    ...
    "html body #page .fo-pp-card h3 span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    ...
    "html body #page .fo-pp-filt a{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);border:1px solid rgba(20,28,40,.14);border-radius:999px;padding:6px 11px;cursor:pointer;text-decoration:none}",
    ...
    "html body #page .fo-pp-radar .fo-pp-rlab{font:700 10px Oswald,sans-serif;letter-spacing:.1em;fill:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-pp-bar i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;color:rgba(20,28,40,.5);font-style:normal}",
    ...
    "html body #page .fo-pp-mini i{display:block;margin-top:5px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);font-style:normal}",
    ...
    "html body #page .fo-pp-meter i{font:700 10px/1.2 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;align-self:center}",
    ...
    "html body #page .fo-pp-ev u{display:block;text-decoration:none;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--nac);font-style:normal;margin-bottom:3px}",
    ...
    "html body #page .fo-pp-nxm{margin-top:6px;text-align:center;font:700 10px/1.5 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(255,254,252,.6)}",
    ...
    "html body #page .fo-pp-track span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.55);background:rgba(20,28,40,.05);border-radius:999px;padding:7px 11px}",
    ...
    "html body #page .fo-pp-hist .se{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-pp-slot .panel table th{font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,28,40,.42);text-align:left;padding:6px 7px;border-bottom:1px solid rgba(20,28,40,.1)}",
    ...
    "html body #page .fo-pp-slot .fo-cp-tab{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);border:1px solid rgba(20,28,40,.14);border-radius:999px;padding:6px 11px;cursor:pointer;text-decoration:none}",
    ...
    "html body #page .fo-pp-slot .fo-cp-ev i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:var(--nac);font-style:normal;flex:0 0 auto}",
