...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-pp-log{width:100%;border-collapse:collapse;font:500 12.5px Oswald,sans-serif}",
    "html body #page .fo-pp-log th{font:700 11px Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#8a8272;text-align:left;padding:6px 8px;border-bottom:1px solid #eee7d9;white-space:nowrap}",
    ...
    "html body #page a.fo-pp-back{display:inline-flex;align-items:center;min-height:44px;padding:0 12px;margin:0 -12px 6px;border-radius:12px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:var(--nac);text-decoration:none}",
    // ---- the hero -----------------------------------------------------------
    ...
    "html body #page .fo-pp-no{position:absolute;z-index:2;left:9px;bottom:7px;text-shadow:0 1px 4px rgba(6,12,24,.9);font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;color:rgba(232,214,168,.85)}",
    "html body #page .fo-pp-id{min-width:0}",
    "html body #page .fo-pp-k{font:700 11px/1 Oswald,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:var(--nac)}",
    ...
    "html body #page .fo-pp-strip b{display:block;font:600 13px/1.25 Oswald,sans-serif;color:#1B2432;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
    "html body #page .fo-pp-strip b .fo-pp-ud{font-size:.68em;font-weight:600;opacity:.5;margin:0 .12em 0 .04em}",
    "html body #page .fo-pp-strip i{display:block;margin-top:4px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42);font-style:normal}",
    ...
    "html body #page .fo-pp-scv i{font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    "html body #page .fo-pp-scv em{float:right;font:700 13px/1 Oswald,sans-serif;font-style:normal;color:#1B2432;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-pp-ovr i{font-style:normal;font:600 11px/1 Oswald,sans-serif;letter-spacing:.2em;color:rgba(232,214,168,.7)}",
    ...
    "html body #page .fo-pp-talk{flex:0 0 auto;font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#0C1B2E;background:var(--gold);border-radius:5px;padding:3px 6px;margin-top:1px}",
    "html body #page .fo-pp-tal b{display:block;font:600 13px/1.3 Oswald,sans-serif;color:#1B2432}",
    "html body #page .fo-pp-tal p{margin:2px 0 0;font:400 13px/1.4 Oswald,sans-serif;color:rgba(20,28,40,.55)}",
    // ---- the rooms ----------------------------------------------------------
    ...
    "html body #page .fo-pp-tabs a{flex:0 0 auto;padding:9px 15px 10px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.46);text-decoration:none;border-bottom:2px solid transparent;margin-bottom:-1px;cursor:pointer}",
    ...
    "html body #page .fo-pp-learn i{font:600 12.5px/1.3 Oswald,sans-serif;font-style:normal;color:#1B2432}",
    ...
    "html body #page .fo-pp-card h3 span{font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    ...
    "html body #page .fo-pp-frline{grid-column:1/-1;margin:8px 0 0;padding-top:8px;border-top:1px solid rgba(20,28,40,.08);font:500 12.5px/1.5 Oswald,sans-serif;color:rgba(20,28,40,.62)}",
    "html body #page .fo-pp-frline b{font-weight:700;letter-spacing:.06em;text-transform:uppercase;font-size:10.5px;color:#8A6A1F}",
    "html body #page a.fo-pp-more{display:inline-block;margin-top:10px;font:600 13px/1 Oswald,sans-serif;color:var(--nac);text-decoration:none}",
    ...
    "html body #page .fo-pp-filt a{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);border:1px solid rgba(20,28,40,.14);border-radius:999px;padding:6px 11px;cursor:pointer;text-decoration:none}",
    ...
    "html body #page .fo-pp-radar .fo-pp-rlab{font:700 11px Oswald,sans-serif;letter-spacing:.1em;fill:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-pp-bar i{font:700 11px/1 Oswald,sans-serif;letter-spacing:.12em;color:rgba(20,28,40,.5);font-style:normal}",
    ...
    "html body #page .fo-pp-bar em{text-align:right;font:600 13px/1 Oswald,sans-serif;font-style:normal;color:#1B2432;font-variant-numeric:tabular-nums}",
    "html body #page .fo-pp-adv{margin-top:12px}",
    "html body #page .fo-pp-adv summary{font:600 13px/1 Oswald,sans-serif;color:var(--nac);cursor:pointer}",
    ...
    "html body #page .fo-pp-advg span{display:flex;justify-content:space-between;align-items:baseline;gap:12px;font:500 13px/1.4 Oswald,sans-serif;color:rgba(20,28,40,.62);background:rgba(20,28,40,.04);border:1px solid rgba(20,28,40,.08);border-radius:8px;padding:5px 10px}",
    ...
    "html body #page .fo-pp-mini b{display:block;font:600 21px/1 Oswald,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
    "html body #page .fo-pp-mini i{display:block;margin-top:5px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);font-style:normal}",
    ...
    "html body #page .fo-pp-meter i{font:700 11px/1.2 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;align-self:center}",
    "html body #page .fo-pp-meter em{font:600 13px/1.2 Oswald,sans-serif;font-style:normal;color:#1B2432;text-align:right}",
    ...
    "html body #page .fo-pp-ev u{display:block;text-decoration:none;font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--nac);font-style:normal;margin-bottom:3px}",
    "html body #page .fo-pp-pos{display:flex;flex-wrap:wrap;gap:5px;margin-bottom:12px}",
    "html body #page .fo-pp-pos span{width:23px;height:23px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font:600 11px/1 Oswald,sans-serif;color:rgba(20,28,40,.4);background:rgba(20,28,40,.05)}",
    ...
    "html body #page .fo-pp-role b{display:block;font:600 13px/1.3 Oswald,sans-serif;color:#1B2432}",
    "html body #page .fo-pp-role i{display:block;font:420 13px/1.45 Fraunces,Georgia,serif;color:rgba(20,28,40,.55)}",
    "html body #page .fo-pp-nx{display:flex;align-items:center;justify-content:center;gap:10px;font:600 13px/1.3 Oswald,sans-serif;color:#FFFEFC;text-align:center}",
    "html body #page .fo-pp-nx i{font:400 13px/1 Fraunces,Georgia,serif;color:rgba(255,254,252,.45)}",
    "html body #page .fo-pp-nxm{margin-top:6px;text-align:center;font:700 11px/1.5 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(255,254,252,.6)}",
    "html body #page .fo-pp-nxbat{margin-top:10px;padding-top:9px;border-top:1px solid rgba(255,254,252,.14);text-align:center;font:600 13px/1.3 Oswald,sans-serif;color:#E8C06A}",
    ...
    "html body #page .fo-pp-track span{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.55);background:rgba(20,28,40,.05);border-radius:999px;padding:7px 11px}",
    ...
    "html body #page .fo-pp-hist .se{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.45)}",
    "html body #page .fo-pp-hist .cl{font:600 13px/1.2 Oswald,sans-serif;color:#1B2432}",
    ...
    "html body #page .fo-pp-chips span{display:inline-flex;align-items:center;gap:6px;font:600 13px/1 Oswald,sans-serif;color:rgba(20,28,40,.7);border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:7px 12px}",
    ...
    "html body #page .fo-pp-slot .panel table{width:100%;border-collapse:collapse;font:500 13px/1.4 Oswald,sans-serif;color:#1B2432}",
    "html body #page .fo-pp-slot .panel table th{font:700 11px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,28,40,.42);text-align:left;padding:6px 7px;border-bottom:1px solid rgba(20,28,40,.1)}",
    ...
    "html body #page .fo-pp-slot .fo-cp-tab{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);border:1px solid rgba(20,28,40,.14);border-radius:999px;padding:6px 11px;cursor:pointer;text-decoration:none}",
    ...
    "html body #page .fo-pp-slot .fo-cp-ev i{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:var(--nac);font-style:normal;flex:0 0 auto}",
    ...
    "html body #page .fo-pp-onbd b{display:block;font:700 12.5px/1.2 Oswald,sans-serif;color:#14243A}",
    "html body #page .fo-pp-onbd i{display:block;margin-top:4px;font:500 13px/1.5 Oswald,sans-serif;font-style:normal;color:rgba(20,28,40,.6);font-variant-numeric:tabular-nums}",
    // ---- the phone ----------------------------------------------------------
