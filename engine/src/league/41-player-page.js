...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-pp-scv em{float:right;font:700 12px/1 Inter,sans-serif;font-style:normal;color:#1B2432;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-pp-talk{flex:0 0 auto;font:700 8px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#0C1B2E;background:var(--gold);border-radius:5px;padding:3px 6px;margin-top:1px}",
    "html body #page .fo-pp-tal b{display:block;font:600 12px/1.3 Inter,sans-serif;color:#1B2432}",
    ...
    "html body #page .fo-pp-dim{margin:9px 0 0;font:420 12px/1.55 Fraunces,Georgia,serif;color:rgba(20,28,40,.55)}",
    ...
    "html body #page .fo-pp-bar em{text-align:right;font:600 11.5px/1 Inter,sans-serif;font-style:normal;color:#1B2432;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-pp-meter em{font:600 11.5px/1.2 Inter,sans-serif;font-style:normal;color:#1B2432;text-align:right}",
    ...
    "html body #page .fo-pp-role i{display:block;font:420 11.5px/1.45 Fraunces,Georgia,serif;color:rgba(20,28,40,.55)}",
    ...
    "html body #page .fo-pp-nx i{font:400 11px/1 Fraunces,Georgia,serif;color:rgba(255,254,252,.45)}",
    ...
    "html body #page .fo-pp-nxbat span{display:block;margin-top:3px;font:420 11px/1.4 Fraunces,Georgia,serif;color:rgba(255,254,252,.55)}",
    ...
    "html body #page .fo-pp-hist .st{font:420 12px/1.4 Fraunces,Georgia,serif;color:rgba(20,28,40,.55);text-align:right}",
    ...
    "html body #page .fo-pp-empty span{display:block;margin-top:4px;font:420 12px/1.5 Fraunces,Georgia,serif;color:rgba(20,28,40,.5)}",
    ...
    "html body #page .fo-pp-slot .panel table{width:100%;border-collapse:collapse;font:500 12px/1.4 Inter,sans-serif;color:#1B2432}",
    ...
    "html body #page .fo-pp-slot .panel .small{font:420 11.5px/1.5 Fraunces,Georgia,serif;color:rgba(20,28,40,.55)}",
    ...
    "html body #page .fo-pp-slot .fo-cp-ev{display:flex;gap:9px;align-items:baseline;padding:5px 0;font:420 12px/1.5 Fraunces,Georgia,serif;color:rgba(20,28,40,.65)}",
    ...
    "html body #page .fo-pp-slot .fo-cp-fld{font:420 11.5px/1.5 Fraunces,Georgia,serif;color:rgba(20,28,40,.55)}",
