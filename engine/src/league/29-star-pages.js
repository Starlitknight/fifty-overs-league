...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-star-chips span{font:700 11px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#8A6606;background:rgba(176,132,9,.12);border-radius:999px;padding:7px 11px}",
    ...
    "html body #page .fo-star-row{display:grid;grid-template-columns:36px 1fr 1fr 1fr 1fr;gap:6px;align-items:baseline;padding:8px 0;border-top:1px solid rgba(20,28,40,.06);font:500 12.5px/1.2 Oswald,sans-serif}",
    "html body #page .fo-star-row i{font:700 11px/1 Oswald,sans-serif;letter-spacing:.08em;color:rgba(20,28,40,.5);font-style:normal}",
    "html body #page .fo-star-row em{font-style:normal;font-variant-numeric:tabular-nums}",
    "html body #page .fo-star-row.hd{border-top:0;padding:0 0 2px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-star-foot a,html body #page .fo-wm-foot a{font:600 13px/1 Oswald,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
    ...
    "html body #page .fo-wm-innh b{flex:1;font:600 15px/1.2 Oswald,sans-serif}",
    ...
    "html body #page .fo-wm-cps i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    "html body #page .fo-wm-cps b{display:block;font:700 12.5px/1 Oswald,sans-serif;margin-top:4px;font-variant-numeric:tabular-nums}",
    "html body #page .fo-wm-perf{margin-top:10px}",
    "html body #page .fo-wm-perf div{display:flex;justify-content:space-between;font:500 12.5px/1.3 Oswald,sans-serif;padding:5px 0;border-top:1px solid rgba(20,28,40,.06)}",
    "html body #page .fo-wm-perf u{text-decoration:none;font-weight:700;font-variant-numeric:tabular-nums}",
    "html body #page .fo-wm-bowl{margin-top:8px;padding:0 4px;font:400 13px/1.5 Oswald,sans-serif;color:rgba(20,28,40,.6)}",
    "html body #page .fo-wm-bowl i{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;font-style:normal;margin-right:8px;color:#B44A22}",
