...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-star-chips span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#8A6606;background:rgba(176,132,9,.12);border-radius:999px;padding:7px 11px}",
    ...
    "html body #page .fo-star-row.hd{border-top:0;padding:0 0 2px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-wm-cps i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    ...
    "html body #page .fo-wm-bowl i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;font-style:normal;margin-right:8px;color:#B44A22}",
