...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-al-ldg th{padding:8px 3px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);border-bottom:1px solid rgba(20,28,40,.5);text-align:right}",
    ...
    "html body #page a.fo-al-gr .wn{grid-area:w;font:600 10px/1.5 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#B44A22;margin-top:7px}",
    ...
    "html body #page .fo-al-rec i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    ...
    "html body #page .fo-al-roll i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
