...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-al-sign{font:700 11px/1 Inter,sans-serif;color:#FFFEFC;background:#C9571F;border:0;border-radius:999px;padding:9px 14px;cursor:pointer}",
