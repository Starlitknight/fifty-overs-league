...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-al-kick{font-family:Inter,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#B44A22}",
    ...
    "html body #page .fo-al-ldg th{padding:8px 3px;font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);border-bottom:1px solid rgba(20,28,40,.5);text-align:right}",
    ...
    "html body #page .fo-al-ldg td.who b{display:block;font:600 13.5px/1.2 Inter,system-ui,sans-serif;color:#1B2432;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
    "html body #page .fo-al-ldg td.who em{font-style:normal;font:400 12px/1.4 Inter,system-ui,sans-serif;color:rgba(20,28,40,.42);font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-al-rail a{flex:0 0 auto;padding:7px 12px;border:1px solid rgba(20,28,40,.16);border-radius:5px;background:#FFFEFC;text-decoration:none;font:600 13px/1 Inter,system-ui,sans-serif;color:rgba(20,28,40,.62) !important;white-space:nowrap}",
    ...
    "html body #page a.fo-al-gr .nm b{display:block;font:600 14.5px/1.25 Inter,system-ui,sans-serif;color:#1B2432}",
    "html body #page a.fo-al-gr .nm em{display:block;font-style:normal;font:400 12px/1.5 Inter,system-ui,sans-serif;color:rgba(20,28,40,.44)}",
    ...
    "html body #page a.fo-al-gr .fg b{display:block;font:700 21px/1 Inter,sans-serif;color:#14243A}",
    "html body #page a.fo-al-gr .fg i{display:block;font-style:normal;font:400 10px/1.4 Inter,system-ui,sans-serif;color:rgba(20,28,40,.44);margin-top:3px}",
    "html body #page a.fo-al-gr .wn{grid-area:w;font:600 11px/1.5 Inter,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#B44A22;margin-top:7px}",
    "html body #page a.fo-al-more{display:inline-block;margin-top:11px;font:600 13px/1 Inter,system-ui,sans-serif;color:#B44A22 !important;text-decoration:none}",
    "html body #page a.fo-al-ld{text-decoration:none;color:#1B2432}",
    "html body #page a.fo-al-ld:hover b{color:#B44A22}",
    "html body #page .fo-al-rec i{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    ...
    "html body #page .fo-al-ld i{font:700 13px/1 Inter,sans-serif;color:rgba(20,28,40,.4);font-style:normal;width:14px}",
    ...
    "html body #page .fo-al-ld em{display:block;font:400 12px/1.2 Inter,sans-serif;font-style:normal;color:rgba(20,28,40,.5)}",
    ...
    "html body #page .fo-al-roll i{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
    ...
    "html body #page .fo-al-mk em{display:block;font:400 13px/1.25 Inter,sans-serif;font-style:normal;color:rgba(20,28,40,.55);margin-top:2px}",
    ...
    "html body #page .fo-al-sign{font:700 13px/1 Inter,sans-serif;color:#FFFEFC;background:#C9571F;border:0;border-radius:999px;padding:9px 14px;cursor:pointer}",
    ...
    "html body #page .fo-al-foot a{font:600 13px/1 Inter,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
