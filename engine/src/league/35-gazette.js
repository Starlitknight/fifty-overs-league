...
(function () {
  ...
  function foGzCss() {
    ...
    s.textContent = [
      ...
      ".fo-gz-btn{display:inline-block;font:600 13px/1 Oswald,sans-serif;color:#8E2F1C;border:1px solid rgba(142,47,28,.45);border-radius:999px;padding:8px 15px;text-decoration:none;margin-top:6px}",
