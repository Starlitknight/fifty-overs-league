...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-ac-k{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-ac-card h3{margin:0 0 10px;font-family:Manrope,sans-serif;font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#8A6A1F;display:flex;align-items:center;gap:8px}",
      "html body #page .fo-ac-card h3 span{margin-left:auto;font-size:10px;color:rgba(20,28,40,.45);letter-spacing:.12em}",
      "html body #page .fo-ac-p{font:400 13px/1.6 Manrope,sans-serif;color:rgba(20,28,40,.72);margin:0 0 10px}",
      ...
      "html body #page .fo-ac-post .pw i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:4px}",
      ...
      "html body #page .fo-ac-post .pw u{display:block;text-decoration:none;font:400 13px/1.5 Manrope,system-ui,sans-serif;color:rgba(244,239,228,.62);margin-top:2px}",
      "html body #page .fo-ac-post .mv{position:relative;flex:none;display:flex;flex-direction:column;align-items:flex-end;gap:4px}",
      "html body #page .fo-ac-post .mv select{appearance:none!important;-webkit-appearance:none!important;max-width:150px;min-height:34px!important;padding:0 16px 0 4px!important;border:0!important;border-bottom:1px solid rgba(235,194,113,.5)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;font:600 13px/1 Manrope,system-ui,sans-serif!important;color:#F4EFE4!important;cursor:pointer;text-overflow:ellipsis}",
      ...
      "html body #page .fo-ac-post .mv s{text-decoration:none;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.5)}",
      ...
      "html body #page .fo-ac-lvt b{display:block;font:700 17px/1.1 Manrope,sans-serif;color:#1B2432}",
      "html body #page .fo-ac-lvt i{display:block;font-style:normal;font:500 13px/1.4 Manrope,sans-serif;color:rgba(20,28,40,.55);margin-top:2px}",
      ...
      "html body #page .fo-ac-money i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
      "html body #page .fo-ac-money b{display:block;font:700 17px/1.2 Manrope,sans-serif;color:#1B2432;margin-top:4px;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac-money u{display:block;text-decoration:none;font:500 12px/1.2 Manrope,sans-serif;color:rgba(20,28,40,.45);margin-top:1px}",
      ...
      "html body #page .fo-ac-uprow b{display:block;font:700 13px/1.2 Manrope,sans-serif;letter-spacing:.04em;color:#1B2432}",
      "html body #page .fo-ac-uprow i{display:block;font-style:normal;font:400 13px/1.45 Manrope,sans-serif;color:rgba(20,28,40,.55);margin-top:3px}",
      "html body #page .fo-ac-btn{display:inline-block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFEFC !important;background:linear-gradient(180deg,#E8894A,#C9571F) !important;border:0 !important;border-radius:999px !important;padding:11px 17px !important;cursor:pointer;text-decoration:none !important}",
      ...
      "html body #page a.fo-ac-sqlink b{font:600 14.5px/1.3 Manrope,sans-serif;color:#1B2432}",
      "html body #page a.fo-ac-sqlink i{font:500 13px/1.5 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
      "html body #page a.fo-ac-sqlink s{flex:none;text-decoration:none;font:600 20px/1 Manrope,sans-serif;color:#C9571F}",
      ".fo-ac-toast{position:fixed;left:50%;bottom:26px;transform:translate(-50%,14px);opacity:0;z-index:9999;background:#14243A;color:#FFFEFC;font:600 13px/1.4 Manrope,sans-serif;border-radius:12px;border-bottom:3px solid #C9571F;padding:11px 16px;max-width:min(92vw,420px);box-shadow:0 14px 34px rgba(7,22,46,.35);transition:opacity .25s ease,transform .25s ease;pointer-events:none}",
      ...
      "html body #page .fo-ac-ch b{flex:1;min-width:0;font:600 13.5px/1.25 Manrope,sans-serif;color:#1B2432;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      "html body #page .fo-ac-ch u{flex:none;text-decoration:none;font:700 13px/1 Manrope,sans-serif;color:#8A6A1F;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac-cm{font:500 12px/1.45 Manrope,sans-serif;color:rgba(20,28,40,.55);margin-top:3px}",
      ...
      "html body #page .fo-ac-sel{flex:1 1 190px;min-width:0;font:500 13px/1.2 Manrope,sans-serif;color:#1B2432;background:#FFFEFC;border:1px solid rgba(20,28,40,.2);border-radius:10px;padding:10px 11px;cursor:pointer}",
      "html body #page .fo-ac-note.thin{font-size:11.5px;line-height:1.55;color:rgba(20,28,40,.55);margin-top:9px}",
      "html body #page .fo-ac-warn{background:#FFF6DA;border:1px solid rgba(200,84,47,.28);border-left:3px solid #C9571F;border-radius:11px;padding:11px 13px;margin:0 0 12px;font:500 12.5px/1.55 Manrope,sans-serif;color:#5A3410}",
      ...
      "html body #page .fo-ac-bcol h4{margin:0 0 6px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#8A7F70}",
      "html body #page .fo-ac-tie{background:#FBF8F2;border:1px solid rgba(20,28,40,.10);border-radius:9px;padding:7px 9px;margin:0 0 6px;font:500 13px/1.5 Manrope,sans-serif;position:relative}",
      ...
      "html body #page .fo-ac-tie em{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;color:#B4A996;margin:2px 0;font-style:normal}",
      "html body #page .fo-ac-ff{position:absolute;top:6px;right:8px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#C9571F;font-style:normal}",
      ...
      "html body #page .fo-ac-champ em{margin-left:auto;font:600 11px/1 Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
      // THE SQUAD PICKER
      ...
      "html body #page .fo-ac-sqh i{margin-left:auto;font:500 13px/1.4 Manrope,sans-serif;color:#8A7F70;font-style:normal;text-align:right}",
      "html body #page .fo-ac-sqm{display:grid;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));gap:5px}",
      "html body #page .fo-ac-sqp{display:flex;align-items:center;gap:6px;background:#FFFEFC;border:1px solid rgba(20,28,40,.10);border-radius:8px;padding:5px 8px;font:500 13px/1.3 Manrope,sans-serif;cursor:pointer}",
      ...
      "html body #page .fo-ac-sqf span{font:500 13px/1.4 Manrope,sans-serif;color:#8A7F70}",
      "html body #page .fo-ac-sqf button{margin-left:auto}",
      "html body #page .fo-ac-warn b{display:block;font:700 13px/1.4 Manrope,sans-serif;color:#1B2432;margin-bottom:2px}",
      ...
      "html body #page .fo-ac-oh i{display:block;margin-top:3px;font:500 13px/1.4 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
      "html body #page .fo-ac-oh u{flex:0 0 auto;text-decoration:none;font:700 20px/1 Manrope,sans-serif;color:#C9571F;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-ac-orow i{display:block;font:700 11px/1 Manrope,sans-serif;font-style:normal;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      "html body #page .fo-ac-orow b{display:block;margin-top:4px;font:700 17px/1 Manrope,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac-orow u{display:block;margin-top:2px;text-decoration:none;font:500 12px/1.3 Manrope,sans-serif;color:rgba(20,28,40,.5)}",
      "html body #page .fo-ac-skills{display:grid;grid-template-columns:1fr 1fr;gap:10px 16px;margin:12px 0 2px}",
      "html body #page .fo-ac-skg h5{margin:0 0 5px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      "html body #page .fo-ac-sk{display:flex;align-items:center;gap:7px;margin:0 0 3px}",
      "html body #page .fo-ac-sk i{flex:0 0 86px;font:500 12px/1.3 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.6)}",
      ...
      "html body #page .fo-ac-sk b{flex:0 0 20px;text-align:right;font:600 12px/1 Manrope,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-ac-mini{flex:1;font:700 11px/1 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;white-space:nowrap;color:#FFFEFC !important;background:#1B2432 !important;border:0 !important;border-radius:999px !important;padding:9px 4px !important;cursor:pointer}",
      ...
      "html body #page .fo-ac-sub{margin:14px 0 7px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      "html body #page .fo-ac-tw{overflow-x:auto;-webkit-overflow-scrolling:touch}",
      "html body #page .fo-ac-tbl{width:100%;border-collapse:collapse;font:500 13px/1.3 Manrope,sans-serif;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac-tbl th{font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);text-align:right;padding:0 0 7px}",
      ...
      "html body #page .fo-ac-res{display:flex;align-items:center;gap:6px;padding:6px 0;border-top:1px solid rgba(20,28,40,.07);font:500 13px/1.3 Manrope,sans-serif;flex-wrap:wrap}",
      "html body #page .fo-ac-res i{flex:none;font-style:normal;font:700 11px/1 Manrope,sans-serif;width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;border-radius:5px;color:#FFFEFC;background:#B23230}",
      ...
      "html body #page .fo-ac-foot{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-top:18px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase}",
      ...
      "html body #page .fo-ac2-folio span{font:700 11px/1 Manrope,sans-serif;text-transform:uppercase;letter-spacing:.18em;color:#14243A}",
      ...
      "html body #page .fo-ac2-bill b{display:block;font:700 21px/1.05 Manrope,sans-serif;text-transform:uppercase;color:#14243A;overflow-wrap:anywhere}",
      "html body #page .fo-ac2-bill i{display:block;margin-top:4px;font:600 11px/1.4 Manrope,sans-serif;font-style:normal;letter-spacing:.16em;text-transform:uppercase;color:#9FB0C6}",
      "html body #page .fo-ac2-bill .mv{position:relative;flex:none;text-align:right}",
      "html body #page .fo-ac2-bill .mv select{appearance:none!important;-webkit-appearance:none!important;max-width:96px;border:0!important;border-bottom:1px solid rgba(201,87,31,.5)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;font:600 12.5px/1.4 Manrope,sans-serif!important;color:#14243A!important;padding:2px 15px 3px 2px!important;cursor:pointer;text-overflow:ellipsis;white-space:nowrap;overflow:hidden}",
      ...
      "html body #page .fo-ac2-bill .mv em{display:block;font:700 11px/1 Manrope,sans-serif;font-style:normal;letter-spacing:.16em;text-transform:uppercase;color:#9FB0C6;margin-top:4px}",
      ...
      "html body #page .fo-ac2-facts b{display:block;font:600 13.5px/1.2 Manrope,sans-serif;color:#14243A;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac2-facts b.go{color:#1F6F4A;font-weight:700}",
      "html body #page .fo-ac2-facts i{display:block;margin-top:3px;font:700 11px/1.35 Manrope,sans-serif;font-style:normal;text-transform:uppercase;letter-spacing:.12em;color:#9FB0C6}",
      "html body #page .fo-ac2-cap{font:700 11px/1 Manrope,sans-serif;text-transform:uppercase;letter-spacing:.14em;color:#14243A;margin-top:2px}",
      ...
      "html body #page .fo-ac2-rh i{display:block;font:500 13px/1.4 Manrope,sans-serif;font-style:normal;color:#67748a;margin-top:3px}",
      "html body #page .fo-ac2-rh .bd{flex:none;text-align:right}",
      "html body #page .fo-ac2-rh .bd b{font:700 22px/1 Manrope,sans-serif;color:#C9571F;font-variant-numeric:tabular-nums}",
      "html body #page .fo-ac2-rh .bd i{font:700 11px/1 Manrope,sans-serif;letter-spacing:.15em;text-transform:uppercase;color:#9FB0C6;margin-top:4px}",
      ...
      "html body #page .fo-ac2-q i{display:block;font:400 12px/1.3 Manrope,sans-serif;font-style:normal;color:#67748a;margin-top:4px}",
      ...
      "html body #page .fo-ac2-strip i{display:block;font:500 12px/1.5 Manrope,sans-serif;font-style:normal;color:#67748a;margin-top:6px}",
