...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-ac-post .pw i{display:block;font:600 9px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:4px}",
      ...
      "html body #page .fo-ac-post .mv:after{content:'\\25BE';position:absolute;right:2px;top:10px;pointer-events:none;font-size:9px;color:#E8B96A}",
      ...
      "html body #page .fo-ac-ff{position:absolute;top:6px;right:8px;font:600 8.5px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#C9571F;font-style:normal}",
      ...
      "html body #page .fo-ac-sk b{flex:0 0 20px;text-align:right;font:600 10.5px/1 Inter,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-ac-mini{flex:1;font:700 9.5px/1 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase;white-space:nowrap;color:#FFFEFC !important;background:#1B2432 !important;border:0 !important;border-radius:999px !important;padding:9px 4px !important;cursor:pointer}",
