...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-ac-post .pw i{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:4px}",
      ...
      "html body #page .fo-ac-post .mv s{text-decoration:none;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.5)}",
      ...
      "html body #page .fo-ac-money i{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal}",
      ...
      "html body #page .fo-ac-bcol h4{margin:0 0 6px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#8A7F70}",
      ...
      "html body #page .fo-ac-tie em{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.16em;color:#B4A996;margin:2px 0;font-style:normal}",
      "html body #page .fo-ac-ff{position:absolute;top:6px;right:8px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#C9571F;font-style:normal}",
      ...
      "html body #page .fo-ac-champ em{margin-left:auto;font:600 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
      // THE SQUAD PICKER
      ...
      "html body #page .fo-ac-orow i{display:block;font:700 10px/1 Oswald,sans-serif;font-style:normal;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      "html body #page .fo-ac-skg h5{margin:0 0 5px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      "html body #page .fo-ac-mini{flex:1;font:700 10px/1 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase;white-space:nowrap;color:#FFFEFC !important;background:#1B2432 !important;border:0 !important;border-radius:999px !important;padding:9px 4px !important;cursor:pointer}",
      ...
      "html body #page .fo-ac-sub{margin:14px 0 7px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      "html body #page .fo-ac-tbl th{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);text-align:right;padding:0 0 7px}",
      ...
      "html body #page .fo-ac-res i{flex:none;font-style:normal;font:700 10px/1 Oswald,sans-serif;width:18px;height:18px;display:inline-flex;align-items:center;justify-content:center;border-radius:5px;color:#FFFEFC;background:#B23230}",
      ...
      "html body #page .fo-ac2-folio span{font:700 10px/1 Oswald,sans-serif;text-transform:uppercase;letter-spacing:.18em;color:#14243A}",
      ...
      "html body #page .fo-ac2-bill i{display:block;margin-top:4px;font:600 10px/1.4 Oswald,sans-serif;font-style:normal;letter-spacing:.16em;text-transform:uppercase;color:#8a93a2}",
      ...
      "html body #page .fo-ac2-bill .mv em{display:block;font:700 10px/1 Oswald,sans-serif;font-style:normal;letter-spacing:.16em;text-transform:uppercase;color:#8a93a2;margin-top:4px}",
      ...
      "html body #page .fo-ac2-facts i{display:block;margin-top:3px;font:700 10px/1.35 Oswald,sans-serif;font-style:normal;text-transform:uppercase;letter-spacing:.12em;color:#8a93a2}",
      ...
      "html body #page .fo-ac2-rh .bd i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.15em;text-transform:uppercase;color:#8a93a2;margin-top:4px}",
