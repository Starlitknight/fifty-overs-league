...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-hb-ch em{display:block;font:600 12px/1 Manrope,sans-serif;color:rgba(46,36,16,.55);font-style:normal;margin-top:9px;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-hb-kick,html body #page .fo-hb-k{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#B44A22}",
    "html body #page .fo-hb-mast h1{font-family:Manrope,sans-serif;font-weight:600;font-size:38px;letter-spacing:.04em;text-transform:uppercase;margin:6px 0 8px;color:#1B2432}",
    "html body #page .fo-hb-mast p{font:400 13.5px/1.55 Fraunces,Georgia,serif;color:rgba(20,28,40,.62);margin:0;max-width:64ch}",
    "html body #page .fo-hb-tally{margin-top:12px;font:600 13px/1 Manrope,sans-serif;color:#1B2432;background:#FFFEFC;border:1px solid rgba(176,132,9,.4);border-radius:999px;display:inline-block;padding:8px 15px}",
    ...
    "html body #page .fo-hb-plq i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.26em;text-transform:uppercase;font-style:normal;color:rgba(20,28,40,.4);margin-bottom:6px}",
    "html body #page .fo-hb-plq b{display:block;font:600 15px/1.15 Manrope,sans-serif;letter-spacing:.04em;text-transform:uppercase;color:#1B2432}",
    ...
    "html body #page .fo-hb-plq em{display:block;font:600 12px/1 Manrope,sans-serif;color:#8A6A1F;font-style:normal;margin-top:9px;font-variant-numeric:tabular-nums}",
    ...
    "html body #page .fo-hb-foot a{font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
    ...
    ".fo-hb-line{font:600 13.5px/1.4 Manrope,sans-serif}",
    ".fo-hb-sub{font:400 13px/1.45 Fraunces,Georgia,serif;opacity:.75;margin-top:3px}",
    ".fo-hb-new{font:700 10px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;font-style:normal;background:#C9571F;color:#FFFEFC;border-radius:999px;padding:3px 7px;margin-left:6px;vertical-align:1px}"
  ].join("\n");
