...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-hb-plq i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.26em;text-transform:uppercase;font-style:normal;color:rgba(20,28,40,.4);margin-bottom:6px}",
