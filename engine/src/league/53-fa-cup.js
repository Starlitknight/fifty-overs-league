...
(function () {
  ...
  function css() {
    var CSS = [
      ...
      "html body #page .fo-kb-hero .eb{font:700 11px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-kb-col h4{display:flex;justify-content:space-between;align-items:baseline;gap:8px;margin:0 0 8px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14202F;border-bottom:2px solid #14243A;padding-bottom:7px}",
      "html body #page .fo-kb-col h4 span{font:600 11px/1.3 Oswald,sans-serif;letter-spacing:.06em;color:#8a6d3b;text-align:right}",
      ...
      "html body #page .fo-kb-tie .t{display:flex;justify-content:space-between;align-items:baseline;gap:8px;padding:6px 10px;font:500 13px/1.3 Oswald,sans-serif;color:#14202F}",
      ...
      "html body #page .fo-kb-tie .t u{text-decoration:none;font:700 13px/1 Oswald,sans-serif;font-variant-numeric:tabular-nums;color:#9FB0C6;white-space:nowrap}",
      ...
      "html body #page .fo-kb-tie .t .ff{font:700 11px/1 Oswald,sans-serif;letter-spacing:.1em;color:#B23230;text-transform:uppercase}",
      ...
      "html body #page .fo-kb-tie.tbd span{display:block;padding:13px 10px;font:600 11px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,32,47,.35);text-align:center}",
      "html body #page .fo-kb-note{font:400 13px/1.55 Oswald,sans-serif;color:rgba(20,32,47,.55);margin:10px 2px 0;max-width:70ch}",
      ...
      "html body #page .fo-kb-gcard h4{display:flex;justify-content:space-between;align-items:baseline;gap:8px;margin:0 0 8px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14202F;border-bottom:2px solid #14243A;padding-bottom:7px}",
      "html body #page .fo-kb-gcard h4 span{font:600 11px/1.3 Oswald,sans-serif;letter-spacing:.06em;color:#8a6d3b;text-align:right}",
      ...
      "html body #page .fo-kb-natsw>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,32,47,.5);font-style:normal;margin-bottom:7px}",
      ...
      "html body #page .fo-kb-nat span{font:700 11px/1 Oswald,sans-serif;letter-spacing:.04em;text-transform:uppercase;color:rgba(20,32,47,.55) !important;max-width:64px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
