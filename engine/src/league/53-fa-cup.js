...
(function () {
  ...
  function css() {
    var CSS = [
      ...
      "html body #page .fo-kb-tie .t u{text-decoration:none;font:700 11px/1 Inter,sans-serif;font-variant-numeric:tabular-nums;color:#8A93A2;white-space:nowrap}",
      ...
      "html body #page .fo-kb-tie .ln{display:block;padding:4px 10px 6px;font:400 10.5px/1.35 Fraunces,serif;color:rgba(20,32,47,.5);border-top:1px solid rgba(14,35,63,.07)}",
