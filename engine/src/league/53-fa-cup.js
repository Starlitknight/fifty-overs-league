...
(function () {
  ...
  function css() {
    var CSS = [
      ...
      "html body #page .fo-kb-hero .eb{font:700 10px/1 Oswald,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-kb-col h4 span{font:600 10px/1.3 Oswald,sans-serif;letter-spacing:.06em;color:#8a6d3b;text-align:right}",
      ...
      "html body #page .fo-kb-tie .t u{text-decoration:none;font:700 13px/1 Inter,sans-serif;font-variant-numeric:tabular-nums;color:#8A93A2;white-space:nowrap}",
      ...
      "html body #page .fo-kb-tie .t .ff{font:700 10px/1 Oswald,sans-serif;letter-spacing:.1em;color:#B23230;text-transform:uppercase}",
      ...
      "html body #page .fo-kb-gcard h4 span{font:600 10px/1.3 Oswald,sans-serif;letter-spacing:.06em;color:#8a6d3b;text-align:right}",
      ...
      "html body #page .fo-kb-natsw>i{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,32,47,.5);font-style:normal;margin-bottom:7px}",
      ...
      "html body #page .fo-kb-nat span{font:700 10px/1 Oswald,sans-serif;letter-spacing:.04em;text-transform:uppercase;color:rgba(20,32,47,.55) !important;max-width:64px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
