...
(function () {
  ...
  function foT2Css() {
    ...
    s.textContent = [
      ...
      ".fo-t2-hero i{font:700 11px Inter,sans-serif;letter-spacing:.22em;color:#E8B96A;font-style:normal}",
      ...
      ".fo-t2-tab span{font:600 11px/1 Inter,sans-serif;letter-spacing:.185em;text-transform:uppercase}",
      ...
      ".fo-t2-head span{font:600 11px Inter,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86}",
      ...
      ".fo-t2-nofoc{text-align:left;padding-left:9px;font:600 13px Inter,sans-serif;color:#cdc5b2}",
      ".fo-t2-dim{margin:0 0 10px;font:400 13px Inter,sans-serif;color:#6d6455;line-height:1.5}",
      ...
      ".fo-t2-bsub{margin:0;font:400 13px Inter,sans-serif;color:#8a8272}",
      ...
      "  font:600 11px Inter,sans-serif !important;letter-spacing:.15em;text-transform:uppercase;",
      ...
      ".fo-t2-svg .ax{font:600 11px Inter,sans-serif;letter-spacing:.08em;fill:#a89f8d}",
      ".fo-t2-svg .ax.r{text-anchor:end}",
      ".fo-t2-svg .ax.e{text-anchor:end}",
      ".fo-t2-svg .rl{font:600 10px Inter,sans-serif;fill:#6d6455}",
      ...
      ".fo-t2-key span{display:inline-flex;align-items:center;gap:5px;font:500 13px Inter,sans-serif;color:#6d6455}",
      ...
      ".fo-t2-bar span{font:600 13px Inter,sans-serif;color:#14243A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ".fo-t2-bar span i{font:600 11px Inter,sans-serif;color:#a89f8d;font-style:normal;margin-left:6px}",
      ...
      ".fo-t2-bar em{font:700 11px Inter,sans-serif;letter-spacing:.05em;color:#177A57;font-style:normal;text-align:right}",
      ...
      "  font:600 11.5px Inter,sans-serif !important;letter-spacing:.22em;text-transform:uppercase;",
