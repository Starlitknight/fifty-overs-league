...
(function () {
  ...
  function foT2Css() {
    ...
    s.textContent = [
      ...
      ".fo-t2-acad i{display:block;margin-top:1px;font:600 10px Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a8272;font-style:normal;white-space:nowrap}",
      ...
      ".fo-t2-head span{font:600 10px Oswald,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86}",
      ...
      "  font:600 10px Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a49b86}",
      ...
      "  font:600 10px Oswald,sans-serif !important;letter-spacing:.15em;text-transform:uppercase;",
      ...
      ".fo-t2-cbar i{font:600 10px Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#8a8272;font-style:normal}",
      ...
      ".fo-t2-svg .ax{font:600 10px Oswald,sans-serif;letter-spacing:.08em;fill:#a89f8d}",
      ...
      ".fo-t2-bar span i{font:600 10px Oswald,sans-serif;color:#a89f8d;font-style:normal;margin-left:6px}",
