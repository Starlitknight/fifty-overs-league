...
(function () {
  ...
  // with it - nine pixels of Manrope becomes five, which is not reading, it is
  ...
  function foT2Css() {
    ...
    s.textContent = [
      ...
      ".fo-t2-hero i{font:700 11px Manrope,sans-serif;letter-spacing:.22em;color:#E8B96A;font-style:normal}",
      ...
      ".fo-t2-acad b{display:block;font:700 15px Manrope,sans-serif;color:#14243A;white-space:nowrap}",
      ".fo-t2-acad i{display:block;margin-top:1px;font:600 11px Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a8272;font-style:normal;white-space:nowrap}",
      ...
      ".fo-t2-acad .go{flex:0 0 auto;text-decoration:none;font:700 22px Manrope,sans-serif;color:#C08A2E;line-height:1}",
      // the plan
      ...
      ".fo-t2-ck{font:700 11px Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#14243A;margin-bottom:8px}",
      ...
      ".fo-t2-tab span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.185em;text-transform:uppercase}",
      ".fo-t2-tab i{font:700 11px/1 Manrope,sans-serif;font-style:normal;letter-spacing:.02em;",
      ...
      ".fo-t2-head span{font:600 11px Manrope,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86}",
      ...
      ".fo-t2-shirt b{position:absolute;inset:5px 0 0 0;text-align:center;font:800 11px Manrope,sans-serif;color:#F6F3EB}",
      ".fo-t2-who{min-width:0}",
      ".fo-t2-who a{display:block;font:650 13.5px/1.25 Manrope,sans-serif;color:#14243A !important;text-decoration:none;letter-spacing:-.005em}",
      ...
      "  font:600 11px Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a49b86}",
      ...
      "  font:600 12.5px/1.2 Manrope,sans-serif !important;color:#3a4759 !important;",
      ...
      ".fo-t2-nofoc{text-align:left;padding-left:9px;font:600 13px Manrope,sans-serif;color:#cdc5b2}",
      ".fo-t2-dim{margin:0 0 10px;font:400 13px Manrope,sans-serif;color:#6d6455;line-height:1.5}",
      ".fo-t2-note{font:400 13px Fraunces,Georgia,serif;color:#6d6455}",
      ".fo-t2-report{border-left:4px solid #177A57}",
      ".fo-t2-rl{padding:6px 0;border-bottom:1px solid #f3eee1;font:500 12.5px Manrope,sans-serif;color:#14243A;line-height:1.5}",
      ...
      ".fo-t2-bsub{margin:0;font:400 13px Manrope,sans-serif;color:#8a8272}",
      ...
      "  font:600 11px Manrope,sans-serif !important;letter-spacing:.15em;text-transform:uppercase;",
      ...
      ".fo-t2-cbar i{font:600 11px Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#8a8272;font-style:normal}",
      ...
      ".fo-t2-svg .ax{font:600 11px Manrope,sans-serif;letter-spacing:.08em;fill:#a89f8d}",
      ".fo-t2-svg .ax.r{text-anchor:end}",
      ".fo-t2-svg .ax.e{text-anchor:end}",
      ".fo-t2-svg .rl{font:600 10px Manrope,sans-serif;fill:#6d6455}",
      ...
      ".fo-t2-key span{display:inline-flex;align-items:center;gap:5px;font:500 13px Manrope,sans-serif;color:#6d6455}",
      ...
      ".fo-t2-bar span{font:600 13px Manrope,sans-serif;color:#14243A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ".fo-t2-bar span i{font:600 11px Manrope,sans-serif;color:#a89f8d;font-style:normal;margin-left:6px}",
      ...
      ".fo-t2-bar em{font:700 11px Manrope,sans-serif;letter-spacing:.05em;color:#177A57;font-style:normal;text-align:right}",
      ".fo-t2-bar em.nil{color:#cdc5b2}",
      ".fo-t2-cnote{margin:10px 0 0;font:400 13px Fraunces,Georgia,serif;color:#8a8272;line-height:1.6}",
      ...
      "  font:600 11.5px Manrope,sans-serif !important;letter-spacing:.22em;text-transform:uppercase;",
      ...
      ".fo-t2-head span{font-size:10px;letter-spacing:.14em}",
      ".fo-t2-shirt,.fo-t2-shirt svg{width:30px;height:30px}.fo-t2-shirt b{inset:5px 0 0 0;font-size:10px}",
      ".fo-t2-who a{font-size:11.5px}.fo-t2-who i{font-size:10px}",
