...
(function () {
  ...
  function foT2Css() {
    ...
    s.textContent = [
      ...
      ".fo-t2-hero i{font:700 11px Oswald,sans-serif;letter-spacing:.22em;color:#E8B96A;font-style:normal}",
      ...
      ".fo-t2-acad b{display:block;font:700 15px Oswald,sans-serif;color:#14243A;white-space:nowrap}",
      ".fo-t2-acad i{display:block;margin-top:1px;font:600 11px Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a8272;font-style:normal;white-space:nowrap}",
      ...
      ".fo-t2-acad .go{flex:0 0 auto;text-decoration:none;font:700 22px Oswald,sans-serif;color:#C08A2E;line-height:1}",
      // the plan
      ...
      ".fo-t2-tab i{font:700 11px/1 Oswald,sans-serif;font-style:normal;letter-spacing:.02em;",
      ...
      ".fo-t2-head span{font:600 11px Oswald,sans-serif;letter-spacing:.19em;text-transform:uppercase;color:#a49b86}",
      ...
      ".fo-t2-who a{display:block;font:650 13.5px/1.25 Oswald,sans-serif;color:#14243A !important;text-decoration:none;letter-spacing:-.005em}",
      ...
      "  font:600 11px Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#a49b86}",
      ...
      "  font:600 12.5px/1.2 Oswald,sans-serif !important;color:#3a4759 !important;",
      ...
      ".fo-t2-nofoc{text-align:left;padding-left:9px;font:600 13px Oswald,sans-serif;color:#cdc5b2}",
      ".fo-t2-dim{margin:0 0 10px;font:400 13px Oswald,sans-serif;color:#6d6455;line-height:1.5}",
      ".fo-t2-note{font:400 13px Fraunces,Georgia,serif;color:#6d6455}",
      ".fo-t2-report{border-left:4px solid #177A57}",
      ".fo-t2-rl{padding:6px 0;border-bottom:1px solid #f3eee1;font:500 12.5px Oswald,sans-serif;color:#14243A;line-height:1.5}",
      ...
      ".fo-t2-bsub{margin:0;font:400 13px Oswald,sans-serif;color:#8a8272}",
      ...
      "  font:600 11px Oswald,sans-serif !important;letter-spacing:.15em;text-transform:uppercase;",
      ...
      ".fo-t2-cbar i{font:600 11px Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#8a8272;font-style:normal}",
      ...
      ".fo-t2-svg .ax{font:600 11px Oswald,sans-serif;letter-spacing:.08em;fill:#a89f8d}",
      ".fo-t2-svg .ax.r{text-anchor:end}",
      ".fo-t2-svg .ax.e{text-anchor:end}",
      ".fo-t2-svg .rl{font:600 10px Oswald,sans-serif;fill:#6d6455}",
      ...
      ".fo-t2-key span{display:inline-flex;align-items:center;gap:5px;font:500 13px Oswald,sans-serif;color:#6d6455}",
      ...
      ".fo-t2-bar span{font:600 13px Oswald,sans-serif;color:#14243A;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ".fo-t2-bar span i{font:600 11px Oswald,sans-serif;color:#a89f8d;font-style:normal;margin-left:6px}",
