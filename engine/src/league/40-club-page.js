...
(function () {
  ...
  function foClubCss() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-cd-bk{display:inline-flex;align-items:center;gap:6px;align-self:flex-start;min-height:44px;padding:0 12px;margin:0 -12px;border-radius:12px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:var(--mut) !important;text-decoration:none !important}",
      ...
      ".fo-cd-sh{display:block;font:600 11.5px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:var(--navy);margin:-15px -16px 13px;padding:12px 16px 11px;background:linear-gradient(0deg,rgba(14,35,63,.03),rgba(14,35,63,.06));border-bottom:1px solid var(--edge);border-radius:12px 12px 0 0}",
      ...
      "html body #page .fo-cd-lnk{display:inline-flex;align-items:center;gap:5px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:var(--acc) !important;margin-top:12px;min-height:34px;text-decoration:none !important}",
      ...
      ".fo-cd-crest b{font:700 20px/1 Manrope,sans-serif;color:#F1EEE6;letter-spacing:.04em;padding-bottom:8px}",
      ...
      ".fo-cd-id h1{font:700 22px/1.1 Manrope,sans-serif;text-transform:uppercase;letter-spacing:.02em;color:var(--navy);margin:0}",
      ".fo-cd-id .loc{display:flex;align-items:center;gap:7px;margin-top:6px;font:600 11px/1.3 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:var(--acc)}",
      ".fo-cd-id .loc img{width:18px;height:12px;object-fit:cover;border-radius:2px}",
      ".fo-cd-id .est{margin-top:4px;font:500 12px/1.3 Manrope,sans-serif;color:rgba(12,27,51,.55)}",
      ...
      ".fo-cd-id .meta span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#9FB0C6}",
      ".fo-cd-id .meta b{display:block;font:600 12.5px/1.3 Manrope,sans-serif;color:var(--ink);margin-top:4px;letter-spacing:0;text-transform:none}",
      ".fo-cd-id .acts{display:flex;gap:9px;margin-top:13px}",
      "html body #page .fo-cd-id .acts a,html body #page .fo-cd-id .acts button{flex:1;display:flex;align-items:center;justify-content:center;min-height:44px;border-radius:9px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;text-decoration:none !important;text-align:center;cursor:pointer}",
      ...
      ".fo-cd-id .foot .f span{font:600 11px/1.4 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#9FB0C6;display:block}",
      ".fo-cd-id .foot .f b{display:block;font:600 13px/1.35 Manrope,sans-serif;color:var(--navy);margin-top:3px}",
      ...
      ".fo-cd-gr .gt{font:600 17px/1.1 Manrope,sans-serif;letter-spacing:.06em;text-transform:uppercase;color:#FFFEFC;text-shadow:0 1px 6px rgba(6,12,22,.5)}",
      ".fo-cd-gr .gt u{display:block;text-decoration:none;font:400 13px/1.4 Manrope,sans-serif;letter-spacing:0;text-transform:none;color:rgba(248,244,236,.88);margin-top:4px}",
      "html body #page .fo-cd-gr .gd{flex:none;border:1.5px solid rgba(255,254,252,.65);border-radius:9px;padding:10px 12px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#FFFEFC !important;background:rgba(9,18,32,.35);white-space:nowrap;text-decoration:none !important;min-height:38px;display:inline-flex;align-items:center}",
      ...
      ".fo-cd-gr .grb span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#9FB0C6}",
      ".fo-cd-gr .grb b{display:block;font:600 12.5px/1.3 Manrope,sans-serif;color:var(--ink);margin-top:4px;letter-spacing:0;text-transform:none}",
      ...
      ".fo-cd-pos .cap{font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(244,239,228,.75)}",
      ".fo-cd-pos .big{font:700 30px/1 Manrope,sans-serif;color:#F6F2E8;margin-top:7px}",
      ".fo-cd-pos .big i{font-size:13px;font-style:normal;color:rgba(244,239,228,.5);font-weight:600}",
      ".fo-cd-pos .pts{font:600 11px/1 Manrope,sans-serif;letter-spacing:.08em;color:#E8B96A;margin-top:6px}",
      ".fo-cd-pos .grid{flex:1;display:flex;justify-content:space-around}",
      ".fo-cd-pos .grid span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(244,239,228,.55);text-align:center}",
      ".fo-cd-pos .grid b{display:block;font:600 14px/1.7 Manrope,sans-serif;color:#F6F2E8}",
      "html body #page .fo-cd-pos .vt{flex:none;font:600 11px/1.45 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#E8B96A !important;text-align:center;text-decoration:none !important;min-height:44px;display:inline-flex;align-items:center}",
      ...
      "html body #page .fo-cd-tabs a{flex:1;text-align:center;padding:12px 8px;border-radius:8px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.11em;text-transform:uppercase;color:var(--mut) !important;white-space:nowrap;text-decoration:none !important;min-height:40px;display:inline-flex;align-items:center;justify-content:center}",
      "html body #page .fo-cd-tabs a.on{background:var(--navy);color:#F1EEE6 !important}",
      // next fixture
      ".fo-cd-nf .tag{display:inline-block;background:rgba(176,74,44,.1);border:1px solid rgba(176,74,44,.35);color:var(--acc);border-radius:7px;padding:5px 9px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;margin-bottom:11px}",
      ...
      ".fo-cd-nf .mn b{font:700 14px/1 Manrope,sans-serif;color:#F1EEE6;padding-bottom:6px}",
      ".fo-cd-nf h3{font:700 16px/1.15 Manrope,sans-serif;text-transform:uppercase;color:var(--navy);margin:0}",
      ".fo-cd-nf h3 u{display:block;text-decoration:none;font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;color:#9FB0C6;margin-top:5px}",
      ...
      ".fo-cd-nf .det span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#9FB0C6}",
      ".fo-cd-nf .det b{display:block;font:600 12.5px/1.35 Manrope,sans-serif;color:var(--ink);margin-top:4px;letter-spacing:0;text-transform:none}",
      ".fo-cd-nf .h2h{font:400 13px/1.5 Manrope,sans-serif;color:var(--mut);margin-top:11px}",
      "html body #page .fo-cd-nf .vf{display:flex;align-items:center;justify-content:center;margin-top:12px;min-height:42px;border-radius:9px;background:var(--navy);color:#F1EEE6 !important;font:600 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;text-decoration:none !important}",
      ".fo-cd-nf .thn{font:600 11px/1 Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#9FB0C6;margin:14px 0 3px}",
      ...
      ".fo-cd-nf .ur .d{flex:none;width:52px;font:600 11px/1.35 Manrope,sans-serif;letter-spacing:.05em;text-transform:uppercase;color:var(--acc)}",
      ".fo-cd-nf .ur .o{font:500 13px/1.35 Manrope,sans-serif;color:var(--ink);min-width:0}",
      ".fo-cd-nf .ur .o em{font-style:normal;color:#9FB0C6;font-size:10px}",
      ".fo-cd-nf .ur .c{margin-left:auto;font:600 11px/1 Manrope,sans-serif;letter-spacing:.09em;text-transform:uppercase;color:#F1EEE6;background:#41577A;border-radius:6px;padding:5px 7px;white-space:nowrap}",
      // recent form
      ...
      ".fo-cd-rf i,.fo-cd-pos .fx i{align-self:center;width:22px;height:22px;border-radius:6px;display:inline-flex;align-items:center;justify-content:center;font:700 12px/1 Manrope,sans-serif;font-style:normal;flex:none;color:#fff}",
      ...
      ".fo-cd-rf .who{font:500 12.5px/1.35 Manrope,sans-serif;color:var(--ink);min-width:0}",
      ".fo-cd-rf .who em{font-style:normal;color:#9FB0C6;font-size:10.5px}",
      ".fo-cd-rf .sc{margin-left:auto;text-align:right;font:400 13px/1.4 Manrope,sans-serif;color:#5b6879;max-width:46%}",
      // diary
      ...
      ".fo-cd-cmp .nm{font:500 12.5px/1.35 Manrope,sans-serif;color:var(--ink)}",
      ".fo-cd-cmp .st{margin-left:auto;display:flex;align-items:center;gap:7px;white-space:nowrap}",
      ".fo-cd-cmp .st u{text-decoration:none;font:600 12px/1 Manrope,sans-serif;background:var(--navy);color:#F1EEE6;border-radius:7px;padding:5px 8px}",
      ".fo-cd-cmp .st u.off{background:rgba(20,32,47,.07);color:#67748a}",
      ".fo-cd-cmp .st em{font-style:normal;font:400 12px/1 Manrope,sans-serif;color:#9FB0C6}",
      ...
      ".fo-cd-sn .snap .r{display:flex;justify-content:space-between;gap:8px;padding:8px 0;border-bottom:1px solid rgba(20,32,47,.05);font:400 13px/1.35 Manrope,sans-serif;color:#55617a}",
      ".fo-cd-sn .snap .r b{color:var(--ink);font-weight:600;font-variant-numeric:tabular-nums}",
      // honours
      ".fo-cd-hn .r{display:flex;align-items:center;gap:10px;padding:9px 0;border-bottom:1px solid rgba(20,32,47,.05);font:500 12.5px/1.4 Manrope,sans-serif;color:var(--ink)}",
      ".fo-cd-hn .r:last-of-type{border-bottom:0}",
      ".fo-cd-hn .r em{font-style:normal;font:400 12px/1 Manrope,sans-serif;color:#9FB0C6}",
      ".fo-cd-hn .r b{margin-left:auto;font-weight:700}",
      "html body #page .fo-cd-hn .hnFoot{margin-top:9px;padding-top:9px;border-top:1px solid rgba(20,28,40,.08);font:500 13px/1.45 Manrope,sans-serif;color:rgba(20,28,40,.45);font-variant-numeric:tabular-nums}",
      ".fo-cd-hn .hnE{font:400 12.5px/1.6 Manrope,sans-serif;color:#6d6350;background:#FBF6EA;border:1px dashed rgba(176,74,44,.25);border-radius:10px;padding:13px 14px}",
      ...
      ".fo-cd-slim h1{font:700 19px/1.1 Manrope,sans-serif;text-transform:uppercase;color:var(--navy);margin:0}",
      ".fo-cd-slim i{display:block;font:600 11px/1.4 Manrope,sans-serif;font-style:normal;letter-spacing:.12em;text-transform:uppercase;color:#9FB0C6;margin-top:4px}",
      ...
      ".fo-cd-pos .xtra .fl{font:600 11px/1 Manrope,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:rgba(244,239,228,.55);margin-bottom:9px}",
      ...
      ".fo-cp-r b{font:600 13px/1.35 Manrope,sans-serif}",
      ...
      ".fo-cp-form i{font-style:normal;width:22px;height:22px;display:inline-flex;align-items:center;justify-content:center;border-radius:6px;font:700 11px/1 Manrope,sans-serif;color:#FFFEFC}",
      ".fo-cp-form i.w{background:var(--grn)}.fo-cp-form i.l{background:#B23230}.fo-cp-form i.t{background:#8a6d3b}",
      ".fo-cp-note{font:500 13px/1.6 Manrope,sans-serif;color:var(--navy);padding:3px 0}",
      ...
      ".fo-cp-great .mk{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(12,27,51,.45);margin-bottom:4px;font-style:normal}",
      ...
      ".fo-cp-chh{font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--navy)}",
      ".fo-cp-chrow{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-top:10px}",
      "html body #page .fo-cp-chrow input{flex:1 1 190px;min-width:0;background:#FFFEFC !important;color:var(--navy) !important;border:1px solid rgba(12,27,51,.2);border-radius:9px;padding:10px 11px;min-height:44px;font:600 12.5px/1 Manrope,sans-serif}",
      "html body #page .fo-cp-chrow button{font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFEFC !important;background:linear-gradient(180deg,#E8894A,#C9571F) !important;border:0 !important;border-radius:9px !important;padding:12px 20px !important;min-height:44px;cursor:pointer}",
      "html body #page .fo-cp-chrow button:disabled{opacity:.55;cursor:default}",
      ".fo-cp-chmsg{margin-top:8px;font:500 13px/1.5 Manrope,sans-serif;color:rgba(12,27,51,.6)}",
      ".fo-cp-chtz{margin-top:7px;font:600 13px/1.5 Manrope,sans-serif;color:#14243A}",
      ...
      ".fo-cp-fr b{font:600 12.5px/1.3 Manrope,sans-serif;color:var(--navy)}",
      ".fo-cp-fr i{font-style:normal;font:500 13px/1.3 Manrope,sans-serif;color:rgba(12,27,51,.55)}",
      ".fo-cp-fr.on i{color:var(--grn)}",
      ".fo-cp-fr.dim{opacity:.5}",
      ".fo-cp-fr span{margin-left:auto;display:inline-flex;gap:6px}",
      "html body #page .fo-cp-fr button{font:700 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:var(--navy) !important;background:#FFFEFC !important;border:1px solid rgba(12,27,51,.22) !important;border-radius:999px !important;padding:9px 13px !important;min-height:44px;cursor:pointer}",
      ...
      ".fo-cp-gkv span{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(12,27,51,.45)}",
      ".fo-cp-gkv b{display:block;margin-top:5px;font:600 14px/1.3 Manrope,sans-serif;color:var(--navy)}",
      "html body #page .fo-cp-glink{display:block;margin-top:12px;padding:12px 14px;background:#FFFEFC !important;border:1px solid rgba(12,27,51,.14);border-left:3px solid var(--gold);border-radius:11px;font:600 12.5px/1.4 Manrope,sans-serif;color:var(--navy) !important;text-decoration:none !important}",
      ...
      ".fo-cp-gfr .r{font:700 11px/1 Manrope,sans-serif;color:rgba(12,27,51,.4)}",
      ".fo-cp-gfr .o{font:600 13px/1.3 Manrope,sans-serif;color:var(--navy);min-width:0}",
      ".fo-cp-gfr .o i{display:block;font-style:normal;font:400 13px/1.3 Manrope,sans-serif;color:rgba(12,27,51,.5)}",
      ".fo-cp-gfr .p{font:700 11px/1 Manrope,sans-serif;letter-spacing:.06em;text-transform:uppercase;color:var(--grn);text-align:right}",
      ".fo-cp-gfr .w{font:500 13px/1.3 Manrope,sans-serif;color:rgba(12,27,51,.62);text-align:right}",
      ...
      ".fo-cp-gpr b{display:flex;align-items:center;gap:8px;font:700 12.5px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:var(--navy)}",
      ".fo-cp-gpr b u{text-decoration:none;font:700 11px/1 Manrope,sans-serif;letter-spacing:.1em;color:#7A5B12;background:rgba(201,162,75,.22);border-radius:999px;padding:4px 8px}",
      ".fo-cp-gpr span{display:block;margin-top:5px;font:400 12.5px/1.5 Manrope,sans-serif;color:var(--navy)}",
      ".fo-cp-gpr em{display:block;margin-top:3px;font-style:normal;font:400 13px/1.45 Manrope,sans-serif;color:rgba(12,27,51,.55)}",
      ...
      "html body #page table.fo-cp-tr th{background:var(--navy);color:#FFFEFC;font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;text-align:right;padding:9px 7px;white-space:nowrap}",
      "html body #page table.fo-cp-tr th.nm{text-align:left}",
      "html body #page table.fo-cp-tr td{padding:8px 7px;text-align:right;white-space:nowrap;font:600 12px/1.2 Manrope,sans-serif;color:#1B2432;border-bottom:1px solid rgba(12,27,51,.07)}",
      "html body #page table.fo-cp-tr td.nm{text-align:left;font-family:Manrope,sans-serif;font-weight:500;font-size:12.5px;white-space:normal}",
      ...
      "html body #page table.fo-cp-tr td.wy{font:700 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;text-align:left}",
      ...
      ".fo-cp-evday{margin:14px -22px 0;padding:8px 22px;background:rgba(12,27,51,.05);font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--navy)}",
      ...
      ".fo-cp-ev .t{font:600 13px/1.4 Manrope,sans-serif;color:rgba(12,27,51,.42);font-variant-numeric:tabular-nums}",
      ".fo-cp-ev .w{font:400 13px/1.55 Manrope,sans-serif;color:var(--navy)}",
      ...
      "html body #page .fo-cp-mineact a{font:600 11px/1 Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#B44A22 !important;background:#FFFEFC;border:1px solid rgba(12,27,51,.14);border-radius:999px;padding:9px 14px;text-decoration:none !important}",
      "html body #page .fo-cp-cta{display:block;text-align:center;font:700 12px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFEFC !important;background:linear-gradient(180deg,#E8894A,#C9571F);border-radius:12px;padding:14px;text-decoration:none !important;box-shadow:0 10px 26px rgba(200,84,47,.3);margin:14px 0 10px}",
      ".fo-cp-foot{display:flex;justify-content:space-between;flex-wrap:wrap;gap:2px 10px;padding:8px 4px}",
      "html body #page .fo-cp-foot a{display:inline-flex;align-items:center;min-height:44px;padding:0 13px;margin:0 -13px;border-radius:12px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#B44A22 !important;text-decoration:none !important}",
