...
(function () {
  ...
  function foClubCss() {
    ...
    s.textContent = [
      ...
      ".fo-cd-id .meta span{font:600 10px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#8a93a2}",
      ...
      ".fo-cd-id .foot .f span{font:600 10px/1.4 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a93a2;display:block}",
      ...
      "html body #page .fo-cd-gr .gd{flex:none;border:1.5px solid rgba(255,254,252,.65);border-radius:9px;padding:10px 12px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#FFFEFC !important;background:rgba(9,18,32,.35);white-space:nowrap;text-decoration:none !important;min-height:38px;display:inline-flex;align-items:center}",
      ...
      ".fo-cd-gr .grb span{font:600 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a93a2}",
      ...
      ".fo-cd-pos .pts{font:600 10.5px/1 Oswald,sans-serif;letter-spacing:.08em;color:#E8B96A;margin-top:6px}",
      ".fo-cd-pos .grid{flex:1;display:flex;justify-content:space-around}",
      ".fo-cd-pos .grid span{font:600 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(244,239,228,.55);text-align:center}",
      ".fo-cd-pos .grid b{display:block;font:600 14px/1.7 Inter,sans-serif;color:#F6F2E8}",
      "html body #page .fo-cd-pos .vt{flex:none;font:600 10px/1.45 Oswald,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#E8B96A !important;text-align:center;text-decoration:none !important;min-height:44px;display:inline-flex;align-items:center}",
      ...
      // next fixture
      ".fo-cd-nf .tag{display:inline-block;background:rgba(176,74,44,.1);border:1px solid rgba(176,74,44,.35);color:var(--acc);border-radius:7px;padding:5px 9px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;margin-bottom:11px}",
      ...
      ".fo-cd-nf h3 u{display:block;text-decoration:none;font:600 10px/1 Oswald,sans-serif;letter-spacing:.12em;color:#8a93a2;margin-top:5px}",
      ...
      ".fo-cd-nf .det span{font:600 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#8a93a2}",
      ...
      ".fo-cd-nf .thn{font:600 10px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:#8a93a2;margin:14px 0 3px}",
      ...
      ".fo-cd-nf .ur .d{flex:none;width:52px;font:600 10px/1.35 Oswald,sans-serif;letter-spacing:.05em;text-transform:uppercase;color:var(--acc)}",
      ...
      ".fo-cd-nf .ur .c{margin-left:auto;font:600 10px/1 Oswald,sans-serif;letter-spacing:.09em;text-transform:uppercase;color:#F1EEE6;background:#41577A;border-radius:6px;padding:5px 7px;white-space:nowrap}",
      // recent form
      ...
      ".fo-cd-di .d{flex:none;width:42px;font:600 10px/1.7 Oswald,sans-serif;letter-spacing:.06em;text-transform:uppercase;color:var(--acc)}",
      ...
      ".fo-cd-cmp .st em{font-style:normal;font:400 12px/1 Inter,sans-serif;color:#8a93a2}",
      ...
      ".fo-cd-hn .r em{font-style:normal;font:400 12px/1 Inter,sans-serif;color:#8a93a2}",
      ...
      ".fo-cd-slim i{display:block;font:600 10px/1.4 Oswald,sans-serif;font-style:normal;letter-spacing:.12em;text-transform:uppercase;color:#8a93a2;margin-top:4px}",
      ...
      ".fo-cd-pos .xtra .fl{font:600 10px/1 Oswald,sans-serif;letter-spacing:.13em;text-transform:uppercase;color:rgba(244,239,228,.55);margin-bottom:9px}",
      ...
      ".fo-cp-starf i{font:600 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,253,247,.5);font-style:normal}",
      ...
      ".fo-cp-sale{display:inline-block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#7A5210;background:linear-gradient(120deg,#F3DFA9,#E8B96A);border-radius:5px;padding:3.5px 6px;vertical-align:2px;margin-left:7px;white-space:nowrap}",
      ".fo-cp-startags{display:flex;gap:6px;flex-wrap:wrap;margin-top:4px}",
      ".fo-cp-startags em{font-style:normal;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#BFE8CF;background:rgba(79,191,133,.18);border:1px solid rgba(79,191,133,.34);border-radius:6px;padding:5px 8px}",
      ...
      ".fo-cp-starovr i,.fo-cp-starval i{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,253,247,.5);font-style:normal}",
      ...
      ".fo-cp-cols{padding:0 12px 8px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(12,27,51,.42);text-align:center}",
      ...
      ".fo-cp-great .mk{display:block;font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(12,27,51,.45);margin-bottom:4px;font-style:normal}",
      ...
      "html body #page .fo-cp-chrow button{font:700 11px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFDF7 !important;background:linear-gradient(180deg,#E8894A,#C9571F) !important;border:0 !important;border-radius:9px !important;padding:12px 20px !important;min-height:44px;cursor:pointer}",
      ...
      ".fo-cp-gkv span{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(12,27,51,.45)}",
      ...
      ".fo-cp-gpr b u{text-decoration:none;font:700 10px/1 Oswald,sans-serif;letter-spacing:.1em;color:#7A5B12;background:rgba(201,162,75,.22);border-radius:999px;padding:4px 8px}",
      ...
      ".fo-cp-trk span{display:block;font:600 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(12,27,51,.45)}",
      ...
      "html body #page table.fo-cp-tr th{background:var(--navy);color:#FFFDF7;font:700 10px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;text-align:right;padding:9px 7px;white-space:nowrap}",
      ...
      "html body #page table.fo-cp-tr td.wy{font:700 10px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;text-align:left}",
      ...
      ".fo-cp-evday{margin:14px -22px 0;padding:8px 22px;background:rgba(12,27,51,.05);font:700 10px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:var(--navy)}",
