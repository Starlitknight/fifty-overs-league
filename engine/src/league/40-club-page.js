...
(function () {
  ...
  var PITCH_NOTE = {
    ...
    dry: ["Strong help for spin bowlers - finger spin far more than wrist - growing as the pitch wears. Weak disadvantage to seam bowlers in the middle overs.", "Pick extra spin bowlers."],
    ...
    cracked: ["Strong help for all bowlers - wrist spin notably more from the bounce - and more again in the second innings. Strong disadvantage to batters.", "Pick batting depth."],
