...
(function () {
  ...
  function foClubCss() {
    ...
    s.textContent = [
      ".fo-cp{min-height:70vh;--navy:#0C1B2E;--gold:#C9A24B;--grn:#1F6F4A;--paper:#F7F3E8;--acc:#B44A22;--ink:#14202F;--mut:#67748a;--edge:rgba(20,32,47,.1)}",
      ...
      "html body #page .fo-cp-tools select{background:#FFFDF7 !important;color:var(--navy) !important;border:1px solid rgba(12,27,51,.18);border-radius:8px;padding:9px 12px;font:600 11px/1 Inter,sans-serif;letter-spacing:.1em;text-transform:uppercase;-webkit-appearance:menulist;appearance:menulist}",
      ...
      ".fo-cp-starn b{font:700 22px/1.1 Inter,sans-serif;color:#FFFDF7;text-transform:uppercase}",
      ...
      ".fo-cp-starval b{display:block;font:700 17px/1.2 Inter,sans-serif;color:#FFFDF7;margin-top:4px}",
      ...
      ".fo-cp-form i{font-style:normal;width:22px;height:22px;display:inline-flex;align-items:center;justify-content:center;border-radius:6px;font:700 11px/1 Inter,sans-serif;color:#FFFDF7}",
      ...
      "html body #page .fo-cp-chrow button{font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFDF7 !important;background:linear-gradient(180deg,#E8894A,#C9571F) !important;border:0 !important;border-radius:9px !important;padding:12px 20px !important;min-height:44px;cursor:pointer}",
      ...
      "html body #page .fo-cp-fr button{font:700 11px/1 Inter,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:var(--navy) !important;background:#FFFDF7 !important;border:1px solid rgba(12,27,51,.22) !important;border-radius:999px !important;padding:9px 13px !important;min-height:44px;cursor:pointer}",
      ...
      "html body #page table.fo-cp-tr th{background:var(--navy);color:#FFFDF7;font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase;text-align:right;padding:9px 7px;white-space:nowrap}",
      ...
      "html body #page .fo-cp-mineact a{font:600 11px/1 Inter,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#B44A22 !important;background:#FFFDF7;border:1px solid rgba(12,27,51,.14);border-radius:999px;padding:9px 14px;text-decoration:none !important}",
      "html body #page .fo-cp-cta{display:block;text-align:center;font:700 12px/1 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#FFFDF7 !important;background:linear-gradient(180deg,#E8894A,#C9571F);border-radius:12px;padding:14px;text-decoration:none !important;box-shadow:0 10px 26px rgba(200,84,47,.3);margin:14px 0 10px}",
