...
(function () {
  ...
  function foPmCss() {
    ...
    var css = [
      ...
      ".fo-pm-folio span{font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.18em;font-size:10px;color:var(--navy)}",
      ...
      ".fo-pm-billside b{display:block;font-family:Oswald,sans-serif;font-weight:700;text-transform:uppercase;line-height:1.04;letter-spacing:.005em;font-size:clamp(14px,3.9vw,21px);color:var(--navy);overflow-wrap:anywhere}",
      ".fo-pm-billside i{display:block;margin-top:3px;font-family:Oswald,sans-serif;font-style:normal;text-transform:uppercase;letter-spacing:.22em;font-size:10px;color:#9FB0C6}",
      ...
      ".fo-pm-v span{font-family:Oswald,sans-serif;font-size:10.5px;letter-spacing:.1em;text-transform:uppercase;color:var(--acc);line-height:1}",
      ".fo-pm-sh{display:grid;place-items:center;width:29px;height:29px;border-radius:7px;background:var(--sc,#14243A);color:#fff;font:700 11px/1 Oswald,sans-serif;letter-spacing:.04em;flex:0 0 auto}",
      ...
      ".fo-pm-fact b{display:block;font-family:Oswald,sans-serif;font-weight:600;font-size:clamp(11.5px,3vw,15px);line-height:1.2;color:var(--navy);font-variant-numeric:tabular-nums;overflow-wrap:anywhere}",
      ".fo-pm-fact i{display:block;margin-top:3px;font-family:Oswald,sans-serif;font-style:normal;text-transform:uppercase;letter-spacing:.14em;font-size:10px;color:#9FB0C6;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ...
      ".fo-pm-cap{font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.14em;font-size:10px;color:var(--navy);font-weight:600}",
      ...
      ".fo-pm-wph u,.fo-pm-wpa u{text-decoration:none;font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.08em;font-size:10px;color:var(--ink);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:600}",
      ".fo-pm-wph b,.fo-pm-wpa b{font-family:Oswald,sans-serif;font-weight:700;font-size:clamp(20px,5vw,26px);line-height:1;font-variant-numeric:tabular-nums}",
      ...
      "#page a.fo-pm-sl .fo-pm-her{grid-column:2;grid-row:2;font:500 12px/1.35 Oswald,sans-serif;color:rgba(27,36,50,.55)}",
      ...
      "#page a.fo-pm-sl .fo-pm-slst u{text-decoration:none;font:600 11px/1 Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#9FB0C6}",
      "#page a.fo-pm-sl .fo-pm-slst u b{display:block;grid-column:auto;grid-row:auto;font:600 12.5px/1.5 Oswald,sans-serif;color:var(--ink);letter-spacing:0;margin:0;font-variant-numeric:tabular-nums}",
      ...
      ".fo-pm-beads i{display:grid;place-items:center;width:19px;height:19px;border-radius:4px;font:700 10px/1 Oswald,sans-serif;font-style:normal;color:#fff}",
      ...
      "#page a.fo-pm-h2h i{grid-row:span 2;font:700 11px/1 Oswald,sans-serif;font-style:normal;color:#9FB0C6}",
      "#page a.fo-pm-h2h b{font:600 12.5px/1.3 Oswald,sans-serif;color:var(--navy)}",
      ...
      ".fo-pm-big{font:700 24px/1.05 Oswald,sans-serif;color:var(--navy);letter-spacing:-.3px}",
      ".fo-pm-prn{margin:0;font:400 13px/1.55 Oswald,sans-serif;color:#3c4757}",
      ...
      ".fo-pm-mast{font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10px;color:var(--acc)}",
