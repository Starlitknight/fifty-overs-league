...
(function () {
  ...
  var CSS = [
    "html body #page .fo-md{max-width:680px;margin:26px auto 44px;padding:0 14px;color:#141C28}",
    ...
    "html body #page .fo-md-kick:after{content:'';display:block;width:34px;border-top:2px solid #C95532;margin-top:7px}",
    ...
    "html body #page .fo-md-mast h1 span{font-style:italic;font-weight:400;color:rgba(20,28,40,.4);font-size:.7em}",
    "html body #page .fo-md-mast>p{font:italic 420 13px/1.5 'Fraunces',Georgia,serif;color:rgba(20,28,40,.55);margin:0 0 14px}",
    "html body #page .fo-md-prob .bar{height:9px;border-radius:999px;background:rgba(20,28,40,.1);overflow:hidden}",
    "html body #page .fo-md-prob .bar i{display:block;height:100%;background:linear-gradient(90deg,#C95532,#B44A22);border-radius:999px}",
    "html body #page .fo-md-prob .lbl{display:flex;justify-content:space-between;font:700 10.5px/1 Oswald,sans-serif;letter-spacing:.08em;margin-top:6px;color:rgba(20,28,40,.65)}",
    "html body #page .fo-md-ctas{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}",
    "html body #page .fo-md-cta{font:700 12px/1 Inter,sans-serif;border-radius:999px;padding:11px 16px;text-decoration:none;background:#FFFEFC;border:1px solid rgba(20,28,40,.15);color:rgba(20,28,40,.75)}",
    "html body #page .fo-md-cta.hot{background:#C95532;border-color:#C95532;color:#FFFEFC}",
    ...
    "html body #page .fo-md-line i{flex:none;width:64px;font:700 9px/1.4 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    "html body #page .fo-md-line span{font:400 13px/1.5 Inter,sans-serif;color:rgba(20,28,40,.75)}",
    ...
    "html body #page .fo-md-h2h i{font:400 11.5px/1.3 Inter,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
    "html body #page .fo-md-h2h u{text-decoration:none;color:rgba(20,28,40,.3)}",
    "html body #page .fo-md-h2h s{text-decoration:none;font:400 11px/1 Inter,sans-serif;color:rgba(20,28,40,.45)}",
    "html body #page .fo-md-last{font:italic 400 12px/1.5 'Fraunces',Georgia,serif;color:rgba(20,28,40,.6);margin:8px 0 0}",
    "html body #page .fo-md-xis{display:grid;grid-template-columns:1fr 1fr;gap:14px}",
    "html body #page .fo-md-xi>i{display:block;font:700 9px/1.3 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;margin-bottom:6px}",
    "html body #page .fo-md-xi .p{display:flex;gap:7px;align-items:baseline;padding:3px 0;font:500 12px/1.3 Inter,sans-serif}",
    "html body #page .fo-md-xi .p u{text-decoration:none;font-size:9.5px;color:rgba(20,28,40,.4);width:14px;font-variant-numeric:tabular-nums}",
    "html body #page .fo-md-xi .p b{font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    "html body #page .fo-md-xi .p em{font-style:normal;font-size:9px;color:#B44A22}",
    "html body #page .fo-md-sec.pundit{background:linear-gradient(150deg,#FFFEFB,#F6F1E4) !important}",
    "html body #page .fo-md-quote{font:italic 420 14.5px/1.6 'Fraunces',Georgia,serif;color:rgba(20,28,40,.78);margin:0 0 6px}",
    "html body #page .fo-md-sec.pundit>i{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    "html body #page .fo-md-foot{display:flex;gap:10px;justify-content:space-between;margin-top:18px;flex-wrap:wrap}",
    "html body #page .fo-md-foot a{font:600 12px/1 Inter,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
