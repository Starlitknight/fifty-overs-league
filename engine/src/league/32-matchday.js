...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-md-line i{flex:none;width:64px;font:700 10px/1.4 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    ...
    "html body #page .fo-md-xi>i{display:block;font:700 10px/1.3 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;margin-bottom:6px}",
