...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-md-kick{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:.22em;text-transform:uppercase;color:#B44A22}",
    ...
    "html body #page .fo-md-prob .lbl{display:flex;justify-content:space-between;font:700 11px/1 Manrope,sans-serif;letter-spacing:.08em;margin-top:6px;color:rgba(20,28,40,.65)}",
    "html body #page .fo-md-ctas{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}",
    "html body #page .fo-md-cta{font:700 13px/1 Manrope,sans-serif;border-radius:999px;padding:11px 16px;text-decoration:none;background:#FFFEFC;border:1px solid rgba(20,28,40,.15);color:rgba(20,28,40,.75)}",
    ...
    "html body #page .fo-md-line i{flex:none;width:64px;font:700 11px/1.4 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    "html body #page .fo-md-line span{font:400 13px/1.5 Manrope,sans-serif;color:rgba(20,28,40,.75)}",
    "html body #page .fo-md-h2h{display:flex;gap:10px;align-items:baseline;flex-wrap:wrap}",
    "html body #page .fo-md-h2h b{font-family:Manrope,sans-serif;font-weight:700;font-size:24px}",
    "html body #page .fo-md-h2h i{font:400 13px/1.3 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
    "html body #page .fo-md-h2h u{text-decoration:none;color:rgba(20,28,40,.3)}",
    "html body #page .fo-md-h2h s{text-decoration:none;font:400 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.45)}",
    ...
    "html body #page .fo-md-xi>i{display:block;font:700 11px/1.3 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;margin-bottom:6px}",
    "html body #page .fo-md-xi .p{display:flex;gap:7px;align-items:baseline;padding:3px 0;font:500 13px/1.3 Manrope,sans-serif}",
    ...
    "html body #page .fo-md-sec.pundit>i{font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    "html body #page .fo-md-foot{display:flex;gap:10px;justify-content:space-between;margin-top:18px;flex-wrap:wrap}",
    "html body #page .fo-md-foot a{font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
