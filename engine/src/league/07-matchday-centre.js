  ...
  function foDashCss() {
    ...
    s.textContent =
      ...
      "body.fo-dash .db-b{display:inline-flex;min-width:26px;height:26px;padding:0 4px;border-radius:50%;align-items:center;justify-content:center;font:700 13px Oswald,sans-serif;background:#EFE9DB;color:#6b6154;border:1px solid #e0d8c8;font-style:normal}" +
      ...
      "body.fo-dash .fo-db-bug .st b.sm{font-size:11px;font-family:Oswald,sans-serif;font-weight:500;max-width:150px}" +
      ...
      "body.fo-dash .db-p .pr u{display:block;text-decoration:none;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.2px;text-transform:uppercase;color:#8a7f6e;margin-top:2px}" +
      ...
      "body.fo-dash .db-cr b{font-family:Oswald,sans-serif;font-weight:600;font-size:11.5px;color:#8a7f6e}" +
      ...
      "body.fo-dash .db-cr p .who{font-family:Oswald,sans-serif;font-weight:500;font-size:10.5px;letter-spacing:.5px;color:#14243A;text-transform:uppercase}" +
      ...
      "#fo-commpage{position:fixed;inset:0;z-index:900;background:#F6F3EB;display:flex;flex-direction:column;font-family:Oswald,system-ui,sans-serif;color:#14243A}" +
      ...
      "#fo-commpage .db-cr b{font-family:Oswald,sans-serif;font-weight:600;font-size:12px;color:#8a7f6e}" +
      "#fo-commpage .db-cr p{margin:0;font-size:13.5px;line-height:1.55;color:#3a3427}" +
      "#fo-commpage .db-cr p .who{font-family:Oswald,sans-serif;font-weight:500;font-size:12px;letter-spacing:.6px;color:#14243A;text-transform:uppercase}" +
      ...
      "#fo-commpage .cp-band{display:flex;align-items:center;gap:12px;background:#14243A;color:#E8B96A;border-radius:9px;padding:9px 16px;margin:10px 0;font:500 11.5px Oswald,sans-serif;letter-spacing:1.6px;text-transform:uppercase}" +
      "#fo-commpage .cp-band.inn{background:#C9571F;color:#fff;font-size:13px}" +
      "#fo-commpage .cp-mile{background:linear-gradient(90deg,#FBF3E4,#FDFAF2);border:1px solid #E8B96A;border-radius:9px;padding:10px 16px;margin:8px 0;font:600 13px Oswald,sans-serif;color:#7a5a17}" +
  ...
  function foThCss() {
    ...
    s.textContent =
      ...
      "body.fo-th .fo-mst-score .ovs{display:block;font-family:Oswald,sans-serif;font-size:11px;letter-spacing:2.4px;text-transform:uppercase;color:#E8B96A;margin-top:3px}" +
      ...
      "body.fo-th #fo-th-gauge .gv i{font-style:normal;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#E8B96A;margin-left:4px}" +
      ...
      "#fo-ovhd b{font-family:Oswald,sans-serif;font-weight:600;font-size:11px;letter-spacing:2.4px;text-transform:uppercase;color:#E8B96A}" +
      ...
      "#fo-th-gf b{display:block;font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#E8B96A;margin-bottom:2px}" +
      ...
      "#fo-th-cut .ct b{font-family:Oswald,sans-serif;font-weight:600;font-size:30px;letter-spacing:5px;color:#E8B96A}" +
      ...
      "html body #fo-mob-nav button span{font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:2px;text-transform:uppercase}" +
      ...
      "html body #fo-mob-spdchip{display:flex;align-items:center;justify-content:center;position:fixed;right:12px;bottom:calc(66px + env(safe-area-inset-bottom));z-index:57;min-width:44px;min-height:32px;padding:5px 10px;border-radius:999px;font-family:Oswald,sans-serif !important;font-weight:600 !important;font-size:12px;letter-spacing:1px;background:rgba(5,20,40,.6) !important;border:1.5px solid rgba(255,255,255,.3) !important;color:rgba(255,255,255,.88) !important;cursor:pointer;box-shadow:none !important;transition:bottom .25s ease}" +
      ...
      "html body.fo-th[data-mobsheet='oval'] #fo-oval #fo-mst-talk .tl{flex-basis:100%;text-align:center;font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:2.2px;text-transform:uppercase;color:#E8B96A;margin:0}" +
  ...
  try {
    ...
    msCss.textContent =
      ...
      ".fo-mst-ask .askopt .who i{font-style:normal;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.4px;text-transform:uppercase;color:rgba(255,255,255,.72)}" +
      ...
      ".fo-mst-ask .askopt .tag{position:static;transform:none;font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:1.8px;text-transform:uppercase;color:#E8B96A;white-space:nowrap}" +
      ...
      ".fo-mst-ask .ask-t{font-family:Oswald,sans-serif;font-weight:600;font-size:19px;letter-spacing:1.6px;text-transform:uppercase;color:#E8B96A}" +
      ...
      ".fo-mst-ask .ask-opts button i{font-style:normal;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.6px;text-transform:uppercase;color:#E8B96A}" +
      ...
      "#fo-mst-talk .tl{font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:2px;text-transform:uppercase;color:#8ea0c0;margin-right:4px}" +
      ...
      ".fo-mst-score i{display:block;font-style:normal;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:1.6px;text-transform:uppercase;color:#E8B96A;margin-top:3px}" +
      ...
      ".fo-mst-p .rl{color:#f5c85b;font-family:Oswald,sans-serif;font-size:10px;font-weight:600;letter-spacing:1.8px;text-transform:uppercase}" +
      ...
      "html body #page #fo-commfull-btn,html body.ftpskin #page #fo-commfull-btn{display:block;margin:8px auto 2px;font-family:Oswald,sans-serif !important;font-weight:600 !important;font-size:10.5px;letter-spacing:1.8px;text-transform:uppercase;color:#6A6354 !important;background:transparent !important;border:1.5px solid #d8d2c5 !important;border-radius:999px;padding:8px 18px;cursor:pointer;box-shadow:none !important}" +
