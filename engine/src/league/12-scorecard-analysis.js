  ...
  function foRenderLeague() {
    try {
      ...
      try {
        ...
        // grounds strip: click-drag to scroll through every ground (a drag never opens a ground)
        page.querySelectorAll(".fo-ov-gstrip").forEach(function (strip) {
  ...
  try {
    ...
    lgCss.textContent = [
      ...
      ".fo-ov-subnav{position:absolute;top:0;left:0;right:0;border-bottom:0;padding:16px 34px}",
