  ...
  try {
    ...
    lgCss.textContent = [
      ...
      ".fo-ov-fig{height:98%;right:-5%;left:auto;top:auto;bottom:0;object-position:bottom;-webkit-mask-image:radial-gradient(58% 90% at 56% 47%,#000 40%,transparent 78%);mask-image:radial-gradient(58% 90% at 56% 47%,#000 40%,transparent 78%)}",
      ".fo-ov-figtag{display:block;left:46%;right:auto;bottom:24%;top:auto;text-align:left}",
