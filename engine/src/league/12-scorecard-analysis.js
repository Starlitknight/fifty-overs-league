  ...
  var FO_CX_REGIONS = [
    ...
    // -- the seventh door: not a nation but a man. Unlocks when all six
    //    regions are conquered; beating it ends the world tour.
    { id: "gt", nm: "The World Final", cty: "England", arch: "greybeard", type: "The Summit", ac: "#C8674A", final: 1,
      ...
      clubs: [
        { boss: 1, final: 1, mx: 50, my: 40, nm: "Thorne's Invincible XI", city: "Marylebone", capt: "master",
          ...
          taunt: "Six trophies against small opposition. I've selected accordingly. Bring your whole game - you'll be needing it.",
          ...
          mult: 1.2, tadj: 0.012, sig: "invincible",
        ...
        html = "<div class='fo-cx' style='--cxc:" + r.ac + "'>" +
          ...
          (function () {
            ...
            return "<div class='fo-cx-stage'>" +
              ...
              "<img src='" + FO_ART + (r.final ? "thorne.png" : "circuit/" + r.id + ".webp") + "' alt=''" + (r.final ? " style='object-fit:cover;object-position:50% 12%'" : "") + ">" +
