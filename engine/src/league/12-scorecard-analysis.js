  ...
  function foRenderLeague() {
    try {
      ...
      if (own) {
        ...
        var idx19 = FO_CX_REGIONS.filter(function (r) { return !r.final; }).findIndex(function (r) { return r.id === nation; }) + 1;
        var lineAv = function (idx) { var e = L[idx]; if (!e) return ""; if (e.isMe) return "<img src='" + foLgArtFallback(nation) + "' alt=''>"; if (e.boss) return "<img class='crest' src='" + foLgClubCrest(nation, e.sideObj) + "' alt='' onerror=\"this.onerror=null;this.src='" + foLgClubArt(nation, e.sideObj) + "'\">"; return foLgArtImg(nation, e.sideObj); };
        var myFx = (sched[round] || []).filter(function (f) { return f[0] === 0 || f[1] === 0; })[0] || null;
        // the identity match card (or, at season's end, the champion + reset)
        var matchCard;
        if (done) {
          ...
          matchCard = "<div class='fo-ov-match'>" +
            ...
            "<div class='fo-ov-team'><span class='av'>" + lineAv(myFx[0]) + "</span><b>" + E(L[myFx[0]].name) + "</b></div>" +
            "<div class='fo-ov-mid'><span class='vs'>VS</span><span class='t'>19:30</span></div>" +
            "<div class='fo-ov-team a'><span class='av'>" + lineAv(myFx[1]) + "</span><b>" + E(L[myFx[1]].name) + "</b></div>" +
            "</div>" +
          ...
          matchCard = "<div class='fo-ov-match'><div class='fo-ov-mh'>Season complete</div></div>";
        }
        var chaseRows = table.slice(0, 4).map(function (x, i) {
          return "<div class='fo-ov-crow" + (x.isMe ? " me" : "") + "'><span class='r'>" + (i + 1) + "</span><span class='n'>" + E(x.name) + "</span><span class='p'>" + x.pts + "</span><span class='nr'>" + (x.nrr == null ? "&middot;" : (x.nrr >= 0 ? "+" : "") + x.nrr.toFixed(2)) + "</span></div>";
        }).join("");
        ...
        page.innerHTML =
          "<div class='fo-lg fo-ov' style='--lac:" + ac + "'>" +
          ...
          "<button type='button' data-ovtab='fixtures'>Fixtures</button>" +
          ...
          "<div class='fo-ov-eb'>Your Domestic League &middot; Season " + (s.season || 1) + "</div>" +
          ...
          "<div class='fo-ov-pstats'><div><i>You</i><b>" + foOrdinal(mePos || 8) + "</b></div><div><i>Top 4</i><b>Qualify</b></div><div><i>" + (14 - round) + "</i><b>Rounds left</b></div></div>" +
          ...
          "<section id='fo-ov-fixtures' class='fo-ov-sec'><h2>Round " + (round + 1) + " Fixtures</h2><div class='fo-lg-side'>" + sideHTML + "</div></section>" +
      ...
      page.innerHTML =
        "<div class='fo-lg fo-lg-cinemode ro' style='--lac:" + ac + "'>" +
        "<div class='fo-lg-bg' style='background-image:url(" + mapSrc + ")'></div><div class='fo-lg-scrim'></div><div class='fo-lg-atmo'></div>" +
        ...
        "<div class='fo-lg-cnav'><a href='#/home'>&#8962; Club</a><a href='#/world'>&#127760; World</a><a href='#/league'>Your league</a></div>" +
        "<a class='fo-lg-cflag' href='#/world' title='World map'>" + flag + "</a>" +
        "<div class='fo-lg-ctitle'>" +
        "<div class='eb'>The Grand Tour &middot; Rival League</div>" +
        "<h1>" + E(region.nm) + "</h1>" +
        "<div class='fo-lg-style'>" + (region.type ? "<span class='pill'>" + E(region.type) + "</span>" : "") + "<span class='pill ghost'>" + E(foPitchName(region.pitch)) + " pitches</span><span class='pill ghost'>" + E(region.wx || "") + "</span></div>" +
        (tagline ? "<p class='fo-lg-tag'>&ldquo;" + E(tagline) + "&rdquo;</p>" : "") +
        "<div class='fo-lg-status'>" + statusLine + "</div>" +
        "</div></section>" +
        "<div class='fo-lg-body'>" +
        "<div class='fo-lg-grid'>" +
        "<div class='fo-lg-tablewrap'><div class='fo-lg-thead'><span class='rk'>#</span><span class='av'></span><span class='nm'>Club</span><span class='c'>P</span><span class='c'>W</span><span class='c'>L</span><span class='c'>NRR</span><span class='c'>Pts</span></div>" +
        tableRows + "<div class='fo-lg-qnote'>Top 4 qualify for the Champions Cup</div></div>" +
        "<div class='fo-lg-side'>" + sideHTML + "</div>" +
        "</div>" +
        (grounds ? "<div class='fo-lg-groundsec'><div class='fo-lg-grhd'><i></i><b>THE GROUNDS OF " + E(String(region.nm).toUpperCase()) + "</b><i></i></div><div class='fo-lg-grounds'>" + grounds + "</div></div>" : "") +
        "</div>" +
        "</div>";
      }
      try { document.body.classList.add("fo-boss-on"); } catch (eBc) {}
  ...
  try {
    ...
    lgCss.textContent = [
      ...
      ".fo-ov-gstrip{display:flex;gap:10px;overflow-x:auto;scroll-snap-type:x mandatory;padding:12px 16px 14px;scrollbar-width:none}",
      ...
      ".fo-ov-fig{height:98%;right:19%;top:auto;bottom:0;object-position:bottom;-webkit-mask-image:radial-gradient(58% 90% at 56% 47%,#000 38%,transparent 76%);mask-image:radial-gradient(58% 90% at 56% 47%,#000 38%,transparent 76%)}",
