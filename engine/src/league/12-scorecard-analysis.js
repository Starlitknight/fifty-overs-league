  ...
  var FO_CX_REGIONS = [
    ...
    { id: "ire", nm: "Ireland", cty: "Ireland", arch: "engine", type: "Green Graft", ac: "#1F7A4D", bg: "eng.webp", art: "circuit/trophy-eng.webp",
    ...
    { id: "ned", nm: "Netherlands", cty: "Netherlands", arch: "miser", type: "Total Cricket", ac: "#C46A1F", bg: "eng.webp", art: "circuit/trophy-nzl.webp",
    ...
    { id: "zim", nm: "Zimbabwe", cty: "Zimbabwe", arch: "prodigy", type: "Fighting Spirit", ac: "#B8471F", bg: "rsa.webp", art: "circuit/trophy-rsa.webp",
    ...
    { id: "slk", nm: "Sri Lanka", cty: "Sri Lanka", arch: "wizard", type: "Flight & Guile", ac: "#2E6FB2", bg: "sub.webp", art: "circuit/trophy-sub.webp",
      ...
      trophy: "The Serendib Gem", nats: ["Sri Lanka"],
      clubs: [
        { mx: 46, my: 78, nm: "Monsoon CC", city: "Colombo", note: "flighted off-spin", gq: "Monsoon flight it and let it dip. Bowl full, attack before it grips.", taunt: "Flight, dip, a puff of dust. Watch your feet, friend.", nug: "Colombo: heat, flight and off-spin that dips late. They're a different side when the ball seams - pray for cloud, bowl full, and attack before it grips.", mult: 1.00 },
        ...
        { boss: 1, mx: 52, my: 62, nm: "The Serendib Sorcerers", city: "Kandy", capt: "talisman",
          leader: "Chaminda Silva", bimg: "players/fs_ind.webp", note: "the ball above your eyeline is already a trap", gq: "Silva buys wickets with flight - every full toss is bait. Hit him along the floor or not at all.", taunt: "I bowl gifts. Unwrap one and see.", nug: "Kandy: Silva tosses it higher than anyone dares and dips it on your bootlaces - the catchers wait for the mishit he's been shopping for. Along the floor, hard sweeps, no charity: make him buy wickets at full price.", mult: 1.12,
          ...
          winln: "You refused every gift I bowled. A batsman with manners AND a brain - rare. The Gem is yours.", lossln: "You unwrapped the wrong ones, friend. My gifts always cost more than they look." }
      ] },
    ...
    { id: "pak", nm: "Pakistan", cty: "Pakistan", arch: "express", type: "Reverse & Raw Pace", ac: "#1E7F5C", bg: "sub.webp", art: "circuit/trophy-rsa.webp",
      ...
      clubs: [
        ...
        { boss: 1, mx: 56, my: 40, nm: "The Lahore Lions", city: "Lahore", capt: "talisman",
          ...
          winln: "Ahead of the game before my ball got old. You read the innings better than I bowled it - take the Mace.", lossln: "The old ball sang and your tail danced to it. Score faster, sooner - or learn to survive it." }
      ] },
    { id: "afg", nm: "Afghanistan", cty: "Afghanistan", arch: "wizard", type: "Mystery Spin", ac: "#5B4A91", bg: "sub.webp", art: "circuit/trophy-sub.webp",
      ...
      clubs: [
        ...
        { boss: 1, mx: 30, my: 74, nm: "The Mountain Storm", city: "Kandahar", capt: "younggun",
          ...
          winln: "You never picked it. You just refused to panic - and the mountain respects nothing more. The Star is yours; the summit is next.", lossln: "Six more swore they picked it today. The Storm keeps their names. Come back calmer." }
      ] },
