  ...
  var FO_CX_REGIONS = [
    ...
    { id: "sub", nm: "India", cty: "India", arch: "wizard", type: "Spin Web", ac: "#7B45C4", arrive: "India, boss. Feel the crowd before you see the ground - a hundred thousand opinions, all about us. Spin, dust and expectation.",
      ...
      clubs: [
        { mx: 30, my: 52, nm: "The Maidan Kings", city: "Mumbai", note: "wristy mystery-spin", gq: "Maidan wristmen spin webs from dust. Sweep hard, use your feet — early.", taunt: "You can't sweep what you can't pick.", nug: "Mumbai: wristy magicians raised on maidan dust bowls. Sweep hard and use your feet early - once the pitch bites, the web is spun.", mult: 1.04 },
        { mx: 71, my: 40, nm: "Eden Roar", city: "Kolkata", note: "a hundred thousand fielders", gq: "Eden's crowd bats at number twelve. Quiet them in the first ten and the Roar plays for you.", taunt: "A hundred thousand of us. Eleven of you.", nug: "Kolkata: an ordinary over here sounds like a riot and their cricket rises with the noise. Early wickets mute the stands - and a muted Eden Roar is just a decent club side a long way from the rope.", mult: 1.08 },
        { boss: 1, mx: 47, my: 48, nm: "The Dust Devils", city: "Nagpur", capt: "talisman",
    ...
    { id: "afg", nm: "Afghanistan", cty: "Afghanistan", arch: "wizard", type: "Mystery Spin", ac: "#5B4A91",
      ...
      clubs: [
        { mx: 62, my: 38, nm: "Kabul Kites", city: "Kabul", note: "wrist-spin off the rooftops", gq: "The Kites learned spin with a taped ball and no coach - nothing they bowl is in a textbook. Watch the hand, not the pitch.", taunt: "Your coaches never taught you our deliveries. Nobody taught us either.", nug: "Kabul: self-taught wrist-spinners with actions no manual describes. The textbook is useless - watch the hand, trust the depth of your crease, and never plant the front foot early.", mult: 1.08 },
        { mx: 76, my: 46, nm: "Hindu Kush Highlanders", city: "Jalalabad", note: "hit first, ask never", gq: "The Highlanders swing at everything from ball one. Hold your nerve - the collapse is always one ball away.", taunt: "We score at eight an over or we lose trying. Mostly the first one.", nug: "Jalalabad: no anchor, no par score, no fear - they attack every ball of all fifty overs. Terrifying and brittle at once: dots build pressure like nowhere else, and pressure here becomes three wickets in an over.", mult: 1.12 },
        { boss: 1, mx: 42, my: 72, nm: "The Mountain Storm", city: "Kandahar", capt: "younggun",
  ...
  var FO_CITY = {
    "Leeds": {
      ...
      history: "Tyke County have won seven pennants and mention none of them - bragging is for southerners. The club was founded by mill foremen who wanted somewhere to disagree on Sundays, and the constitution still bans “unnecessary flair.”",
    ...
    "Canterbury": {
      ...
      history: "The Southern Shires have played on the Precincts since before overs had numbers. The honours board lists captains back two centuries; the tea ladies, they will tell you, go back further and matter more.",
    ...
    "London": {
      ...
      history: "The Old Guard's pavilion predates the postal district. Sir Giles Pemberley has captained here for twenty years, and a young Reggie Thorne learned his arithmetic in this very long room. When you earn the World Final, it is played on this square.",
      phil: "Bat time, then bat more time. The Old Guard treat risk as a character flaw and the follow-on as a moral position. Strand the captain, starve the other end, and the rest remember they are mortal.",
  ...
  var FO_CT_FOLK = {
    ...
    "Dublin": { who: "Deco Byrne", role: "pulls pints across the road from the ground", say: "A grand soft day means the ball swings sideways and the Gaels bowl maidens till you weep. Sure, you'll learn." },
    "Belfast": { who: "Maureen Craig", role: "keeps the Corsairs' tide-and-squall log", say: "Forecast says four squalls before tea. The Corsairs bat through all of them. Question is - do you?" },
    "Cork": { who: "Old Fintan", role: "the Emerald XI's scorer, fifty years in pencil", say: "I've a thousand collapses in this book, mostly visitors'. The Rebels save their best for when it's hopeless. That's when they're happiest." },
    "Amsterdam": { who: "Joos van der Meer", role: "fixes bicycles, and the Windmillers' kit bags", say: "Eleven batsmen, eleven bowlers, one bicycle each. Efficiency, my friend. You will be out-thought before you are out-played." },
    ...
    "Utrecht": { who: "Professor Aldert Vink", role: "plays chess by the canal, never loses", say: "The Method is not a nickname, it is a warning. Every field was set on Tuesday. Improvise - it is the one thing the plan cannot hold." },
    ...
    "Port of Spain": { who: "Miss Cynthia", role: "roti shop on the Savannah's edge", say: "The Titans eat here after every win, and they eat here a lot. Book your table anyway, darling - mine is the best consolation in Trinidad." },
    ...
    "Cape Town": { who: "Nomvula", role: "flies kites on the seafront", say: "When my kites fly flat sideways, the wind is right for the Storm. Their gullies wait like gulls. Feed them nothing." },
    "Durban": { who: "Vusi Dlamini", role: "beachfront lifeguard, bowls in the nets at dawn", say: "Humidity makes the ball talk here all day, and the Fire never tire. Their ironman once bowled nineteen straight in January heat. I counted." },
    "Bulawayo": { who: "Mrs. Ndlovu", role: "runs the railway tuckshop by the ground", say: "The Miners have never surrendered an innings in my lifetime, and my scones run out by noon. Between the two, plan for the scones." },
    "Victoria Falls": { who: "Baraka", role: "river guide on the Zambezi", say: "Some days the Drifters play like the falls - roaring, unstoppable. Other days like the still pools above them. Pray for pool days." },
    ...
    "Perth": { who: "Macca", role: "pours the coldest lemonade east of the Indian Ocean", say: "The Goldfields boys run twos on misfields you haven't made yet. Hydrate, mate. That's not a joke - it's forty in the shade and they know it." },
    ...
    "Melbourne": { who: "Bluey", role: "drives the tram route past the great oval", say: "Ninety thousand seats, and the Sunburnt XI act like every one's watching. Do something they've never seen, mate. That mob hates surprises." },
    "Christchurch": { who: "Ted Brooking", role: "drives the heavy roller for Kauri Coast", say: "Flattest pitch I roll all year, and still their seamers hit the same blade of grass six balls an over. Boring? Ask the scoreboard." },
    "Wellington": { who: "Hemi", role: "skippers the harbour ferry", say: "The gale's a team-mate here. Southern Cross read it like sailors, because half of them are. Bowl into it, never with it. Now you know more than most." },
    "Auckland": { who: "Marama", role: "runs the boat-shed cafe by the ground", say: "The Longwhite XI have won from everywhere - last over, last wicket, doesn't matter. Never let it get close. It always gets close." },
    "Colombo": { who: "Uncle Siri", role: "sells king coconuts outside the gate", say: "Watch the dust when Monsoon bowl. First puff, the ball grips. Second puff, you're stumped. Have a thambili - you'll be back out here soon enough." },
    ...
    "Kandy": { who: "Menaka", role: "sells temple flowers on the lake road", say: "The Sorcerers' spinner learned flight from watching temple kites. The ball hangs, hangs - then it's gone. Sweep before the dip, never after." },
    "Mumbai": { who: "Prakash bhai", role: "cutting chai by the maidan since 1975", say: "A hundred games on one maidan every evening, and the Kings pick the one boy who turns it both ways. Play him off the pitch, not the hand. Chai first." },
    ...
    "Nagpur": { who: "Baba Saheb", role: "grows oranges beside the ground", say: "Dust devils cross my orchard before every Devils match. Ground staff call it luck. It's the pitch drying to powder - by the thirtieth over it turns square." },
    "Karachi": { who: "Majid sahab", role: "street-corner umpire, forty years of tape-ball nights", say: "Every fast bowler in this city learned under my one streetlight. The Express just found the quickest. Back away if you must - everyone does, eventually." },
    "Peshawar": { who: "Gul Khan", role: "pours kahwa in the shadow of the fort", say: "The Chargers sprint in like the ball owes them money - fifty overs, full throttle, nothing held back. Sip slowly. It is the only slow thing you'll get all day." },
    "Lahore": { who: "Ustad Rafiq", role: "stitched match balls for three generations of Lions", say: "The talisman asks for the seam a thumbnail prouder - legal, just. When it starts reversing at the fortieth over, remember my stitching." },
    ...
    "Jalalabad": { who: "Haji Noor", role: "sells pomegranates at long-on", say: "The Highlanders hit first and ask never. Eight an over or glorious ruin - there is no third door. I board my windows on match day, friend." },
    ...
    try {
      ...
      var pins = r.clubs.map(function (c, ci) {
        ...
        return "<button type='button' class='" + cls + "' data-tp='" + ci + "' style='left:" + c.mx + "%;top:" + c.my + "%'>" +
          "<span class='dot'>" + (done ? "&#10003;" : c.boss ? "&#9733;" : "&#9679;") + "</span>" +
      ...
      page.innerHTML =
        ...
        "<div class='fo-tour-hint' id='fo-tour-hint'>Tap a city to meet it</div>" +
  ...
  try {
    ...
    trCss.textContent =
      ...
      ".fo-tour-map{position:absolute;left:50%;top:52%;transform:translate(-50%,-50%);width:min(100vw,calc(100vh - 250px));aspect-ratio:1/1}" +
      ".fo-tour-map>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;border-radius:12px;box-shadow:0 22px 70px rgba(0,0,0,.6)}" +
      "html body #page .fo-tp,html body.ftpskin #page .fo-tp{position:absolute;transform:translate(-50%,-50%);background:none !important;border:none !important;box-shadow:none !important;cursor:pointer;z-index:4;display:flex;flex-direction:column;align-items:center;gap:3px;padding:6px}" +
      ".fo-tp .dot{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;color:#fff;background:rgba(20,33,61,.85);border:2px solid rgba(255,255,255,.7);box-shadow:0 3px 10px rgba(0,0,0,.4)}" +
      ".fo-tp.done .dot{background:#2E7A3C;border-color:#CFEAD2}" +
      ...
      "@media(max-width:640px){.fo-tour{height:calc(100vh - 130px);min-height:480px}.fo-tour-map{top:50%}.fo-tour-card{bottom:8px}.tc-art{height:96px}.tc-bd{padding:10px 13px 12px}}";
