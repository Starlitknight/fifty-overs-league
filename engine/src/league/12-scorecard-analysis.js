  ...
  function foRenderSide() {
    try {
      ...
      var bgart = FO_ART + "circuit/" + (r.bg || (r.id + ".webp"));
      var pct = Math.max(18, Math.min(94, Math.round((side.pts / 28) * 100)));
      var monogram = foJCrest(ac, 150, foJInitials(side.city + " CC"));
      ...
      page.innerHTML =
        ...
        "<div class='fo-boss-bgart' style='background-image:url(" + bgart + ")'></div>" +
        "<div class='fo-boss-scrim'></div>" +
        "<div class='fo-boss-in'>" +
        "<div class='fo-boss-nav'>" +
        ...
        "</div>" +
        "<header class='fo-boss-hero'>" +
        "<div class='fo-boss-portrait fo-side-mono'>" + monogram + "</div>" +
        "<div class='fo-boss-id'>" +
  ...
  try {
    ...
    siCss.textContent = [
      ".fo-side-mono{display:flex;align-items:center;justify-content:center;background:radial-gradient(120% 120% at 50% 20%,rgba(255,255,255,.06),rgba(8,13,24,.9))}",
      ".fo-side-mono svg{width:66%;height:66%;filter:drop-shadow(0 10px 22px rgba(0,0,0,.5))}",
  ...
  function foLgTable(L, res) {
    var T = L.map(function (x) { return { name: x.name, isMe: x.isMe, boss: x.boss, city: x.city, wid: x.wid, P: 0, W: 0, L: 0, T: 0, pts: 0, rf: 0, ra: 0 }; });
  ...
  function foRenderLeague() {
    try {
      ...
      page.innerHTML =
        ...
        "<div class='fo-lg-tablewrap'><div class='fo-lg-thead'><span class='rk'>#</span><span class='nm'>Club</span><span class='c'>P</span><span class='c'>W</span><span class='c'>L</span><span class='c'>NRR</span><span class='c'>Pts</span></div>" +
  ...
  try {
    ...
    lgCss.textContent = [
      ...
      ".fo-lg-thead,.fo-lg-row{display:grid;grid-template-columns:30px 1fr 30px 30px 30px 58px 40px;gap:6px;align-items:center;padding:9px 14px}",
