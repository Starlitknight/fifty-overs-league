  ...
  function foRenderLeague() {
    try {
      ...
      var sig = "lg|" + nation + "|" + own + "|" + (own ? (round + "|" + Object.keys(s.res || {}).length + "|" + meNm) : "ro");
      ...
      try {
        ...
        // country navigator: pick a nation from the dropdown and jump straight to its league
        var selNat = page.querySelector(".fo-ov-selnat");
        if (selNat) selNat.addEventListener("change", function () { var v = selNat.value; if (v && v !== nation) { location.hash = "#/league?n=" + encodeURIComponent(v); if (typeof window.route === "function") window.route(); } });
  ...
  try { window.foRenderLeague = foRenderLeague; window.foRenderCup = foRenderCup; } catch (eLgW) {}
  ...
  try {
    ...
    lgCss.textContent = [
      ...
      "#page .fo-ov .fo-ov-subnav .fo-ov-tabs{gap:2px}",
      "html body #page .fo-ov .fo-ov-subnav .fo-ov-tabs button{font-size:11px;letter-spacing:1.4px;padding:6px 8px}",
