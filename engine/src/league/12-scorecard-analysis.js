  ...
  function foRenderCity() {
    try {
      ...
      railEl.innerHTML = chBtn +
        ...
        "<a class='fo-ct-back' href='#/tour?r=" + encodeURIComponent(Lc.r.id) + "'>&#8592; Tour " + E(Lc.r.nm) + "</a>" +
  ...
  try {
    ...
    ctCss.textContent =
      ...
      ".fo-ct-doss{color:#101B2D;background:rgba(235,194,113,.92);border-color:rgba(235,194,113,.92)}" +
