  ...
  function foRenderLeague() {
    try {
      ...
      page.innerHTML =
        ...
        "<div class='fo-lg-cnav'><a href='#/home'>&#8962; Club</a><a href='#/world'>&#127760; World</a>" + (own ? "<a href='#/cup'>&#9818; Cup</a>" : "<a href='#/league'>Your league</a>") + "</div>" +
        "<a class='fo-lg-cflag' href='#/world' title='World map'>" + flag + "</a>" +
        "<div class='fo-lg-ctitle'>" +
        "<div class='eb'>" + (own ? "Your Domestic League &middot; Season " + (s.season || 1) : "The Grand Tour &middot; Rival League") + "</div>" +
        "<h1>" + E(region.nm) + "</h1>" +
