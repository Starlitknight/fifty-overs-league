  ...
  function foHgHero(st, cur) {
    ...
    var nextCard = "", gq = "";
    if (champ) {
      nextCard = "<div class='hg-next hg-champ'><i>THE CIRCUIT &middot; COMPLETE</i>" +
        "<img src='" + FO_ART + "circuit/trophy-crown.webp' alt='' class='hg-crn'>" +
      ...
      if (nx >= 0) {
        ...
        nextCard = "<div class='hg-next'><i>NEXT ON THE CIRCUIT</i><em>" + (curR.final ? "THE WORLD FINAL" : E(curR.nm).toUpperCase()) + "</em>" +
          "<b>" + E(c9.nm) + "</b>" +
