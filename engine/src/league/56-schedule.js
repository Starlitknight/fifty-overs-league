...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-sch-nx i{display:block;font-style:normal;font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#B44A22}",
      "html body #page .fo-sch-nx b{display:block;font:600 15px/1.2 Manrope,sans-serif;margin-top:6px;color:#1B2432}",
      "html body #page .fo-sch-cd{flex:0 0 auto;white-space:nowrap;font:600 15px/1 Manrope,sans-serif;font-variant-numeric:tabular-nums;color:rgba(20,28,40,.55)}",
      ...
      "html body #page .fo-sch-tr span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.34)}",
      // ---- the legend: a colour and a word ---------------------------------
      "html body #page .fo-sch-lg{display:flex;flex-wrap:wrap;gap:5px 14px;padding:12px 2px 0}",
      "html body #page .fo-sch-lg span{display:inline-flex;align-items:center;gap:6px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.34)}",
      ...
      "html body #page .fo-sch-wk b{font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.34)}",
      ...
      "html body #page .fo-sch-row .dt{flex:0 0 50px;font:700 11px/1.25 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#4A4438}",
      ...
      ".fo-sch-tz{font:700 11px/1.2 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#6A6354;text-align:right;margin:6px 0 10px}",
      "html body #page .fo-sch-row .dt u{display:block;margin-top:3px;font:500 12px/1 Manrope,sans-serif;letter-spacing:0;text-transform:none;color:#6A6354;text-decoration:none;font-variant-numeric:tabular-nums}",
      "html body #page .fo-sch-rest .dt{flex:0 0 auto;font:500 12px/1 Manrope,sans-serif;letter-spacing:0;text-transform:none;color:#6A6354}",
      "html body #page .fo-sch-rest .rw{font:500 12px/1 Manrope,sans-serif;color:rgba(20,28,40,.26);white-space:nowrap}",
      "html body #page .fo-sch-you{display:flex;align-items:center;gap:7px;margin-top:5px;font:500 13px/1.2 Manrope,sans-serif;color:rgba(20,28,40,.55)}",
      "html body #page .fo-sch-you i{font-style:normal;font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.34);background:rgba(20,28,40,.05);border-radius:4px;padding:4px 6px 3px}",
      "html body #page .fo-sch-you u{text-decoration:none;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;border-radius:4px;padding:4px 7px 3px;color:#FFFEFC}",
      ...
      "html body #page .fo-sch-wk .wc{font:500 12px/1 Manrope,sans-serif;color:rgba(20,28,40,.28);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-sch-row .dn{flex:0 0 26px;font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.34);font-variant-numeric:tabular-nums}",
      "html body #page .fo-sch-row .ev{flex:1;min-width:0;font:600 13.5px/1.25 Manrope,sans-serif;color:#1B2432}",
      "html body #page .fo-sch-row .hr{font:500 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.34);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-sch-rest .dn{flex:0 0 26px;font:500 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.34);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-sch-fine{margin:16px 2px 0;font:400 13px/1.6 Manrope,sans-serif;color:rgba(20,28,40,.34)}",
  ...
  // EVERY LEAGUE FIXTURE STILL AHEAD, from the same draw - the ground page's
  // gate board walks these looking for home Sundays to sell
  window.foMyLeagueFixtures = function (maxN) {
    var out = [];
    try {
      var pl = planet(); if (!pl || !pl.phaseOf) return out;
      var here = pl.phaseOf(Date.now()); if (!here) return out;
      var season = here.season || 1, today = here.di | 0;
      var seat = mySeat(pl); if (!seat) return out;
      var now = Date.now(), cap = maxN || 20;
      var hour = 14; try { hour = pl.natHour(seat.rid); } catch (eH) {}
      for (var s2 = season; s2 <= season + 1 && out.length < cap; s2++) {
        for (var di = (s2 === season ? Math.max(0, today) : 0); di < 42 && out.length < cap; di++) {
          ...
          out.push({ season: s2, round: p.round, home: !!fx.home, t0: t0,
