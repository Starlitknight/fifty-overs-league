...
(function () {
  ...
  function foRenderPlanetPage() {
    try {
      ...
      page.innerHTML =
        ...
        "<p>" + E(phaseLine) + ". Every league runs on the world calendar, live from 10:00 UTC.</p>" +
  ...
  var CSS = [
    "html body #page .fo-pl{max-width:680px;margin:26px auto 44px;padding:0 14px;color:#1B2432}",
    ...
    "html body #page .fo-pl-kick{font-family:Manrope,sans-serif;font-size:10.5px;letter-spacing:.24em;text-transform:uppercase;color:#B44A22}",
    "html body #page .fo-pl-kick:after{content:'';display:block;width:34px;border-top:2px solid #C9571F;margin-top:7px}",
    "html body #page .fo-pl-mast h1{font-family:Fraunces,Georgia,serif;font-weight:600;font-size:36px;letter-spacing:-.015em;margin:8px 0 8px;color:#1B2432;line-height:1.02}",
    "html body #page .fo-pl-mast p{font:420 13.5px/1.6 Fraunces,Georgia,serif;color:rgba(20,28,40,.6);margin:0 0 12px;max-width:52ch}",
    "html body #page .fo-pl-chip{display:inline-block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;border-radius:999px;padding:7px 13px}",
    ...
    "html body #page .fo-pl-livebtn{flex:none;display:inline-flex;align-items:center;gap:6px;font:800 11px/1 Manrope,sans-serif;letter-spacing:.14em;color:#FFFEFC;background:#C83C3A;border-radius:999px;padding:9px 14px;box-shadow:0 6px 16px rgba(200,60,58,.35)}",
    ...
    "html body #page .fo-pl-band>i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal;margin-bottom:9px}",
    ...
    "html body #page .fo-pl-tz.me img{border-color:#C9571F}",
    "html body #page .fo-pl-tz i{font:700 11px/1 Manrope,sans-serif;color:rgba(20,28,40,.5);font-style:normal}",
    ...
    "html body #page .fo-pl-own{display:flex;align-items:center;gap:14px;margin-top:16px;background:#07162E;border-radius:18px;padding:16px 18px;text-decoration:none;color:#FFFEFC;box-shadow:0 16px 38px rgba(7,22,46,.35);border-bottom:2px solid #C9571F}",
    ...
    "html body #page .fo-pl-ownt i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
    ...
    "html body #page .fo-pl-ownt em{display:block;font:400 13px/1.4 Fraunces,Georgia,serif;color:rgba(255,254,252,.75);margin-top:3px}",
    ...
    "html body #page .fo-pl-nat{display:flex;align-items:center;gap:12px;background:#FFFEFC;border:1px solid rgba(20,28,40,.09);border-radius:13px;padding:11px 14px;text-decoration:none;color:#1B2432;box-shadow:0 4px 14px rgba(30,38,52,.06);transition:border-color .15s ease}",
    ...
    "html body #page .fo-pl-natt b{display:block;font:600 13px/1.2 Manrope,sans-serif}",
    "html body #page .fo-pl-natt em.fx{display:block;font:400 13px/1.35 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.62);margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    "html body #page .fo-pl-natt em.fx.live b{color:#B23230;font-size:10px;letter-spacing:.1em}",
    "html body #page .fo-pl-natt u{display:block;text-decoration:none;font:400 12px/1 Manrope,sans-serif;color:rgba(20,28,40,.42);margin-top:3px}",
    ...
    "html body #page .fo-pl-cuph i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    "html body #page .fo-pl-cuph .in{display:block;font:420 12.5px/1.5 Fraunces,Georgia,serif;color:rgba(20,28,40,.65);margin-top:5px}",
    "html body #page .fo-pl-crown{font-family:Fraunces,Georgia,serif;font-size:16px;margin:10px 0 2px;color:#1B2432}",
    ...
    "html body #page .fo-pl-stage.dim span{font:400 13px/1 Manrope,sans-serif}",
    "html body #page .fo-pl-stage>i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;margin-bottom:6px}",
    "html body #page .fo-pl-stage>i b.lv{color:#B23230}",
    "html body #page .fo-pl-cm{display:flex;align-items:center;gap:7px;flex-wrap:wrap;font:500 12.5px/1.3 Manrope,sans-serif;padding:6px 0;border-top:1px solid rgba(20,28,40,.06);color:#1B2432;text-decoration:none}",
    ...
    "html body #page .fo-pl-cm em{flex-basis:100%;font:400 12px/1.3 Manrope,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
    ...
    "html body #page .fo-pl-wire>i{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#B44A22;font-style:normal;margin-bottom:8px}",
    "html body #page .fo-pl-wireln{font:420 12.5px/1.55 Fraunces,Georgia,serif;color:rgba(20,28,40,.72);padding:4px 0;border-top:1px solid rgba(20,28,40,.05)}",
    "html body #page .fo-pl-foot{display:flex;gap:10px;justify-content:space-between;margin-top:18px;flex-wrap:wrap}",
    "html body #page .fo-pl-foot a{display:inline-flex;align-items:center;min-height:44px;font:600 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:0 17px;text-decoration:none}",
