...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-pl-chip{display:inline-block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;border-radius:999px;padding:7px 13px}",
    ...
    "html body #page .fo-pl-band>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,28,40,.45);font-style:normal;margin-bottom:9px}",
    ...
    "html body #page .fo-pl-tz i{font:700 11px/1 Oswald,sans-serif;color:rgba(20,28,40,.5);font-style:normal}",
    ...
    "html body #page .fo-pl-ownt i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
    ...
    "html body #page .fo-pl-natt b{display:block;font:600 13px/1.2 Oswald,sans-serif}",
    "html body #page .fo-pl-natt em.fx{display:block;font:400 13px/1.35 Oswald,sans-serif;font-style:normal;color:rgba(20,28,40,.62);margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    "html body #page .fo-pl-natt em.fx.live b{color:#B23230;font-size:10px;letter-spacing:.1em}",
    "html body #page .fo-pl-natt u{display:block;text-decoration:none;font:400 12px/1 Oswald,sans-serif;color:rgba(20,28,40,.42);margin-top:3px}",
    ...
    "html body #page .fo-pl-cuph i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#B44A22;font-style:normal}",
    ...
    "html body #page .fo-pl-stage.dim span{font:400 13px/1 Oswald,sans-serif}",
    "html body #page .fo-pl-stage>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.5);font-style:normal;margin-bottom:6px}",
    "html body #page .fo-pl-stage>i b.lv{color:#B23230}",
    "html body #page .fo-pl-cm{display:flex;align-items:center;gap:7px;flex-wrap:wrap;font:500 12.5px/1.3 Oswald,sans-serif;padding:6px 0;border-top:1px solid rgba(20,28,40,.06);color:#1B2432;text-decoration:none}",
    ...
    "html body #page .fo-pl-cm em{flex-basis:100%;font:400 12px/1.3 Oswald,sans-serif;font-style:normal;color:rgba(20,28,40,.55)}",
    ...
    "html body #page .fo-pl-wire>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#B44A22;font-style:normal;margin-bottom:8px}",
    ...
    "html body #page .fo-pl-foot a{display:inline-flex;align-items:center;min-height:44px;font:600 13px/1 Oswald,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:0 17px;text-decoration:none}",
