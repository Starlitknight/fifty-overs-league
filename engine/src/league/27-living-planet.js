  ...
  function foRenderPlanetPage() {
    try {
      ...
      page.innerHTML =
        ...
        "<div class='fo-pl-foot'><a href='#/world'>The world map &rsaquo;</a><a href='#/league'>My league &rsaquo;</a><a href='#/almanack'>The world almanack &rsaquo;</a><a href='#/atlas'>The atlas &rsaquo;</a></div>" +
        "</div>";
