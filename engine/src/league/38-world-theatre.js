...
(function () {
  ...
  function foWtCss() {
    ...
    s.textContent = [
      ...
      ".fo-wt-back{font:600 13px/1 Oswald,sans-serif;color:#3a4353 !important;text-decoration:none !important;border:1px solid rgba(14,35,63,.22);border-radius:999px;padding:7px 13px;background:#fff}",
      ".fo-wt-flag{width:26px;height:18px;object-fit:cover;border-radius:3px;box-shadow:0 1px 3px rgba(14,35,63,.25)}",
      ".fo-wt-league{font:700 11px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#14243A}",
      ".fo-wt-live{margin-left:auto;display:inline-flex;align-items:center;gap:6px;font:800 11px/1 Oswald,sans-serif;letter-spacing:.14em;color:#B23230}",
      ...
      ".fo-wt-soon,.fo-wt-fin{margin-left:auto;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;color:rgba(20,32,47,.55)}",
      ".fo-wt-stage{padding:16px 0 4px}",
      ".fo-wt-ground{font:600 13px/1.4 Oswald,sans-serif;color:rgba(20,32,47,.55);margin-bottom:7px}",
      ...
      ".fo-wt-crease{display:flex;justify-content:space-between;gap:10px;margin-top:10px;font:400 13px/1.5 Oswald,sans-serif;color:rgba(255,254,252,.85);flex-wrap:wrap}",
      ...
      ".fo-wt-teamsin .ld{font:400 13px/1.4 Oswald,sans-serif;color:rgba(255,254,252,.65)}",
      ...
      ".fo-wt-teamsin .c u{display:block;text-decoration:none;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#E8B96A;margin-bottom:6px}",
      ".fo-wt-teamsin .c span{display:flex;align-items:baseline;gap:6px;font:400 13px/1.55 Oswald,sans-serif;color:rgba(255,254,252,.85)}",
      ".fo-wt-teamsin .c span i{font-style:normal;font:700 11px/1 Oswald,sans-serif;color:rgba(255,254,252,.4);width:12px;text-align:right}",
      ...
      ".fo-wt-rail>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:rgba(20,32,47,.5);font-style:normal;margin-bottom:8px}",
      ...
      ".fo-wt-other b{font:600 12.5px/1.35 Oswald,sans-serif}",
      ".fo-wt-other span{font:400 13px/1.3 Oswald,sans-serif;color:rgba(20,32,47,.5);white-space:nowrap}",
      ...
      ".fo-wt-natsw>i{display:block;font:700 11px/1 Oswald,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:rgba(20,32,47,.5);font-style:normal;margin-bottom:8px}",
      ...
      ".fo-wt-nat i{font:700 11px/1 Oswald,sans-serif;color:rgba(20,32,47,.55);font-style:normal;letter-spacing:.04em}",
