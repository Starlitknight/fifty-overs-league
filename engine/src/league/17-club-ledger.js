...
(function () {
  ...
  function foLedCss() {
    ...
    s.textContent = [
      ...
      ".fo-led-hero{background:linear-gradient(135deg,#0E233F,#07162E 70%);border-radius:14px;padding:18px 20px;box-shadow:0 12px 32px rgba(7,22,46,.28);margin-bottom:18px}",
      ".fo-led-tag{font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.26em;text-transform:uppercase;color:#EBC271;margin-bottom:12px}",
      ".fo-led-stats{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:14px}",
      ".fo-led-stat span{display:block;font-family:Oswald,sans-serif;font-size:9px;letter-spacing:.2em;text-transform:uppercase;color:#7d8fad}",
      ".fo-led-stat b{display:block;font-size:20px;color:#f2f6ff;font-variant-numeric:tabular-nums;margin:2px 0 1px}",
      ".fo-led-stat em{font-style:normal;font-size:11px;color:#93a5c2}",
