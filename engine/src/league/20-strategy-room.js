...
(function () {
  ...
  var GRADE_C = { A: "#35C28F", B: "#9BCE58", C: "#E5C24A", D: "#F09A4C", E: "#EF6461" };
  ...
  // ---- sheet -----------------------------------------------------------------
  var CSS = [
    "html body #page .fo-sd{max-width:880px;margin:26px auto 44px;padding:0 14px;color:#E9EEF6}",
    "html body #page .fo-sd-hero{background:linear-gradient(150deg,#0D1626,#13253f 70%,#173350);border:1px solid rgba(255,255,255,.08);border-radius:22px;padding:28px 30px 24px;box-shadow:0 24px 60px rgba(7,16,32,.35)}",
    "html body #page .fo-sd-kick,html body #page .fo-sd-k{font-family:Oswald,sans-serif;font-size:10.5px;letter-spacing:.22em;text-transform:uppercase;color:rgba(233,238,246,.55)}",
    "html body #page .fo-sd-hero h1{font-family:Oswald,sans-serif;font-weight:600;font-size:36px;letter-spacing:.03em;text-transform:uppercase;margin:6px 0 8px;color:#fff}",
    "html body #page .fo-sd-hero p{font:italic 400 13.5px/1.55 Georgia,serif;color:rgba(233,238,246,.72);margin:0;max-width:60ch}",
    "html body #page .fo-sd-tale{display:flex;gap:14px;align-items:baseline;margin-top:14px;font:600 12.5px/1 Inter,sans-serif;color:#fff;flex-wrap:wrap}",
    "html body #page .fo-sd-tale b{color:rgba(233,238,246,.4);font-weight:400}",
    "html body #page .fo-sd-tale span{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.09);border-radius:999px;padding:8px 14px}",
    "html body #page .fo-sd-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:14px}",
    "html body #page .fo-sd-card{background:rgba(13,22,38,.92);border:1px solid rgba(255,255,255,.07);border-radius:18px;padding:18px 20px}",
    "html body #page .fo-sd-wide{grid-column:1/-1}",
    "html body #page .fo-sd-k{margin-bottom:12px}",
    "html body #page .fo-sd-formrow{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:7px 0;border-bottom:1px solid rgba(255,255,255,.05);font:600 13px/1 Inter,sans-serif}",
    ...
    "html body #page .fo-sd-bead.w{background:rgba(53,194,143,.18);color:#66E2B2;border:1px solid rgba(53,194,143,.4)}",
    "html body #page .fo-sd-bead.l{background:rgba(239,100,97,.14);color:#F49290;border:1px solid rgba(239,100,97,.35)}",
    "html body #page .fo-sd-none,html body #page .fo-sd-none2{font:italic 400 12px/1.4 Georgia,serif;color:rgba(233,238,246,.45)}",
    ...
    "html body #page .fo-sd-h2h a{font:italic 400 12.5px/1.4 Georgia,serif;color:rgba(233,238,246,.65);text-decoration:none}",
    "html body #page .fo-sd-h2h a:hover{color:#FF9C78}",
    "html body #page .fo-sd-split{display:flex;align-items:center;gap:10px;margin:8px 0;font:600 12px/1 Inter,sans-serif;color:rgba(233,238,246,.8)}",
    "html body #page .fo-sd-split>span{width:56px;flex:none}",
    "html body #page .fo-sd-m{flex:1;height:7px;border-radius:6px;background:rgba(255,255,255,.08);overflow:hidden;display:block}",
    "html body #page .fo-sd-m u{display:block;height:100%;border-radius:6px;background:linear-gradient(90deg,#3E6DB2,#7FB4E8)}",
    "html body #page .fo-sd-g{flex:none;width:24px;height:24px;border-radius:8px;border:1px solid;display:inline-flex;align-items:center;justify-content:center;font:800 12px/1 Inter,sans-serif;font-style:normal;background:rgba(255,255,255,.04)}",
    ...
    "html body #page .fo-sd-mixlbl{display:flex;justify-content:space-between;font:600 10.5px/1 Inter,sans-serif;color:rgba(233,238,246,.6);margin-top:5px;letter-spacing:.04em;text-transform:uppercase}",
    "html body #page .fo-sd-men{margin-top:12px;display:flex;flex-direction:column;gap:7px}",
    "html body #page .fo-sd-man{display:flex;justify-content:space-between;gap:10px;align-items:baseline;border-bottom:1px solid rgba(255,255,255,.05);padding-bottom:6px}",
    "html body #page .fo-sd-man b{font:600 13px/1.3 Inter,sans-serif;color:#fff}",
    "html body #page .fo-sd-man span{font:400 11.5px/1.3 Inter,sans-serif;color:rgba(233,238,246,.55);font-variant-numeric:tabular-nums;white-space:nowrap}",
    "html body #page .fo-sd-cond b{font:600 14px/1.3 Inter,sans-serif;display:block;color:#fff}",
    "html body #page .fo-sd-cond span{font:600 11px/1.6 Inter,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#FFB58F}",
    "html body #page .fo-sd-say{font:italic 400 13px/1.55 Georgia,serif;color:rgba(233,238,246,.7);margin:9px 0 0}",
    "html body #page .fo-sd-toss{font:400 12.5px/1.5 Inter,sans-serif;color:rgba(233,238,246,.75);margin:10px 0 0}",
    "html body #page .fo-sd-recs{margin:0;padding-left:19px;display:flex;flex-direction:column;gap:9px;font:400 13.5px/1.55 Inter,sans-serif;color:rgba(233,238,246,.85)}",
    "html body #page .fo-sd-recs b{color:#fff}",
    "html body #page .fo-sd-docs{display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:9px;margin-top:12px}",
    "html body #page button.fo-sd-doc{text-align:left;background:rgba(255,255,255,.04) !important;border:1px solid rgba(255,255,255,.1) !important;border-radius:13px !important;padding:11px 13px !important;cursor:pointer;color:#E9EEF6 !important;transition:border-color .15s ease}",
    "html body #page button.fo-sd-doc b{display:block;font:700 12.5px/1 Inter,sans-serif;letter-spacing:.02em;color:#fff}",
    "html body #page button.fo-sd-doc span{display:block;font:italic 400 11px/1.4 Georgia,serif;color:rgba(233,238,246,.55);margin-top:4px}",
    "html body #page button.fo-sd-doc:hover{border-color:rgba(255,122,80,.5) !important}",
    "html body #page button.fo-sd-doc.on{border-color:#FF7A50 !important;background:rgba(255,122,80,.12) !important;box-shadow:0 0 0 1px rgba(255,122,80,.35)}",
    "html body #page .fo-sd-foot{display:flex;gap:10px;justify-content:space-between;margin-top:16px;flex-wrap:wrap}",
    "html body #page .fo-sd-foot a{font:600 12px/1 Inter,sans-serif;color:rgba(233,238,246,.65);background:rgba(13,22,38,.85);border:1px solid rgba(255,255,255,.1);border-radius:999px;padding:9px 16px;text-decoration:none}",
    "html body #page .fo-sd-foot a:hover{color:#fff;border-color:rgba(255,122,80,.5);text-decoration:none}",
