...
(function () {
  ...
  function foLsCss() {
    ...
    s.textContent = [
      ...
      ".fo-ls-card .fo-card-h2{font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.18em;color:#E8B96A}",
      ...
      ".fo-ls-k{font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.14em;color:#7d8fad}.fo-ls-k b{color:#E8B96A}",
      ...
      ".fo-ls-h2h b{font-family:Oswald,sans-serif;font-size:26px;color:#E8B96A}.fo-ls-h2h span{font-size:10px;text-transform:uppercase;letter-spacing:.12em;color:#7d8fad}.fo-ls-h2h i{color:#42536e;font-style:normal}",
      ...
      ".fo-tele-sub{font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.24em;color:#93835c;padding:7px 16px 0}",
      ...
      ".fo-let-head b{display:block;font-family:Oswald,sans-serif;font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:.26em;color:#93835c;margin-top:3px;padding-bottom:8px;border-bottom:1px solid rgba(36,29,14,.3)}",
      ...
      ".fo-tick-stub{border-top:1px dashed rgba(176,132,9,.45);margin:0 10px;padding:8px 6px 10px;text-align:center;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.3em;text-transform:uppercase;color:#8A8060}",
      "html body.ftpskin .fo-ls-btn,html body .fo-ls-btn{display:inline-flex;align-items:center;min-height:44px;margin-top:8px;border:0 !important;border-radius:999px !important;padding:0 19px !important;background:#C9571F !important;color:#FFFEFC !important;font:600 11px Oswald,sans-serif !important;text-transform:uppercase;letter-spacing:.14em;cursor:pointer;text-decoration:none}",
      ...
      ".fo-ls-career h4{margin:0;padding:12px 16px 0;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.18em;color:#E8B96A;background:transparent;border:0}",
      ...
      ".fo-ls-ck span{display:block;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.13em;color:#7d8fad}",
      ...
      ".fo-ls-mh{display:block;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.14em;color:#7d8fad;margin-bottom:6px}",
      ...
      ".fo-cer-eyebrow{font-family:Oswald,sans-serif;font-size:11px;text-transform:uppercase;letter-spacing:.3em;color:#E8B96A;margin-bottom:10px}",
      ...
      ".fo-cer-step b{display:block;font-family:Oswald,sans-serif;font-size:22px;color:#E8B96A}",
      ...
      ".fo-cer-aw span{display:block;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.16em;color:#E8B96A}",
      ...
      ".fo-cer-def span{display:block;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.16em;color:#e8a08a;margin-bottom:4px}",
      ...
      ".fo-cer-goals>span{display:block;font-family:Oswald,sans-serif;font-size:10px;text-transform:uppercase;letter-spacing:.16em;color:#E8B96A;margin-bottom:9px}",
