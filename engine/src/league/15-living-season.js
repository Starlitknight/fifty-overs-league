...
(function () {
  ...
  function foLsCss() {
    ...
    s.textContent = [
      ...
      ".fo-cer-aw span{display:block;font-family:Oswald,sans-serif;font-size:9.5px;text-transform:uppercase;letter-spacing:.16em;color:#E8B96A}",
      ...
      ".fo-cer-goals>span{display:block;font-family:Oswald,sans-serif;font-size:9.5px;text-transform:uppercase;letter-spacing:.16em;color:#E8B96A;margin-bottom:9px}",
