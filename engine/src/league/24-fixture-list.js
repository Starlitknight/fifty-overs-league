...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-fl-stat{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.14);border-radius:12px;padding:8px 13px 7px;font:600 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(244,239,228,.62)}",
    ...
    "html body #page .fo-fl-next .nvs u{text-decoration:none;display:inline-block;vertical-align:3px;font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14202F;background:rgba(20,28,40,.08);border:1px solid rgba(20,28,40,.16);border-radius:6px;padding:4px 7px;margin-left:6px}",
    ...
    "html body #page .fo-fl-dt b{font:700 10px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    ...
    "html body #page .fo-fl-cmp{display:inline-flex;align-items:center;justify-content:center;font:700 10px/1 Oswald,sans-serif;letter-spacing:.08em;border-radius:7px;padding:5px 0;text-transform:uppercase}",
