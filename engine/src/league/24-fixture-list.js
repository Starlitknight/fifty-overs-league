...
(function () {
  ...
  var CSS = [
    ...
    "html body #page .fo-fl-stat{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.14);border-radius:12px;padding:8px 13px 7px;font:600 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(244,239,228,.62)}",
    "html body #page .fo-fl-stat b{display:block;font:700 17px/1 Oswald,sans-serif;letter-spacing:0;color:#FFFEFC;font-variant-numeric:tabular-nums;margin-bottom:4px}",
    ...
    "html body #page .fo-fl-form i{width:23px;height:23px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font:800 12px/1 Oswald,sans-serif;font-style:normal;color:#FFFEFC}",
    ...
    "html body #page .fo-fl-next .nvs u{text-decoration:none;display:inline-block;vertical-align:3px;font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14202F;background:rgba(20,28,40,.08);border:1px solid rgba(20,28,40,.16);border-radius:6px;padding:4px 7px;margin-left:6px}",
    "html body #page .fo-fl-next .nw{display:block;font:400 13px/1.4 Oswald,sans-serif;color:rgba(20,28,40,.55)}",
    "html body #page .fo-fl-next .ncta{margin-left:auto;background:#C9571F;color:#FFFEFC;border-radius:999px;padding:10px 16px;font:700 13px/1 Oswald,sans-serif;white-space:nowrap}",
    ...
    "html body #page .fo-fl-dt b{font:700 11px/1 Oswald,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
    "html body #page .fo-fl-dt i{font:600 13px/1 Oswald,sans-serif;font-style:normal;color:rgba(20,28,40,.72);font-variant-numeric:tabular-nums;white-space:nowrap}",
    "html body #page .fo-fl-dt b.one{font-size:10px;color:#B44A22;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    "html body #page .fo-fl-cmp{display:inline-flex;align-items:center;justify-content:center;font:700 11px/1 Oswald,sans-serif;letter-spacing:.08em;border-radius:7px;padding:5px 0;text-transform:uppercase}",
    ...
    "html body #page .fo-fl-row u{width:24px;height:24px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;font:800 13px/1 Oswald,sans-serif;text-decoration:none}",
    ...
    "html body #page .fo-fl-set{font:700 12px/1.3 Oswald,sans-serif;color:#177A57;text-align:right;white-space:nowrap}",
    "html body #page .fo-fl-who{min-width:0}",
    "html body #page .fo-fl-who b{display:block;font:600 13.5px/1.25 Oswald,sans-serif;color:#1B2432;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    "html body #page .fo-fl-who>span{display:block;font:400 13px/1.35 Oswald,sans-serif;color:rgba(20,28,40,.5);margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
    ...
    "html body #page .fo-fl-time{font:600 13px/1 Oswald,sans-serif;font-style:normal;color:rgba(20,28,40,.62);font-variant-numeric:tabular-nums;white-space:nowrap;text-align:right}",
    ...
    "html body #page .fo-fl-foot a{font:600 13px/1 Oswald,sans-serif;color:rgba(20,28,40,.65);background:#FFFEFC;border:1px solid rgba(20,28,40,.12);border-radius:999px;padding:9px 16px;text-decoration:none}",
