...
(function () {
  ...
  function foNsCss() {
    ...
    s.textContent = [
      "html body.ftpskin.fo-nets-on,html body.fo-nets-on{background:#0a0d08 !important;isolation:isolate}",
      ...
      "html body.fo-nets-on #page{padding:0 !important;margin:0 !important;background:#0a0d08 !important}",
      ".fo-ns{position:relative;min-height:100vh;color:#e7eefb;padding:72px 18px 40px;isolation:isolate}",
      ".fo-ns-bg{position:fixed;inset:0;width:100%;height:100%;object-fit:cover;object-position:50% 45%;z-index:-2}",
      ".fo-ns-veil{position:fixed;inset:0;z-index:-1;background:linear-gradient(180deg,rgba(7,10,6,.78),rgba(8,11,7,.5) 32%,rgba(7,10,6,.62) 66%,rgba(5,7,4,.86))}",
      ".fo-ns-in{max-width:1120px;margin:0 auto}",
      ".fo-ns-h1{font-family:Oswald,sans-serif;font-weight:700;text-transform:uppercase;font-size:clamp(40px,6.4vw,72px);line-height:.9;margin:0 0 8px;color:#fff;text-shadow:0 4px 26px rgba(0,0,0,.75)}",
      ".fo-ns-tag{font-family:Georgia,serif;font-style:italic;font-size:14.5px;color:#cfd8be;margin:0 0 22px;max-width:60ch;text-shadow:0 2px 10px rgba(0,0,0,.7)}",
      ...
      ".fo-ns-panel{background:rgba(10,15,10,.78);border:1px solid rgba(158,188,140,.22);border-radius:14px;padding:15px 17px;backdrop-filter:blur(3px);box-shadow:0 14px 34px rgba(0,0,0,.5)}",
      ".fo-ns-panel h3{margin:0 0 10px;font-family:Oswald,sans-serif;font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:#EBC271;display:flex;justify-content:space-between;align-items:baseline}",
      ".fo-ns-panel h3 span{font-size:9.5px;color:#9eb08a;letter-spacing:.14em}",
      ".fo-ns-note{font-family:Georgia,serif;font-style:italic;font-size:12px;color:#9eb08a;margin:0 0 10px}",
      ".fo-ns-sessgrid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}",
      "html body #page .fo-ns-sess{text-align:left;border:1px solid rgba(158,188,140,.25) !important;border-radius:11px !important;background:rgba(14,20,13,.85) !important;color:#dfe8d2 !important;padding:11px 12px !important;cursor:pointer;transition:.15s;font:inherit !important}",
      "html body #page .fo-ns-sess.on{border-color:#EBC271 !important;background:rgba(46,52,30,.9) !important;box-shadow:0 0 0 1px rgba(235,194,113,.4),0 6px 16px rgba(0,0,0,.4)}",
      ".fo-ns-sess i{font-style:normal;font-size:15px;margin-right:6px}",
      ".fo-ns-sess b{font-family:Oswald,sans-serif;font-size:12.5px;letter-spacing:.06em;text-transform:uppercase;color:#f2f6e9}",
      ".fo-ns-sess b u{text-decoration:none;color:#EBC271}",
      ".fo-ns-sess span{display:block;font-family:Georgia,serif;font-style:italic;font-size:11px;color:#9eb08a;margin-top:3px;line-height:1.4}",
      ".fo-ns-proj{display:flex;gap:8px;align-items:center;margin-bottom:9px;flex-wrap:wrap}",
      ".fo-ns-proj em{font-family:Oswald,sans-serif;font-style:normal;font-size:9.5px;letter-spacing:.18em;text-transform:uppercase;color:#9eb08a;width:70px}",
      "html body #page .fo-ns-proj select{flex:1;min-width:130px;background:rgba(14,20,13,.9) !important;color:#e7eefb !important;border:1px solid rgba(158,188,140,.3) !important;border-radius:8px;padding:8px 9px;font:500 12.5px Inter,sans-serif}",
      "html body #page .fo-ns-coach{display:flex;justify-content:space-between;align-items:baseline;width:100%;text-align:left;border:1px solid rgba(158,188,140,.25) !important;border-radius:10px !important;background:rgba(14,20,13,.85) !important;color:#dfe8d2 !important;padding:10px 12px !important;margin-bottom:8px;cursor:pointer;font:inherit !important;transition:.15s}",
      "html body #page .fo-ns-coach.on{border-color:#5BD0A6 !important;box-shadow:0 0 0 1px rgba(91,208,166,.35)}",
      ".fo-ns-coach b{font-family:Oswald,sans-serif;font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#f2f6e9}",
      ".fo-ns-coach span{font-size:11px;color:#9eb08a}",
      ".fo-ns-coach.on span{color:#5BD0A6}",
      ".fo-ns-line{margin:0 0 7px;font-size:12.5px;color:#cfd8be}.fo-ns-line b{color:#f2f6e9}.fo-ns-line span{color:#8a9b76;font-size:11px}"
    ].join("\n");
