...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-nat-fl span{font:600 11px/1 Manrope,sans-serif;letter-spacing:.05em;color:rgba(20,28,40,.55);text-transform:uppercase}",
      ...
      "html body #page .fo-nat-man{display:flex;align-items:baseline;gap:9px;padding:9px 2px;border-top:1px solid rgba(20,28,40,.07);font:500 13px/1.3 Manrope,sans-serif}",
      ...
      "html body #page .fo-nat-man i{font-style:normal;font:700 11px/1 Manrope,sans-serif;color:rgba(20,28,40,.35);width:16px}",
      "html body #page .fo-nat-man b{font-weight:600;color:#1B2432}",
      ...
      "html body #page .fo-nat-man u{text-decoration:none;font:600 12px/1 Manrope,sans-serif;color:#1F6F4A;background:rgba(31,111,74,.1);padding:5px 9px;border-radius:999px;white-space:nowrap;align-self:center}",
      ...
      "html body #page .fo-nat-tie{display:flex;align-items:center;gap:8px;flex-wrap:wrap;padding:9px 2px;border-top:1px solid rgba(20,28,40,.07);font:500 13px/1.4 Manrope,sans-serif}",
      "html body #page .fo-nat-tie b{font-weight:600;color:#1B2432}",
      ...
      "html body #page .fo-nat-when{margin:2px 0 8px;padding:11px 13px;background:rgba(11,29,58,.05);border:1px solid rgba(11,29,58,.18);border-left:3px solid #0B1D3A;border-radius:12px;font:500 13px/1.55 Manrope,sans-serif;color:rgba(20,28,40,.75)}",
      ...
      "html body #page .fo-nt-hero .kick{font:600 11px/1 Manrope,sans-serif;letter-spacing:.28em;text-transform:uppercase;color:#E8B96A;margin-bottom:10px}",
      "html body #page .fo-nt-hero h2{font:700 clamp(34px,4.5vw,62px)/1 Manrope,sans-serif;text-transform:uppercase;color:#FFFEFC;margin:0;display:flex;align-items:center;gap:clamp(12px,1.4vw,20px);text-shadow:0 2px 10px rgba(0,0,0,.45)}",
      ...
      "html body #page .fo-nt-hero .hf span{font:600 11px/1.5 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.6)}",
      "html body #page .fo-nt-hero .hf b{display:block;font:600 15px/1.3 Manrope,sans-serif;color:#FFFEFC;text-transform:none;letter-spacing:0;white-space:nowrap;text-shadow:0 1px 6px rgba(0,0,0,.5)}",
      // ---- the navy tab band ------------------------------------------------
      ...
      "html body #page .fo-nt-tabs button{flex:none;font:600 12px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#EFE8D8 !important;opacity:.8;padding:16px 2px 13px !important;border:none !important;border-bottom:3px solid transparent !important;border-radius:0 !important;box-shadow:none !important;background:transparent !important;cursor:pointer}",
      ...
      "html body #page .fo-nt-cat{font:600 11px/1 Manrope,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#B44A22;margin-bottom:12px}",
      ...
      "html body #page .fo-nt-dek{font:400 14px/1.65 Manrope,sans-serif;color:rgba(20,28,40,.62);margin:0}",
      "html body #page .fo-nt-when{font:500 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.4);margin-top:16px}",
      ...
      "html body #page .fo-nt-tile h3{font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#8a5219;margin:0 0 14px}",
      ...
      "html body #page .fo-nt-lab{font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.45);margin-top:13px}",
      "html body #page .fo-nt-lab b{display:block;font:700 21px/1.2 Manrope,sans-serif;color:#14243A;margin-top:5px;letter-spacing:0}",
      ...
      "html body #page .fo-nt-mini b{font:600 13px/1.35 Manrope,sans-serif;color:#14243A !important}",
      "html body #page .fo-nt-foot{display:flex;justify-content:space-between;flex-wrap:wrap;gap:6px 14px;margin:26px 0 8px}",
      "html body #page .fo-nt-form{display:flex;gap:7px;margin:2px 0 10px}",
      "html body #page .fo-nt-form i{width:28px;height:28px;border-radius:50%;font-style:normal;display:flex;align-items:center;justify-content:center;font:700 12px/1 Manrope,sans-serif;color:#fff}",
      "html body #page .fo-nt-form i.w{background:#1F7A50}html body #page .fo-nt-form i.l{background:#C22823}html body #page .fo-nt-form i.t{background:#9FB0C6}"
    ].join("\n");
