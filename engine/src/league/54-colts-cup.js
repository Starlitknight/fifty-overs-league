...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-cc-tie .side u{flex:none;text-decoration:none;font-size:9.5px;letter-spacing:.1em;text-transform:uppercase;color:#C9571F}",
      "html body #page .fo-cc-tie .vs{flex:none;font-size:10.5px;color:#b4aa98;font-style:normal}",
      "html body #page .fo-cc-tie .ff{flex:none;font:600 9.5px/1 Oswald,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:#C9571F;font-style:normal}",
