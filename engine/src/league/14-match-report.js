...
(function () {
  ...
  function foMrMomentum(f, rec) {
    ...
    series.forEach(function (s, si) {
      ...
      svg += "<text x='" + (x0 + half / 2) + "' y='" + (PT - 12) + "' text-anchor='middle' font-family='Manrope' font-size='10.5' letter-spacing='1.5' fill='#8a8272'>" + E(String(s.team || "").toUpperCase()) + " INNINGS</text>";
  ...
  function foMrCss() {
    ...
    s.textContent = [
      ...
      ".fo-mr-t b{font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.14em;font-size:11px;color:#9FB0C6}",
      ".fo-mr-t u{font-family:Manrope,sans-serif;font-weight:700;font-size:clamp(28px,3.4vw,44px);line-height:1;color:#fff;text-decoration:none;font-variant-numeric:tabular-nums}",
      ".fo-mr-t i{font-family:Manrope,sans-serif;font-style:normal;letter-spacing:.16em;font-size:10px;color:#6E7F96}",
      ".fo-mr-v{font-family:Fraunces,Georgia,serif;font-style:normal;color:#5f7392;font-size:18px}",
      ".fo-mr-verdict{font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:11.5px;color:var(--gold);margin-top:11px;padding-top:11px;border-top:1px solid rgba(150,180,225,.16)}",
      // body
      ...
      ".fo-mr-report p.lead:first-letter{float:left;font-family:Manrope,sans-serif;font-weight:700;font-size:56px;line-height:.82;padding:4px 10px 0 0;color:var(--gold)}",
      ...
      ".fo-mr-pshb>b{display:block;font:700 11px/1.2 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14243A;margin-bottom:8px}",
      ".fo-mr-pshr{display:grid;grid-template-columns:64px minmax(0,1fr) 40px;gap:3px 10px;align-items:center;padding:4px 0}",
      ".fo-mr-pshr .w{font:700 11px/1.2 Manrope,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#5b5344}",
      ...
      "html body #page .fo-mr-pshr>b{text-align:right;font:700 12.5px/1.2 Manrope,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
      ...
      ".fo-mr-mrow i{font-family:Manrope,sans-serif;font-style:normal;letter-spacing:.14em;font-size:10px;color:#6E7F96;white-space:nowrap}",
      ".fo-mr-mrow b{font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.04em;font-size:13px;color:var(--paper);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      ...
      ".fo-mr-none h3{margin:0 0 8px;font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.12em;font-size:14px;color:var(--paper)}",
      ...
      "html body #page a.fo-mr-back{font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10.5px;font-weight:600;color:#F4EFE3 !important;text-decoration:none !important;background:rgba(12,20,36,.6);border:1.5px solid rgba(235,194,113,.42) !important;border-radius:999px !important;padding:11px 19px !important;transition:.16s}",
      "html body #page a.fo-mr-back:hover{color:#E8B96A !important;border-color:var(--gold) !important}",
      "html body #page a.fo-mr-jump{display:inline-block;margin:0 0 10px;font-family:Manrope,sans-serif;text-transform:uppercase;letter-spacing:.18em;font-size:10.5px;font-weight:600;color:#0d1526 !important;text-decoration:none !important;background:linear-gradient(180deg,#E8B96A,#8F6A1C) !important;border:0 !important;border-radius:999px !important;padding:9px 17px !important;box-shadow:0 5px 16px rgba(230,177,94,.22)}",
      ...
      ".fo-ms-in{max-width:1400px;margin:0 auto;padding:20px 22px 44px;font-family:Manrope,-apple-system,'Segoe UI',sans-serif}",
      ".fo-ms-crumb{font:600 11px Manrope,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#8a8272;margin-bottom:10px}",
      ...
      ".fo-ms-mid .mc{font:700 11px Manrope,sans-serif;letter-spacing:.3em;text-transform:uppercase;color:#E8B96A;margin-bottom:7px}",
      ...
      ".fo-ms-mid .potm i{display:block;font:700 11px Manrope,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:3px}",
      ...
      ".fo-ms-ck{display:flex;justify-content:space-between;align-items:center;padding:12px 15px 9px;font:700 11px Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#14243A;border-bottom:1px solid #eee7d9}",
      ".fo-ms-note{font:500 11px Manrope,sans-serif;letter-spacing:.1em;color:#B23230;font-style:normal}",
      ...
      ".fo-ms-km .ov{font:700 12px Manrope,sans-serif;color:#8a8272;font-variant-numeric:tabular-nums}",
      ".fo-ms-km .bb{width:25px;height:25px;border-radius:50%;display:flex;align-items:center;justify-content:center;font:800 12px Manrope,sans-serif;color:#fff}",
      ...
      ".fo-ms-km .tx b{display:block;font:700 13px Manrope,sans-serif;color:#14243A}",
      ".fo-ms-km .tx>span{display:block;font:400 13px/1.45 Manrope,sans-serif;color:#6A6354}",
      ".fo-ms-km .sc{text-align:right;font:700 13px Manrope,sans-serif;color:#14243A;white-space:nowrap;font-variant-numeric:tabular-nums}",
      ".fo-ms-km .sc i{display:block;font:400 10px Manrope,sans-serif;color:#8a8272;font-style:normal}",
      ".fo-ms-more{display:block;margin:10px 13px 13px;text-align:center;font:700 11px Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#C9571F !important;border:1px solid #C9571F;border-radius:9px;padding:9px;text-decoration:none !important}",
      ...
      ".fo-ms-ph{padding:8px 15px 4px;font:700 11px Manrope,sans-serif;letter-spacing:.2em;color:#C9571F}",
      ...
      ".fo-ms-pf .id b{display:block;font:700 12.5px Manrope,sans-serif;color:#14243A}",
      ".fo-ms-pf .id>span{display:block;font:400 12px Manrope,sans-serif;color:#8a8272}",
      ".fo-ms-pf .num{margin-left:auto;text-align:right;font:400 13px Manrope,sans-serif;color:#8a8272;white-space:nowrap}",
      ".fo-ms-pf .num b{font:800 17px Manrope,sans-serif;color:#14243A;font-variant-numeric:tabular-nums}",
      ...
      ".fo-ms-kv{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:8px 15px;font:500 13px Manrope,sans-serif;color:#6A6354;border-bottom:1px solid #f3eee1}",
      ".fo-ms-kv b{font:700 13px Manrope,sans-serif;color:#14243A;text-align:right}",
      ".fo-ms-kv b u{text-decoration:none;display:inline-flex;width:18px;height:18px;border-radius:50%;align-items:center;justify-content:center;font:800 10px Manrope,sans-serif;margin-left:3px;color:#fff;background:#b0a794}",
      ".fo-ms-kv b u.fW{background:#177A57}.fo-ms-kv b u.fL{background:#C0392E}",
      ".fo-ms-pad{padding:12px 14px}",
      ".fo-ms-legend{display:flex;gap:14px;align-items:center;font:600 11px Manrope,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#8a8272;margin-top:6px;flex-wrap:wrap}",
      ...
      ".fo-ms-dark .dk{font:700 11px Manrope,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A;margin-bottom:9px}",
      ".fo-ms-pr{display:grid;grid-template-columns:minmax(0,1.3fr) 34px 1fr;gap:9px;align-items:center;font:600 13px Manrope,sans-serif;margin:6px 0}",
      ...
      ".fo-ms-dark .nf b{display:block;font:700 15px Manrope,sans-serif;color:#fff}",
      ".fo-ms-dark .nf span{font:400 13px Manrope,sans-serif;color:#9fb0c5}",
      ".fo-ms-dark .vs{margin-left:auto;font:800 20px Fraunces,Georgia,serif;color:#E8B96A}",
      "html body #page .fo-ms-dark a.go{display:block;margin-top:11px;text-align:center;font:700 11px Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#E8B96A !important;border:1px solid rgba(232,185,106,.6);border-radius:9px;padding:8px;text-decoration:none !important}",
