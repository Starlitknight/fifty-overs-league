...
(function () {
  ...
  function foMrMomentum(f, rec) {
    ...
    series.forEach(function (s, si) {
      ...
      svg += "<text x='" + (x0 + half / 2) + "' y='" + (PT - 12) + "' text-anchor='middle' font-family='Inter' font-size='10.5' letter-spacing='1.5' fill='#8a8272'>" + E(String(s.team || "").toUpperCase()) + " INNINGS</text>";
  ...
  function foMrManhattan(rec, f) {
    ...
    groups.forEach(function (g, gi) {
      g.bars.forEach(function (b) {
        ...
        if (b.k > 0) svg += "<circle cx='" + (x + bw / 2).toFixed(1) + "' cy='" + (H - PB - h - 5).toFixed(1) + "' r='2.6' fill='#B23230'/>";
        x += bw + 1.5;
      });
      x += 10;
    });
  ...
  function foMrCss() {
    ...
    s.textContent = [
      ...
      "html body.fo-mr-on #topbar,html body.ftpskin.fo-mr-on #topbar{position:fixed;top:0;left:0;right:0;z-index:60;background:#0C1B2E !important;border-bottom:1px solid rgba(230,177,94,.16) !important;box-shadow:none !important}",
      "html body.fo-mr-on #page{padding-top:0 !important;margin-top:0 !important}",
      "html body.fo-mr-on #fo-top-status{display:none}",
      "#page .fo-mr{--gold:#E8B96A;--paper:#F4EFE4;position:relative;min-height:100vh;background:#0C1B2E;color:#e9eefa;overflow-x:clip}",
      ...
      ".fo-mr-mast{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.4em;font-size:clamp(9px,1vw,11.5px);font-weight:600;color:var(--gold)}",
      ".fo-mr-mast em{font-style:normal;color:#9FB0C6;letter-spacing:.28em}",
      ".fo-mr-folio{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.22em;font-size:10px;color:#7d8fad;margin-top:7px;padding-bottom:9px;border-bottom:1px solid rgba(230,177,94,.28)}",
      ".fo-mr-head{font-family:Inter,sans-serif;font-weight:700;text-transform:uppercase;line-height:.86;letter-spacing:-.005em;font-size:clamp(30px,4.6vw,62px);margin:14px 0 0;color:var(--paper);text-wrap:balance}",
      ...
      ".fo-mr-t b{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.14em;font-size:11px;color:#9FB0C6}",
      ...
      ".fo-mr-t i{font-family:Inter,sans-serif;font-style:normal;letter-spacing:.16em;font-size:10px;color:#6E7F96}",
      ".fo-mr-v{font-family:Fraunces,Georgia,serif;font-style:normal;color:#5f7392;font-size:18px}",
      ".fo-mr-verdict{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:11.5px;color:var(--gold);margin-top:11px;padding-top:11px;border-top:1px solid rgba(150,180,225,.16)}",
      // body
      ...
      ".fo-mr-report p{font-family:Fraunces,Georgia,serif;font-size:15.5px;line-height:1.78;color:#9FB0C6;margin:0 0 16px}",
      ".fo-mr-report p.lead{font-size:17px;color:#dbe4f2}",
      ".fo-mr-report p.lead:first-letter{float:left;font-family:Inter,sans-serif;font-weight:700;font-size:56px;line-height:.82;padding:4px 10px 0 0;color:var(--gold)}",
      ".fo-mr-by{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10px;color:#6E7F96;margin-top:22px;padding-top:12px;border-top:1px solid rgba(150,180,225,.14)}",
      // rail
      ".fo-mr-rail{display:flex;flex-direction:column;gap:14px}",
      ".fo-mr-kick{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.26em;font-size:10px;font-weight:600;color:var(--gold)}",
      ...
      ".fo-mr-turn h3,.fo-mr-mom h3{font-family:Inter,sans-serif;font-weight:700;text-transform:uppercase;font-size:19px;line-height:1.1;margin:7px 0 8px;color:var(--paper)}",
      ...
      ".fo-mr-line i{font-family:Inter,sans-serif;font-style:normal;font-size:10px;letter-spacing:.1em;color:#6E7F96}",
      ...
      ".fo-mr-sh b{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.1em;font-size:12.5px;color:var(--paper);flex:1;min-width:0}",
      ...
      ".fo-mr-sh i{font-family:Inter,sans-serif;font-style:normal;font-size:10px;letter-spacing:.12em;color:#6E7F96}",
      ".fo-mr-sub{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10px;color:#7d8fad;margin:11px 0 2px}",
      // rules + worm
      ...
      ".fo-mr-pshb>b{display:block;font:700 11px/1.2 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#14243A;margin-bottom:8px}",
      ".fo-mr-pshr{display:grid;grid-template-columns:64px minmax(0,1fr) 40px;gap:3px 10px;align-items:center;padding:4px 0}",
      ".fo-mr-pshr .w{font:700 11px/1.2 Inter,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#5b5344}",
      ...
      ".fo-mr-rule span{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.32em;font-size:10.5px;font-weight:600;color:var(--gold);white-space:nowrap}",
      ...
      ".fo-mr-worm .gl{fill:#6E7F96;font-family:Inter,sans-serif;font-size:10px;letter-spacing:.08em}",
      ...
      ".fo-mr-key{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:9px;font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.14em;font-size:10px;color:#9FB0C6}",
      ...
      ".fo-mr-mrow i{font-family:Inter,sans-serif;font-style:normal;letter-spacing:.14em;font-size:10px;color:#6E7F96;white-space:nowrap}",
      ".fo-mr-mrow b{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.04em;font-size:13px;color:var(--paper);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      ".fo-mr-mrow span{font-family:Fraunces,Georgia,serif;font-style:normal;font-size:12.5px;color:#9FB0C6;white-space:nowrap}",
      // ---- the four views ------------------------------------------------
      ...
      ".fo-mr-comm{background:#FFFEFC;border-radius:12px;padding:14px 12px 16px;box-shadow:0 10px 30px rgba(0,0,0,.34)}",
      ...
      ".fo-mr-none h3{margin:0 0 8px;font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.12em;font-size:14px;color:var(--paper)}",
      ".fo-mr-none p{margin:0 auto;max-width:56ch;font-family:Fraunces,Georgia,serif;font-size:13.5px;line-height:1.7;color:#9FB0C6}",
      ".fo-mr-foot{display:flex;gap:10px;flex-wrap:wrap;margin-top:38px}",
      "html body #page a.fo-mr-back{font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10.5px;font-weight:600;color:#F4EFE3 !important;text-decoration:none !important;background:rgba(12,20,36,.6);border:1.5px solid rgba(235,194,113,.42) !important;border-radius:999px !important;padding:11px 19px !important;transition:.16s}",
      "html body #page a.fo-mr-back:hover{color:#E8B96A !important;border-color:var(--gold) !important}",
      "html body #page a.fo-mr-jump{display:inline-block;margin:0 0 10px;font-family:Inter,sans-serif;text-transform:uppercase;letter-spacing:.18em;font-size:10.5px;font-weight:600;color:#0d1526 !important;text-decoration:none !important;background:linear-gradient(180deg,#E8B96A,#8F6A1C) !important;border:0 !important;border-radius:999px !important;padding:9px 17px !important;box-shadow:0 5px 16px rgba(230,177,94,.22)}",
      ...
      ".fo-ms-crumb{font:600 11px Inter,sans-serif;letter-spacing:.18em;text-transform:uppercase;color:#8a8272;margin-bottom:10px}",
      ".fo-ms-hero{position:relative;background:linear-gradient(115deg,#0C1B2E,#14243A 55%,#1B3A5F);border-radius:18px;overflow:hidden;padding:28px 38px 24px;color:#F6F3EB;box-shadow:0 18px 44px rgba(11,29,51,.35)}",
      ...
      ".fo-ms-side .tn{font:600 12.5px Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#c9d0da}",
      ...
      ".fo-ms-side .ov{font:600 11px Inter,sans-serif;letter-spacing:.16em;color:#8ea0b8}",
      ".fo-ms-mid{text-align:center;max-width:420px}",
      ".fo-ms-mid .mc{font:700 11px Inter,sans-serif;letter-spacing:.3em;text-transform:uppercase;color:#E8B96A;margin-bottom:7px}",
      ...
      ".fo-ms-mid .potm i{display:block;font:700 11px Inter,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:3px}",
      ...
      ".fo-ms-ck{display:flex;justify-content:space-between;align-items:center;padding:12px 15px 9px;font:700 11px Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#14243A;border-bottom:1px solid #eee7d9}",
      ".fo-ms-note{font:500 11px Inter,sans-serif;letter-spacing:.1em;color:#B23230;font-style:normal}",
      ...
      ".fo-ms-km .ov{font:700 12px Inter,sans-serif;color:#8a8272;font-variant-numeric:tabular-nums}",
      ".fo-ms-km .bb{width:25px;height:25px;border-radius:50%;display:flex;align-items:center;justify-content:center;font:800 12px Inter,sans-serif;color:#fff}",
      ".fo-ms-km .bb.wk{background:#B23230}.fo-ms-km .bb.f4{background:#C9571F}",
      ".fo-ms-km .bb.f6{background:#14243A;border:1.5px solid #E8B96A;color:#E8B96A}",
      ".fo-ms-km .bb.oth{background:#efe9da;color:#6A6354}",
      ".fo-ms-km .bb.ms{background:#F8ECD4;color:#8a6a1f;border:1px solid #e8d5a8;border-radius:8px;font-size:10px}",
      ".fo-ms-km .tx b{display:block;font:700 13px Inter,sans-serif;color:#14243A}",
      ".fo-ms-km .tx>span{display:block;font:400 13px/1.45 Inter,sans-serif;color:#6A6354}",
      ".fo-ms-km .sc{text-align:right;font:700 13px Inter,sans-serif;color:#14243A;white-space:nowrap;font-variant-numeric:tabular-nums}",
      ".fo-ms-km .sc i{display:block;font:400 10px Inter,sans-serif;color:#8a8272;font-style:normal}",
      ".fo-ms-more{display:block;margin:10px 13px 13px;text-align:center;font:700 11px Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#C9571F !important;border:1px solid #C9571F;border-radius:9px;padding:9px;text-decoration:none !important}",
      ...
      ".fo-ms-dim{padding:14px;font:400 13px Fraunces,Georgia,serif;color:#8a8272}",
      ".fo-ms-ph{padding:8px 15px 4px;font:700 11px Inter,sans-serif;letter-spacing:.2em;color:#C9571F}",
      ...
      ".fo-ms-pf .id>span{display:block;font:400 12px Inter,sans-serif;color:#8a8272}",
      ".fo-ms-pf .num{margin-left:auto;text-align:right;font:400 13px Inter,sans-serif;color:#8a8272;white-space:nowrap}",
      ...
      ".fo-ms-st .st{text-decoration:none;font-size:10px;letter-spacing:.4px;white-space:nowrap}",
      ...
      ".fo-ms-kv{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:8px 15px;font:500 13px Inter,sans-serif;color:#6A6354;border-bottom:1px solid #f3eee1}",
      ".fo-ms-kv b{font:700 13px Inter,sans-serif;color:#14243A;text-align:right}",
      ".fo-ms-kv b u{text-decoration:none;display:inline-flex;width:18px;height:18px;border-radius:50%;align-items:center;justify-content:center;font:800 10px Inter,sans-serif;margin-left:3px;color:#fff;background:#b0a794}",
      ".fo-ms-kv b u.fW{background:#177A57}.fo-ms-kv b u.fL{background:#C0392E}",
      ".fo-ms-pad{padding:12px 14px}",
      ".fo-ms-legend{display:flex;gap:14px;align-items:center;font:600 11px Inter,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#8a8272;margin-top:6px;flex-wrap:wrap}",
      ...
      ".fo-ms-dark .dk{font:700 11px Inter,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A;margin-bottom:9px}",
      ".fo-ms-pr{display:grid;grid-template-columns:minmax(0,1.3fr) 34px 1fr;gap:9px;align-items:center;font:600 13px Inter,sans-serif;margin:6px 0}",
      ...
      ".fo-ms-dark .nf span{font:400 13px Inter,sans-serif;color:#9fb0c5}",
      ".fo-ms-dark .vs{margin-left:auto;font:800 20px Fraunces,Georgia,serif;color:#E8B96A}",
      "html body #page .fo-ms-dark a.go{display:block;margin-top:11px;text-align:center;font:700 11px Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#E8B96A !important;border:1px solid rgba(232,185,106,.6);border-radius:9px;padding:8px;text-decoration:none !important}",
