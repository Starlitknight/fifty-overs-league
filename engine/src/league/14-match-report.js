...
(function () {
  ...
  function foMrCss() {
    ...
    s.textContent = [
      ...
      ".fo-mr-t i{font-family:Oswald,sans-serif;font-style:normal;letter-spacing:.16em;font-size:10px;color:#6f819e}",
      ...
      ".fo-mr-by{font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10px;color:#6f819e;margin-top:22px;padding-top:12px;border-top:1px solid rgba(150,180,225,.14)}",
      // rail
      ...
      ".fo-mr-line i{font-family:Oswald,sans-serif;font-style:normal;font-size:10px;letter-spacing:.1em;color:#6f819e}",
      ...
      ".fo-mr-sh i{font-family:Oswald,sans-serif;font-style:normal;font-size:10px;letter-spacing:.12em;color:#6f819e}",
      ...
      ".fo-mr-worm .gl{fill:#6f819e;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.08em}",
      ...
      ".fo-mr-key{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:9px;font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.14em;font-size:10px;color:#93a5c2}",
      ...
      ".fo-mr-mrow i{font-family:Oswald,sans-serif;font-style:normal;letter-spacing:.14em;font-size:10px;color:#6f819e;white-space:nowrap}",
      ...
      ".fo-mr-cf b{margin-left:auto;font-family:Oswald,sans-serif;font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:#8a7a55;font-weight:600}",
      ".fo-mr-innmark{margin:14px 0 6px;font-family:Oswald,sans-serif;text-transform:uppercase;letter-spacing:.2em;font-size:10px;font-weight:600;color:#8a7a55;border-bottom:1px solid rgba(20,28,40,.12);padding-bottom:5px}",
      ...
      ".fo-ms-mid .potm i{display:block;font:700 10px Oswald,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:3px}",
      ...
      ".fo-ms-note{font:500 10px Oswald,sans-serif;letter-spacing:.1em;color:#8E1F13;font-style:normal}",
      ...
      ".fo-ms-km .tx>span{display:block;font:400 13px/1.45 Inter,sans-serif;color:#6d6455}",
      ...
      ".fo-ms-ph{padding:8px 15px 4px;font:700 10px Oswald,sans-serif;letter-spacing:.2em;color:#C9571F}",
      ...
      ".fo-ms-kv{display:flex;justify-content:space-between;align-items:center;gap:10px;padding:8px 15px;font:500 13px Inter,sans-serif;color:#6d6455;border-bottom:1px solid #f3eee1}",
      ...
      ".fo-ms-legend{display:flex;gap:14px;align-items:center;font:600 10px Oswald,sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#8a8272;margin-top:6px;flex-wrap:wrap}",
      ...
      ".fo-ms-dark .dk{font:700 10px Oswald,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A;margin-bottom:9px}",
