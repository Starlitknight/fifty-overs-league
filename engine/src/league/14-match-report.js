...
(function () {
  ...
  function foMrCss() {
    ...
    s.textContent = [
      ...
      ".fo-mr-veil{position:absolute;top:0;left:0;right:0;height:min(62vh,560px);z-index:0;background:linear-gradient(180deg,rgba(7,12,22,.72) 0%,rgba(7,12,22,.5) 34%,rgba(7,12,22,.88) 78%,#070c16 100%)}",
