...
(function () {
  ...
  var CSS = [
    ...
    "#topbar#topbar #fo-wclock b{font:600 11px/1 Inter,sans-serif;letter-spacing:.18em;color:#E8B96A;white-space:nowrap;text-transform:uppercase}",
    ...
    "#topbar#topbar #fo-wclock i{font:700 11px/1 Inter,sans-serif;letter-spacing:.06em;color:#FF6B5E;font-style:normal;white-space:nowrap}",
    ...
    "html body #fo-eng-live{position:fixed;left:50%;transform:translateX(-50%);bottom:86px;z-index:1200;display:inline-flex;align-items:center;gap:8px;background:#B23230;color:#FFFEFC !important;font:800 11px/1 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase;border-radius:999px;padding:12px 18px;text-decoration:none;box-shadow:0 14px 34px rgba(178,50,48,.45)}",
