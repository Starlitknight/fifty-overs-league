...
(function () {
  ...
  var CSS = [
    ...
    "#topbar#topbar .brand{font:italic 600 16px/1 " + D + " !important;letter-spacing:.01em}",
    ...
    "html body #page .fo-ns-h1{font-family:" + D + " !important;font-weight:600;font-style:italic;text-transform:none !important;letter-spacing:-.01em !important;line-height:1;font-variation-settings:'opsz' 110}",
    "html body #page .fo-desk-h1{font-family:" + D + " !important;font-weight:600;font-style:italic;text-transform:none !important;letter-spacing:-.01em !important;line-height:1;font-variation-settings:'opsz' 110}",
    // the club's name over its ground: an art-print signature
    "html body #page .fo-hg2 .hg-id b{font-family:" + D + " !important;font-style:italic;font-weight:620;text-transform:none !important;letter-spacing:-.015em !important;line-height:.98;font-variation-settings:'opsz' 120}",
    // the squad room's title over the park
    "html body #page .fo-sqx-hd h1{font-family:" + D + " !important;font-weight:600;font-style:italic;text-transform:none !important;letter-spacing:-.01em !important;font-variation-settings:'opsz' 110}",
    // the nation, city and cup heroes over their painted maps
    "html body #page .fo-nt-title,html body #page .fo-lx-title,html body #page .fo-ct-h1{font-family:" + D + " !important;font-weight:600;font-style:italic;text-transform:none !important;letter-spacing:-.015em !important;line-height:.95;font-variation-settings:'opsz' 120}",
    ...
    "html body #page .fo-cer-h1{font-family:" + D + " !important;font-weight:600;font-style:italic;text-transform:none !important;letter-spacing:-.01em !important;font-variation-settings:'opsz' 110}",
    ...
    "html body #page .fo-sd-hero p,html body #page .fo-tm-mast p,html body #page .fo-mc-hero p,html body #page .fo-hb-mast p{font-family:" + D + " !important;font-style:italic;font-weight:420;font-size:13.5px;line-height:1.6;font-variation-settings:'opsz' 24}",
