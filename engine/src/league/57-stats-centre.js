...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-stc-lead em{display:block;margin-top:3px;font:700 17px/1 Oswald,sans-serif;font-style:normal;font-variant-numeric:tabular-nums;color:#FFFEFC}",
      // ---- the table view ---------------------------------------------------
