...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-stc-hero .k{font:600 11px/1 Inter,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-stc-now span{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);border-radius:11px;padding:8px 13px 7px;font:600 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(244,239,228,.62)}",
      ...
      "html body #page .fo-stc-sech{display:flex;align-items:center;gap:12px;font:600 11px/1 Inter,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#14243A;margin:0 2px 10px}",
      ...
      "html body #page .fo-stc-item i{display:block;margin-top:8px;font:700 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#B44A22 !important;font-style:normal}html body #page .fo-stc-item i:after{content:' \u203A'}",
      ...
      "html body #page .fo-stc-lead i{display:block;font:600 11px/1 Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:8px}",
      ...
      // ---- the table view ---------------------------------------------------
      "html body #page .fo-stc-back{display:inline-flex;align-items:center;min-height:30px;margin:16px 0 0;font:600 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.4) !important;text-decoration:none !important}",
      ...
      "html body #page .fo-stc-mast .mid i{font:600 11px/1 Inter,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
      "html body #page .fo-stc-mast .mid b{font:600 clamp(30px,7.4vw,40px)/1.02 Inter,sans-serif;letter-spacing:.03em;text-transform:uppercase;color:#FFFEFC;font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-stc-hstep s{text-decoration:none;font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;color:rgba(244,239,228,.55);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-stc-ck{font:600 11px/1 Inter,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#B44A22;margin:14px 0 6px}",
      "html body #page .fo-stc-hhead h2 s{text-decoration:none;font:600 11px/1 Inter,sans-serif;letter-spacing:.15em;text-transform:uppercase;color:rgba(20,28,40,.45);margin-left:12px;vertical-align:3px;white-space:nowrap;font-variant-numeric:tabular-nums}",
      "html body #page .fo-stc-htb tr.ch td{background:rgba(47,107,69,.07)}",
      "html body #page .fo-stc-htb tr.ch em{font-style:normal;margin-left:6px;font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;color:#2F6B45}",
      ...
      "html body #page .fo-stc-htb th{padding:7px 3px;font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,28,40,.45);border-bottom:1px solid rgba(20,28,40,.16)}",
      ...
      "html body #page .fo-stc-htb tr.ch em{font-style:normal;margin-left:5px;font:700 11px/1 Inter,sans-serif;letter-spacing:.12em;color:#2F6B45}",
      ...
      "html body #page .fo-stc-ldg th{padding:8px 3px;font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);border-bottom:1px solid rgba(20,28,40,.5);text-align:right}",
      ...
      "html body #page table.fo-stc-tbl th{position:sticky;top:0;z-index:1;background:#FFFEFC;color:rgba(20,28,40,.45);font:600 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;text-align:right;padding:0 8px 10px;white-space:nowrap;cursor:pointer;-webkit-user-select:none;user-select:none;box-shadow:inset 0 -1px 0 rgba(20,28,40,.16)}",
      ...
      "html body #page .fo-stc-note h3{margin:0 0 8px;font:600 11px/1 Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#14243A}",
      ...
      "html body #page .fo-stw-hd i{display:block;font:600 11px/1 Inter,sans-serif;font-style:normal;letter-spacing:.24em;text-transform:uppercase;color:#E8B96A;margin-bottom:6px}",
      "html body #page .fo-stw-hd b{font:700 22px/1 Inter,sans-serif;letter-spacing:.02em;text-transform:uppercase;color:#FFFEFC}",
      "html body #page .fo-stw-hd>span{font:600 11px/1.5 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.5)}",
      ...
      "html body #page .fo-stw-kpi span{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(241,238,230,.5)}",
      "html body #page .fo-stw-kpi b{display:block;font:700 18px/1 Inter,sans-serif;color:#FFFEFC;margin-top:7px;font-variant-numeric:tabular-nums;white-space:nowrap}",
      ...
      "html body #page .fo-stw-cap{font:700 11px/1 Inter,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-stw-row .v{font:700 13.5px/1 Inter,sans-serif;color:#FFFEFC;font-variant-numeric:tabular-nums;text-align:right}",
      ...
      "html body #page a.fo-stw-all{display:inline-block;margin-top:12px;font:700 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#E8B96A !important;text-decoration:none !important}",
      ...
      "html body #page a.fo-stw-mini span{display:block;font:700 11px/1 Inter,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.5)}",
      "html body #page a.fo-stw-mini b{display:block;font:700 22px/1 Inter,sans-serif;color:#FFFEFC;margin-top:7px;font-variant-numeric:tabular-nums}",
      ...
      "html body #page a.fo-stw-door b{font:700 11px/1 Inter,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#E8B96A !important;white-space:nowrap}",
