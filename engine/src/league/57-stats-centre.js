...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      "html body #page .fo-stc-hero .k{font:600 11px/1 Manrope,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-stc-hero p{margin:0;font:400 13.5px/1.55 Manrope,sans-serif;color:rgba(244,239,228,.76);max-width:66ch}",
      "html body #page .fo-stc-now{display:flex;gap:8px;flex-wrap:wrap;margin-top:15px}",
      "html body #page .fo-stc-now span{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.15);border-radius:11px;padding:8px 13px 7px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(244,239,228,.62)}",
      "html body #page .fo-stc-now span b{display:block;margin-bottom:4px;font:700 16px/1 Manrope,sans-serif;letter-spacing:0;color:#FFFEFC;font-variant-numeric:tabular-nums;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:20ch}",
      // ---- the index --------------------------------------------------------
      "html body #page .fo-stc-sec{margin-top:26px}",
      "html body #page .fo-stc-sech{display:flex;align-items:center;gap:12px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.22em;text-transform:uppercase;color:#14243A;margin:0 2px 10px}",
      ...
      "html body #page .fo-stc-item span{display:block;font:400 13px/1.5 Manrope,sans-serif;color:rgba(20,28,40,.6)}",
      "html body #page .fo-stc-item i{display:block;margin-top:8px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#B44A22 !important;font-style:normal}html body #page .fo-stc-item i:after{content:' \u203A'}",
      ...
      "html body #page .fo-stc-lead div{background:transparent;border-left:1px solid rgba(244,239,228,.12);padding:16px 18px 15px;color:#FFFEFC;min-width:0}",
      "html body #page .fo-stc-lead div:first-child{border-left:0}",
      "html body #page .fo-stc-lead i{display:block;font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A;font-style:normal;margin-bottom:8px}",
      ...
      "html body #page .fo-stc-lead em{display:block;margin-top:5px;font:400 13px/1.5 Manrope,sans-serif;font-style:normal;font-variant-numeric:tabular-nums;color:rgba(244,239,228,.62)}",
      ...
      // ---- the table view ---------------------------------------------------
      "html body #page .fo-stc-back{display:inline-flex;align-items:center;min-height:30px;margin:16px 0 0;font:600 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(20,28,40,.4) !important;text-decoration:none !important}",
      ...
      "html body #page .fo-stc-seg a{position:relative;font:600 13px/1 Manrope,sans-serif;letter-spacing:-.005em;color:rgba(20,28,40,.45) !important;text-decoration:none !important;padding:7px 0 8px;transition:color .12s ease}",
      ...
      "html body #page .fo-stc-qual{display:inline-flex;align-items:center;gap:8px;padding:7px 2px 8px;font:500 13px/1 Manrope,sans-serif;color:rgba(20,28,40,.45) !important;text-decoration:none !important}",
      ...
      "html body #page .fo-stc-sub{font:500 13px/1.4 Manrope,sans-serif;color:rgba(20,28,40,.52)}",
      "html body #page .fo-stc-dim{font:400 13px/1.55 Manrope,sans-serif;color:rgba(20,28,40,.5);margin:8px 2px}",
      ...
      "html body #page .fo-stc-foot a{flex:0 1 auto;font:600 13px/1.4 Manrope,system-ui,sans-serif;",
      ...
      "html body #page .fo-stc-mast .mid i{font:600 11px/1 Manrope,sans-serif;letter-spacing:.26em;text-transform:uppercase;color:#E8B96A;font-style:normal}",
      "html body #page .fo-stc-mast .mid b{font:600 clamp(30px,7.4vw,40px)/1.02 Manrope,sans-serif;letter-spacing:.03em;text-transform:uppercase;color:#FFFEFC;font-variant-numeric:tabular-nums}",
      "html body #page .fo-stc-mast .mid .of{font:400 13px/1.5 Manrope,system-ui,sans-serif;color:rgba(244,239,228,.62)}",
      ...
      "html body #page .fo-stc-mast .pick select{appearance:none!important;-webkit-appearance:none!important;min-height:34px!important;max-width:44vw;padding:0 18px 0 4px!important;border:0!important;border-bottom:1px solid rgba(235,194,113,.5)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;font:600 12.5px/1 Manrope,system-ui,sans-serif!important;color:#F4EFE4!important;font-variant-numeric:tabular-nums;cursor:pointer;text-overflow:ellipsis}",
      ...
      "html body #page .fo-stc-hstep u{width:40px;height:40px;display:inline-flex;align-items:center;justify-content:center;border:1.5px solid rgba(235,194,113,.45);border-radius:999px;text-decoration:none;font:400 19px/1 Manrope,sans-serif;color:#E8B96A;transition:border-color .14s,color .14s}",
      "html body #page .fo-stc-hstep:hover u{border-color:#E8B96A;color:#FFFEFC}",
      "html body #page .fo-stc-hstep s{text-decoration:none;font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;color:rgba(244,239,228,.55);font-variant-numeric:tabular-nums}",
      ...
      "html body #page .fo-stc-ck{font:600 11px/1 Manrope,sans-serif;letter-spacing:.24em;text-transform:uppercase;color:#B44A22;margin:14px 0 6px}",
      "html body #page .fo-stc-hhead h2 s{text-decoration:none;font:600 11px/1 Manrope,sans-serif;letter-spacing:.15em;text-transform:uppercase;color:rgba(20,28,40,.45);margin-left:12px;vertical-align:3px;white-space:nowrap;font-variant-numeric:tabular-nums}",
      "html body #page .fo-stc-htb tr.ch td{background:rgba(47,107,69,.07)}",
      "html body #page .fo-stc-htb tr.ch em{font-style:normal;margin-left:6px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;color:#2F6B45}",
      ...
      "html body #page .fo-stc-htb{width:100%;table-layout:fixed;border-collapse:collapse;margin-top:6px;font:400 12.5px/1.4 Manrope,system-ui,sans-serif;color:#1B2432}",
      "html body #page .fo-stc-htb th{padding:7px 3px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;text-transform:uppercase;color:rgba(20,28,40,.45);border-bottom:1px solid rgba(20,28,40,.16)}",
      ...
      "html body #page .fo-stc-htb tr.ch em{font-style:normal;margin-left:5px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.12em;color:#2F6B45}",
      ...
      "html body #page .fo-stc-ldg th{padding:8px 3px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42);border-bottom:1px solid rgba(20,28,40,.5);text-align:right}",
      "html body #page .fo-stc-ldg th:nth-child(2){text-align:left}",
      "html body #page .fo-stc-ldg td{padding:9px 3px;border-bottom:1px solid rgba(20,28,40,.08);text-align:right;font:500 13px/1.35 Manrope,system-ui,sans-serif;color:rgba(20,28,40,.72)}",
      ...
      "html body #page .fo-stc-ldg td.who b{display:block;font:600 13.5px/1.2 Manrope,system-ui,sans-serif;color:#1B2432;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}",
      "html body #page .fo-stc-ldg td.who em{font-style:normal;font:400 12px/1.4 Manrope,system-ui,sans-serif;color:rgba(20,28,40,.42);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}",
      ...
      "html body #page .fo-stc-mgrid div b{display:block;font:700 17px/1.15 Manrope,sans-serif;color:#1B2432;font-variant-numeric:tabular-nums}",
      "html body #page .fo-stc-mgrid div i{display:block;margin-top:3px;font:600 10px/1.2 Manrope,sans-serif;font-style:normal;letter-spacing:.14em;text-transform:uppercase;color:rgba(20,28,40,.42)}",
      ...
      "html body #page .fo-stc-htb.bk td:nth-child(2) u{display:block;text-decoration:none;font:400 12px/1.35 Manrope,system-ui,sans-serif;color:rgba(20,28,40,.5)}",
      ...
      "html body #page table.fo-stc-tbl th{position:sticky;top:0;z-index:1;background:#FFFEFC;color:rgba(20,28,40,.45);font:600 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;text-align:right;padding:0 8px 10px;white-space:nowrap;cursor:pointer;-webkit-user-select:none;user-select:none;box-shadow:inset 0 -1px 0 rgba(20,28,40,.16)}",
      ...
      "html body #page table.fo-stc-tbl td{padding:9px 8px;text-align:right;white-space:nowrap;font:500 12.5px/1.2 Manrope,sans-serif;color:rgba(20,28,40,.78);border-bottom:1px solid rgba(20,28,40,.055)}",
      ...
      "html body #page .fo-stc-note h3{margin:0 0 8px;font:600 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#14243A}",
      "html body #page .fo-stc-note ul{margin:0;padding-left:17px}",
      "html body #page .fo-stc-note li{font:400 12.5px/1.6 Manrope,sans-serif;color:rgba(20,28,40,.72);margin-bottom:5px}",
      ...
      "html body #page .fo-stw-kpi b{display:block;font:700 18px/1 Manrope,sans-serif;color:#FFFEFC;margin-top:7px;font-variant-numeric:tabular-nums;white-space:nowrap}",
      ...
      "html body #page .fo-stw-cap{font:700 11px/1 Manrope,sans-serif;letter-spacing:.2em;text-transform:uppercase;color:#E8B96A}",
      ...
      "html body #page .fo-stw-row em{font:700 12px/1 Manrope,sans-serif;font-style:normal;color:rgba(244,239,228,.45);font-variant-numeric:tabular-nums}",
      "html body #page .fo-stw-row a.nm{font:600 12.5px/1.2 Manrope,sans-serif;color:#F1EEE6 !important;text-decoration:none !important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0}",
      "html body #page .fo-stw-row a.nm:hover{color:#E8B96A !important}",
      "html body #page .fo-stw-row a.nm i{font:600 10px/1 Manrope,sans-serif;font-style:normal;color:rgba(244,239,228,.45);margin-left:6px;letter-spacing:.04em}",
      "html body #page .fo-stw-row .v{font:700 13.5px/1 Manrope,sans-serif;color:#FFFEFC;font-variant-numeric:tabular-nums;text-align:right}",
      ...
      "html body #page a.fo-stw-all{display:inline-block;margin-top:12px;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:#E8B96A !important;text-decoration:none !important}",
      "html body #page a.fo-stw-all:hover{color:#FFFEFC !important}",
      ...
      "html body #page a.fo-stw-mini span{display:block;font:700 11px/1 Manrope,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(244,239,228,.5)}",
      "html body #page a.fo-stw-mini b{display:block;font:700 22px/1 Manrope,sans-serif;color:#FFFEFC;margin-top:7px;font-variant-numeric:tabular-nums}",
      "html body #page a.fo-stw-mini i{display:block;font:500 12px/1.35 Manrope,sans-serif;font-style:normal;color:rgba(244,239,228,.55);margin-top:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}",
      ...
      "html body #page a.fo-stw-door b{font:700 11px/1 Manrope,sans-serif;letter-spacing:.14em;text-transform:uppercase;color:#E8B96A !important;white-space:nowrap}",
      "html body #page a.fo-stw-door i{font:400 13px/1.4 Manrope,sans-serif;font-style:normal;color:rgba(244,239,228,.5);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:right}",
      ...
      // A CONTENTS LIST THAT LOSES THE CONTENTS IS A LIST OF NAMES. Sharing one
      // line with the label left the note a few dozen pixels short on a phone,
      // so "every season this league has played" arrived as "every season this
      // league h...". The note takes its own line down there and wraps.
      "@media(max-width:560px){" +
        "html body #page a.fo-stw-door{grid-template-columns:minmax(0,1fr) auto;align-items:center;row-gap:3px}" +
        "html body #page a.fo-stw-door b{grid-column:1;grid-row:1}" +
        "html body #page a.fo-stw-door i{grid-column:1;grid-row:2;text-align:left;white-space:normal;overflow:visible}" +
        "html body #page a.fo-stw-door s{grid-column:2;grid-row:1/3}" +
      "}",
