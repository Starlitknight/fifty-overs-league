...
(function () {
  ...
  css3.textContent =
    ...
    ".fo-pk-sp .fo-pk-name{font-size:17px;font-weight:800}" +
  ...
  var FO_FIN = {
    ...
    sponsors: [
      ...
      { id: "contender", name: "Emirates", ind: "Airline \u00b7 Dubai", pos: "Fly with the winners.", base: 15000, win: 45000, halfway: 0, seasonTop3: 0, champ: 0, tone: "gold", lines: ["$15,000 every matchday", "+$45,000 per win"] }
    ],
    scenarios: [
  ...
  function foOnbSponsor() {
    ...
    var cards = FO_FIN.sponsors.map(function (s) {
      ...
      return "<button type='button' class='fo-pk fo-pk-sp fo-tone-" + s.tone + " " + (FO_ONB.sponsor === s.id ? "on" : "") + "' data-sp='" + s.id + "'>" +
        "<span class='fo-sp-mono fo-mono-" + s.tone + "'>" + mono[s.id] + "</span>" +
