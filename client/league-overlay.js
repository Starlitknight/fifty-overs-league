      ...
      window.comm = function (inn, out, rb, sb, bowler, intent, field) {
        try {
          ...
          if (typeof isWkt === "function" && isWkt(out)) {
            ...
            else tail = pick([" A genuine breakthrough.", " " + bwl + " has earned that.", " The pressure told."], 16);
            return "WICKET - " + core + "." + tail;
          }
          if (out === "6") return pick([
            "SIX! " + bat + " picks the length early and deposits " + bwl + " over " + reg,
            "SIX - that is enormous! Clean off the middle and into the " + (death ? "second tier" : "stands"),
            "SIX! " + (pace ? "Pace on, pace used - flat and brutal over " + reg : bat + " skips down and lifts the spinner into the sightscreen"),
            "SIX more! " + bwl + " drops short and " + bat + " swivels and buries it over the rope",
            "Huge from " + bat + "! The fielder at " + reg + " does not even move"
          ], 21) + (chase && chase.need <= 30 && chase.need > 0 ? " The target is suddenly very close." : (intent >= 2 ? " Launch mode pays." : "."));
          if (out === "4") return pick([
            "FOUR - " + bat + " leans into a cover drive and it races away. Pure timing",
            "FOUR! Short and wide from " + bwl + ", and " + bat + " cuts it savagely behind point",
            "FOUR - whipped off the pads through " + reg + ", no one moved",
            "Streaky! " + bat + " gets an inside edge past " + (pace ? kp : "the stumps") + " and it runs away for FOUR",
            "FOUR - " + bat + " opens the face and steers it past " + (field === "def" ? "a packed off side" : "backward point"),
            "Poor from " + bwl + ", straying onto the pads, and " + bat + " helps it to the " + reg + " fence. FOUR",
            "FOUR! Danced down and driven back past the bowler - " + bwl + " can only watch",
            "Top edge on the pull... it lands SAFE and skips to the rope. FOUR, and " + bat + " smiles"
          ], 22) + ".";
          if (out === "wide") return pick([
          ...
          if (out === "noball") return pick([
            "NO-BALL! " + bwl + " oversteps - a free run and he has to bowl it again",
            "No-ball called - the front foot is well over. Sloppy from " + bwl
          ], 24) + ".";
          if (out === "bye") return "The ball beats everyone - " + kp + " cannot gather and they scamper a bye.";
          if (out === "legbye") return "Off the pad and squirting to " + reg + " - they cross for a leg bye.";
          if (out === "dot") {
            var dots = pace ? [
              "Beaten! " + bwl + " angles it across and " + bat + " flashes at fresh air",
              bat + " shoulders arms and lets it through to " + kp + ". Good leave",
              "Defended off the back foot, dead bat, no run",
              "Loud appeal for caught behind! The umpire is unmoved, and " + bwl + " cannot believe it",
              "Sharp bouncer - " + bat + " sways out of the way at the last instant",
              "Yorker dug out at the very last moment. " + bat + " survives",
              bwl + " hits the seam and it wobbles past the edge. A groan from the slips",
              "Firm push to " + reg + " but the fielder is on it in a flash. No run",
              "Driven hard, straight to the man at " + reg + ". Good cricket all round",
              "Back of a length, tucked into the hip - " + bat + " cannot get it away"
            ] : [
              "Tossed up, smothered - " + bat + " comes forward with bat and pad together",
              "Rips past the outside edge! " + bwl + " is turning it square here",
              "Big appeal for lbw as " + bat + " misses the sweep... not out, says the umpire",
              bat + " reads the googly late and jams it out. Nervous moment",
              "Flighted, driven, but " + reg + " cuts it off. Dot ball",
              "Quicker one, skidding through - " + bat + " is rushed and can only block",
              "Down the track... beaten in the flight and lucky the keeper fumbles the take",
              "Pushed to " + reg + ", the single is on but they decline. Dot",
              bwl + " gives it air and " + bat + " treats it with respect"
            ];
            var d = pick(dots, 25);
            if (field === "def" && H(26) % 4 === 0) d += ". The ring holds the single";
            if (chase && chase.need > 0 && H(27) % 6 === 0) d = d + ". " + chase.need + " needed off " + chase.balls;
            return d + ".";
          }
          // 1s, 2s, 3s
          var runs = rb === 3 ? pick([
            ...
            "Two more - " + bat + " works it into the gap at " + reg + " and comes back quickly",
            "Dropped into the deep and they push for two. Smart cricket from " + bat,
            bat + " lofts it over " + reg + " and the sweeper cuts it off - two runs"
          ], 29) : pick([
            "Worked off the hip for a single. " + bat + " keeps the board moving",
            "Pushed to " + reg + " for one. Good, busy cricket",
            "Soft hands into the off side and a comfortable single",
            bat + " tucks it away and " + (sb.r >= 40 ? "moves to " + (sb.r + 1) : "rotates the strike"),
            "A thick edge squirts to " + reg + " - just the single"
          ], 30);
