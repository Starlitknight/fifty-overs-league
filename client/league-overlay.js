...
(function () {
  ...
  function foPremiumClub() {
    try {
      ...
      var stk = foStreak();
      if (stk >= 2) strip += "<span class='fo-streak'>&#128293; " + stk + "-day check-in streak</span>";
  ...
  function foAdvisor(picked, fc, styleId) {
    ...
    if ((pt === "green" || pt === "cracked") && s.n >= 6 && picked.filter(function (p) { return p.bowlTypeFull && p.bowlTypeFull !== "none" && foIsPace(p); }).length < 3) out.push({ t: "info", m: "Your home pitch is " + pt + " — pace bowlers will love it. Consider drafting more seamers." });
    if (pt === "dry" && s.n >= 6 && picked.filter(function (p) { return p.bowlTypeFull && p.bowlTypeFull !== "none" && !foIsPace(p); }).length < 2) out.push({ t: "info", m: "Your home pitch is dry — it will turn. Consider drafting more spinners." });
  ...
  function foManualPage() {
    ...
    var secs = [
      ...
      ["tips", "Ten habits of champion managers", [
        "<ul><li><b>Set orders every single day.</b> The auto-XI is competent. Competent finishes sixth.</li>",
        ...
        "<li><b>Draft the pitch, not the players.</b> Your ground plays half your cricket. Make it unfair.</li>",
        ...
        "<li><b>Train the 19-year-olds like it&rsquo;s your job.</b> It is. Youth plus potential plus academy is the only exponential curve in the game.</li>",
