...
(function () {
  ...
  function ensureNav() {
    try {
      var tb = document.getElementById("topbar"); if (!tb || tb.querySelector('a[data-nav="players"]')) return;
      var a = document.createElement("a"); a.setAttribute("data-nav", "players"); a.href = "#/players"; a.textContent = "Clubs";
