...
(function () {
  ...
  css3.textContent =
    ...
    ".fo-mhead{display:flex;gap:22px;align-items:stretch;padding:16px 18px !important;margin-bottom:12px}" +
    ".fo-mh-l{flex:1 1 auto;min-width:0}" +
    ".fo-mh-eyebrow{font-size:10.5px;font-weight:800;letter-spacing:.08em;color:#C95532;text-transform:uppercase;margin-bottom:8px}" +
    ".fo-mh-team{display:flex;align-items:baseline;gap:8px;padding:3px 0;color:#98A2B3;font-size:17px}" +
    ".fo-mh-team .fo-mh-nm{font-weight:800}" +
    ".fo-mh-team.win{color:#111827}" +
    ".fo-mh-ov{font-size:12px;color:#98A2B3}" +
    ".fo-mh-sc{margin-left:auto;font-weight:800;font-size:19px;font-variant-numeric:tabular-nums}" +
    ".fo-mh-res{margin-top:9px;font-weight:800;color:#B04A2C;font-size:14.5px}" +
    ".fo-mh-r{flex:0 0 230px;border-left:1px solid #EAE5DA;padding-left:20px;display:flex;flex-direction:column;justify-content:center;gap:3px}" +
    ".fo-mh-k{font-size:10px;font-weight:800;letter-spacing:.08em;color:#667085;text-transform:uppercase}" +
    ".fo-mh-pn a{font-weight:800;font-size:15px;color:#111827;text-decoration:none}" +
    ".fo-mh-pn a:hover{color:#B04A2C}" +
    ".fo-mh-pt{font-size:12.5px;color:#667085}" +
    ".fo-mh-pf{font-size:13px;color:#3c4658;font-weight:600}" +
    "@media(max-width:820px){.fo-mhead{flex-direction:column;gap:12px}.fo-mh-r{border-left:0;border-top:1px solid #EAE5DA;padding:12px 0 0}}" +
  ...
  function foFrDoneRender(c, id) {
    ...
    try {
      ...
      var pomHtml = pomN
        ...
        : "";
      if (sc0) {
        hero = "<div class='panel fo-mhead'><div class='fo-mh-l'>" +
