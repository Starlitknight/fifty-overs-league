    ...
    try {
      ...
      if (nxt) {
        ...
        nextCard = "<div class='fo-c2-next'><div class='fo-c2-nl'>" +
          "<div class='fo-c2-nk'>Next match &middot; Round " + (nxt.round + 1) + "</div>" +
