...
(function () {
  ...
  try {
    ...
    foChCss.textContent =
      ...
      ".fo-cp-ev i{font-style:normal;flex:0 0 52px;color:#8a93a3;font-size:11px;font-weight:700}" +
  ...
  function foCareerPanel() {
    try {
      ...
      h.forEach(function (e) {
        var k = e.s || "early";
        var b = (bySeason[k] = bySeason[k] || { inns: 0, runs: 0, hs: 0, wkts: 0, bw: 0, br: 1e9 });
      ...
      var srows = keys.map(function (k) {
        var b = bySeason[k];
        return "<tr><td>" + (k === "early" ? "Early days" : "Season " + k) + "</td><td class='n'>" + b.inns + "</td><td class='n'>" + b.runs + "</td><td class='n'>" + (b.hs || "–") + "</td><td class='n'>" + b.wkts + "</td><td class='n'>" + (b.bw ? b.bw + "/" + b.br : "–") + "</td></tr>";
      }).join("");
      var evs = (p._career || []).slice().reverse().slice(0, 14).map(function (c) {
        return "<div class='fo-cp-ev'><i>S" + c.s + " R" + c.r + "</i><span>" + E(c.txt) + "</span></div>";
  ...
  try {
    ...
    if (typeof window.ftpCommHTML === "function" && !window.ftpCommHTML.__foRich) {
      ...
      var _pass = null, _tal = null;
      try { _pass = ftpPass; _tal = talentize; } catch (e) {}
      window.ftpCommHTML = function (log, filter, limit) {
  ...
  try { (function () {
    ...
    window.foScorecardCards = function (innings) {
      ...
      out += all.map(function (inn, idx) {
        ...
        return "<div class='panel fo-sci'><div class='fo-sci-head'><b>" + E(inn.batTeam) + "</b><span>" + inn.runs + "/" + inn.wkts + " <em>(" + Math.floor(inn.legal / 6) + (inn.legal % 6 ? "." + inn.legal % 6 : "") + " ov)</em></span></div><div class='pad'>" +
  ...
  try { (function () {
    ...
    var FO_TOWNS = {
      Netherlands: ["Rotterdam", "Utrecht", "Haarlem", "Deventer", "Amstelveen", "Nijmegen", "Groningen", "Leiden", "Zwolle", "Arnhem", "Breda", "Delft", "Alkmaar", "Gouda", "Hilversum", "Enschede", "Maastricht", "Apeldoorn", "Amersfoort", "Dordrecht", "Voorburg", "The Hague", "Schiedam", "Eindhoven"],
      England: ["Leeds", "Taunton", "Canterbury", "Chester-le-Street", "Scarborough", "Worcester", "Hove", "Bristol", "Northampton", "Derby", "Leicester", "Chelmsford", "Guildford", "Cheltenham", "Blackpool", "Kidderminster", "Ormskirk", "Pudsey", "Wakefield", "Barnsley", "Nottingham", "Durham", "Bath", "Ashington"],
      Australia: ["Ballarat", "Newcastle", "Geelong", "Townsville", "Wagga Wagga", "Bendigo", "Launceston", "Toowoomba", "Cairns", "Bunbury", "Dubbo", "Albury", "Mackay", "Rockhampton", "Penrith", "Wollongong", "Mount Gambier", "Shepparton", "Bathurst", "Port Macquarie", "Alice Springs", "Devonport", "Fremantle", "Orange"],
      India: ["Pune", "Rajkot", "Indore", "Mysuru", "Nagpur", "Kanpur", "Ranchi", "Meerut", "Vadodara", "Guwahati", "Amritsar", "Jodhpur", "Nashik", "Coimbatore", "Vijayawada", "Patna", "Bhopal", "Raipur", "Dehradun", "Aligarh", "Kochi", "Ludhiana", "Surat", "Varanasi"],
      Pakistan: ["Multan", "Sialkot", "Hyderabad", "Peshawar", "Gujranwala", "Faisalabad", "Quetta", "Rawalpindi", "Sargodha", "Bahawalpur", "Sheikhupura", "Abbottabad", "Larkana", "Sahiwal", "Mardan", "Sukkur", "Okara", "Jhelum", "Mianwali", "Gujrat", "Kasur", "Attock"],
      "South Africa": ["Paarl", "Bloemfontein", "Kimberley", "George", "Stellenbosch", "Pietermaritzburg", "Benoni", "Potchefstroom", "East London", "Gqeberha", "Rustenburg", "Krugersdorp", "Uitenhage", "Makhanda", "Welkom", "Springs", "Vereeniging", "Oudtshoorn", "Middelburg", "Nelspruit", "Polokwane", "Vryheid"],
      "New Zealand": ["Napier", "Dunedin", "Nelson", "Whangarei", "Tauranga", "Palmerston North", "Invercargill", "Rotorua", "New Plymouth", "Hastings", "Timaru", "Gisborne", "Blenheim", "Masterton", "Ashburton", "Whanganui", "Levin", "Oamaru", "Cambridge", "Rangiora", "Taupo", "Greymouth"],
      "Sri Lanka": ["Galle", "Kandy", "Matara", "Kurunegala", "Moratuwa", "Negombo", "Jaffna", "Ratnapura", "Badulla", "Anuradhapura", "Batticaloa", "Trincomalee", "Panadura", "Kalutara", "Gampaha", "Ambalangoda", "Nuwara Eliya", "Hambantota", "Chilaw", "Kegalle", "Dambulla", "Matale"],
      "West Indies": ["Arima", "Spanish Town", "Bridgetown", "Basseterre", "San Fernando", "Chaguanas", "Montego Bay", "Kingstown", "Castries", "Georgetown", "Roseau", "St John's", "Gros Islet", "Speightstown", "May Pen", "Portmore", "Point Fortin", "New Amsterdam", "Linden", "Holetown", "Falmouth", "Couva"],
      Afghanistan: ["Jalalabad", "Khost", "Kandahar", "Kunduz", "Herat", "Mazar-i-Sharif", "Ghazni", "Lashkar Gah", "Asadabad", "Gardez", "Charikar", "Pul-e-Khumri", "Taloqan", "Sheberghan", "Baghlan", "Faizabad", "Mehtar Lam", "Farah", "Zaranj", "Aybak"],
      Ireland: ["Cork", "Galway", "Lisburn", "Drogheda", "Waterford", "Kilkenny", "Sligo", "Tralee", "Athlone", "Navan", "Carlow", "Ennis", "Dundalk", "Bray", "Mullingar", "Wexford", "Letterkenny", "Portlaoise", "Clonmel", "Bangor", "Coleraine", "Armagh"],
      Zimbabwe: ["Bulawayo", "Mutare", "Gweru", "Kwekwe", "Masvingo", "Chinhoyi", "Marondera", "Kadoma", "Chegutu", "Bindura", "Zvishavane", "Victoria Falls", "Hwange", "Rusape", "Chiredzi", "Kariba", "Gwanda", "Shurugwi", "Norton", "Beitbridge"],
      Bangladesh: ["Khulna", "Rajshahi", "Sylhet", "Bogura", "Chattogram", "Narayanganj", "Cumilla", "Mymensingh", "Jashore", "Barisal", "Rangpur", "Dinajpur", "Tangail", "Narsingdi", "Kushtia", "Brahmanbaria", "Feni", "Pabna", "Gazipur", "Magura", "Cox's Bazar", "Savar"]
    };
