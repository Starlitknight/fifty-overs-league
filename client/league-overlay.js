...
(function () {
  ...
  css3.textContent =
    ...
    "html body .fo-scout-links a.on,html body.ftpskin .fo-scout-links a.on{background:" + TERRA + ";color:#fff !important;font-weight:700}" +
    ...
    "html body a.fo-sp-nm,html body.ftpskin a.fo-sp-nm{font-weight:800;font-size:14.5px;color:#12203a !important;text-decoration:none}" +
    "html body a.fo-sp-nm:hover,html body.ftpskin a.fo-sp-nm:hover{color:#C0562F !important}" +
