...
(function () {
  ...
  function foOnbPlayers() {
    ...
    var defs = [
      ["Batting", "The group that decides runs. <b>Overall</b> is the headline; <b>vs pace</b> and <b>vs spin</b> are real matchups (a spin-weak opener WILL be found out); <b>Rotation</b> turns dots into singles; <b>Power</b> clears the rope; <b>Temperament</b> holds it together under pressure."],
      ["Bowling", "Only bowlers carry it. <b>Wicket threat</b> buys wickets, <b>Economy</b> buys dots, <b>Discipline</b> avoids wides and no-balls, <b>Move / turn</b> is seam or spin bite, <b>Stamina</b> keeps spells honest (and matters double in hot weather)."],
      ["In the field", "<b>Fielding</b> saves runs and effects run-outs; <b>Catching</b> sets the drop chance when your bowler earns an edge. Keepers add <b>Keeping</b> and <b>Stumping</b>."],
      ["The footer", "<b>Experience</b> steadies big moments, <b>Captaincy</b> lifts the whole XI in the field, <b>Fatigue</b> is his freshness ladder today."],
      ["Words &amp; colours", "Every number wears an honest word (from atrocious to world class) and a colour: red is a liability, amber does a job, teal is good, green wins matches."],
      ["Hand &amp; style", "RHB/LHB and the bowling type (genuine fast, fast medium, medium, finger spin, wrist spin). The rarity and value of each is on the next page."],
    ...
    var body =
      ...
      "<p class='fo-ob-lead'>Two real players from your draft pool, exactly as every player page shows them: skills grouped into <b>Batting</b>, <b>Bowling</b> and <b>In the field</b>, each with a number, a bar and an honest word. <b style='color:#C84F4A'>Red</b> is a liability, <b style='color:#D9A441'>amber</b> does a job, <b style='color:#2d7a76'>teal</b> is good, <b style='color:#3E9960'>green</b> wins matches.</p>" +
  ...
  try { (function () {
    ...
    function foBcastT0(rd) {
      ...
      try {
        ...
        for (var ci = 0; ci < cand.length; ci++) {
          if (!cand[ci]) continue;
          var t = Date.parse(cand[ci] + " 09:00:00 GMT-0400");
    ...
    // live pill in the nav + a slow tick that keeps live surfaces fresh
    setInterval(function () {
      try {
        var em = foEmbargo();
        var tb = document.getElementById("topbar");
    ...
    if (typeof window.route === "function" && !window.route.__foBcast) {
      ...
      window.route = function () {
        ...
        try { foMaskSpoilers(); } catch (e) {}
        setTimeout(foMaskSpoilers, 220); setTimeout(foMaskSpoilers, 900);   // pages paint async
        return r2;
      };
