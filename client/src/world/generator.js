...
FOC.worldgen = (function () {
  ...
  var CLUBS = [
    { key: "willowmere", name: "Willowmere CC", city: "Willowmere", ground: "The Meadow", pitch: "green", arch: "blade", rep: 38, mult: 0.86,
    ...
    { key: "ironbridge", name: "Ironbridge CC", city: "Ironbridge", ground: "Foundry Field", pitch: "flat", arch: "express", rep: 45, mult: 0.92,
    ...
    { key: "moorland", name: "Moorland CC", city: "High Moor", ground: "High Tor", pitch: "green", arch: "rock", rep: 42, mult: 0.9,
    ...
    { key: "fenholt", name: "Fenholt Athletic", city: "Fenholt", ground: "Brick Lane End", pitch: "dry", arch: "finisher", rep: 40, mult: 0.9, founded: 1,
    ...
    { key: "bellminster", name: "Bellminster CC", city: "Bellminster", ground: "Cathedral Green", pitch: "dusty", arch: "wizard", rep: 55, mult: 1.0,
    ...
    { key: "blackstone", name: "Blackstone Ramblers", city: "Blackstone", ground: "The Quarry", pitch: "flat", arch: "express", rep: 65, mult: 1.06,
    ...
    { key: "kestrel", name: "Kestrel Park CC", city: "Kestrel Park", ground: "The Aviary", pitch: "green", arch: "gloveman", rep: 52, mult: 0.98,
    ...
    { key: "harrowgate", name: "Harrowgate CC", city: "Harrowgate", ground: "Spa Ground", pitch: "dusty", arch: "wizard", rep: 58, mult: 1.02,
    ...
    { key: "crown", name: "Crown Ground XI", city: "The Crown Ground", ground: "The Crown Ground", pitch: "flat", arch: "rock", rep: 80, mult: 1.14,
