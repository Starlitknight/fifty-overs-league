...
FOC.oval = (function () {
  ...
  function css() {
    ...
    st.textContent =
      ...
      "html body #page.fo-ovalgrid.fo-matchpage{grid-template-columns:minmax(460px,50%) minmax(0,1fr);grid-template-rows:auto auto auto auto 1fr;grid-template-areas:'moval mcrumb' 'moval mlinks' 'moval mbody' 'mtop mbody' 'mrest mbody'}" +
      ...
      "html body #page.fo-ovalgrid.fo-matchpage .mc-top{grid-area:mtop;display:flex !important;flex-direction:row !important;align-items:stretch !important;gap:12px;margin:12px 0 0}" +
