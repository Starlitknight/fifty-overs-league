...
const GAME = resolve(__dirname, '../.build/page.html');   // self-contained tooling page (the shipped site splits HTML and JS; build.sh keeps this one whole for file:// harnesses)
